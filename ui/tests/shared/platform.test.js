...
import { DefaultPlatformAdapter, createPlatformAdapterCapabilityView, createDesktopPlatformAdapter, createMobilePlatformAdapter, createWebPlatformAdapter, } from "@aa/shared-platform";
        ...
        window.__TAURI__ = {
            async invoke(command) {
                if (command === "run_shell") {
                    return { code: 0, stdout: "tauri:ok", stderr: "" };
                }
