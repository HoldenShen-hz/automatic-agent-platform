...
const createMockFeature = (overrides = {}) => ({
    ...
    Component: () => (_jsx("div", { "data-testid": "test-component", children: "Test Feature Content" })),
    ...overrides,
});
describe("UI integration: web app-shell with auth context", () => {
    ...
    it("authenticates user with permissions and renders protected feature", () => {
        ...
        render(_jsx(WebAppShell, { features: [createMockFeature()], router: "memory", initialEntries: ["/test"], authContext: authContext }));
...
describe("UI integration: navigation flow", () => {
    ...
    it("renders sidebar with multiple feature groups", () => {
        ...
        render(_jsx(WebAppShell, { features: mockFeatures, router: "memory", initialEntries: ["/mission-control/dashboard"] }));
...
describe("UI integration: system status display", () => {
    ...
    it("renders system status bar with WS and offline status", () => {
        render(_jsx(WebAppShell, { features: [createMockFeature()], router: "memory", initialEntries: ["/"] }));
...
describe("UI integration: multi-platform feature rendering", () => {
    ...
    it("features render across different route paths", () => {
        ...
        render(_jsx(WebAppShell, { features: mockFeatures, router: "memory", initialEntries: ["/mission-control/workflows"] }));
        expect(screen.getByText("Workflows")).toBeInTheDocument();
    });
    it("supports planned features that render differently", () => {
        const mockFeatures = [
            createMockFeature({
                manifest: { ...createMockFeature().manifest, id: "workflow-builder", title: "Workflow Builder", kind: "planned" },
        ...
        render(_jsx(WebAppShell, { features: mockFeatures, router: "memory", initialEntries: ["/extended/workflow-builder"] }));
...
describe("UI integration: catch-all route behavior", () => {
    ...
    it("renders first feature for unmatched routes", () => {
        ...
        render(_jsx(WebAppShell, { features: [firstFeature, secondFeature], router: "memory", initialEntries: ["/some/unknown/route"] }));
