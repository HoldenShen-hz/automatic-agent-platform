...
describe("feature-registry", () => {
    ...
    it("contains workflow-cockpit feature", () => {
        const workflowCockpit = featureRegistry.find((f) => f.manifest.id === "workflow-cockpit");
    ...
    it("contains workflow-builder feature (planned)", () => {
        const workflowBuilder = featureRegistry.find((f) => f.manifest.id === "workflow-builder");
    ...
    it("contains workflow-debugger feature (planned)", () => {
        const workflowDebugger = featureRegistry.find((f) => f.manifest.id === "workflow-debugger");
    ...
    it("contains explainability feature", () => {
        const explainability = featureRegistry.find((f) => f.manifest.id === "explainability");
...
describe("feature registry groups", () => {
    it("contains Mission Control group", () => {
        const missionControl = featureRegistry.filter((f) => f.manifest.group === "Mission Control");
        expect(missionControl.length).toBeGreaterThan(0);
    });
    it("contains Operations group", () => {
        const operations = featureRegistry.filter((f) => f.manifest.group === "Operations");
        expect(operations.length).toBeGreaterThan(0);
    });
    it("contains Governance group", () => {
        const governance = featureRegistry.filter((f) => f.manifest.group === "Governance");
