...
import { configureWindowsDesktopIntegrations, createMainWindow, electronGlobalShortcuts, electronMainBaseline, electronBridgeCapabilities, openSecondaryWindow, registerGlobalShortcuts, registerIpcHandlers, showPlatformNotification, } from "../../../../../apps/electron-win/src/main";
...
describe("desktop integrations", () => {
    ...
    it("configures Windows jump-list tasks for dashboard and command palette entrypoints", () => {
        ...
        expect(app.setUserTasks).toHaveBeenCalledWith(expect.arrayContaining([
