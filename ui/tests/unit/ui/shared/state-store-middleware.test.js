...
import { CACHE_TIER_STALE_TIME, createAuthStore, createNotificationStore, createQueryClientFactory, createTieredQueryClientFactory, createRealtimeStore, createSyncStore, createThemeStore, createUiStore, } from "@aa/shared-state";
describe("shared state store middleware", () => {
    it("keeps persist middleware attached while auth state updates through draft mutations", () => {
        ...
        expect(typeof authStore.persist?.rehydrate).toBe("function");
