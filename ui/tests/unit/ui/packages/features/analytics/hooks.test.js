...
import { MAX_ANALYTICS_EXPORT_BYTES, buildAnalyticsExportPayload, useAnalyticsVm, } from "../../../../../../packages/features/analytics/src/hooks";
describe("useAnalyticsVm", () => {
    ...
    it("rejects oversized analytics exports before creating blobs", () => {
        expect(() => buildAnalyticsExportPayload("json", [{ label: "x".repeat(MAX_ANALYTICS_EXPORT_BYTES), value: 12, trend: "up" }], [{ timestamp: "2026-05-08T00:00:00.000Z", value: 12 }], [{
                dimension: "time",
