...
describe("mapDashboardSnapshotToVm", () => {
    it("clamps ratio metrics, resolves analytics aliases, and normalizes trend values to percentages", () => {
        ...
        ], [{ id: "incident-1", severity: "critical", title: "critical", summary: "summary", createdAt: "2026-05-01T00:00:00.000Z" }], [{ id: "worker-1", status: "draining", queue: "primary", heartbeatLagMs: 900 }], [{ id: "queue-1", ready: 6, inFlight: 4, retries: 2, dlq: 1 }], [
