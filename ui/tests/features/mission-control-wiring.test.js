...
describe("mission control panel wiring", () => {
    it("maps dashboard inputs into four panel layers with 28 panels", () => {
        const vm = mapDashboardSnapshotToVm(defaultMockApiShape.dashboard, defaultMockApiShape.analytics, defaultMockApiShape.incidents, defaultMockApiShape.workers, defaultMockApiShape.queues, defaultMockApiShape.agents);
    ...
    it("maps stability data into structured health rows", () => {
        const vm = mapStabilityToVm(defaultMockApiShape.dashboard, defaultMockApiShape.incidents, defaultMockApiShape.workers, defaultMockApiShape.queues, defaultMockApiShape.agents);
