export function createFeatureGuardContext(overrides = {}) {
    return {
        authenticated: true,
...
function allowedResult(evaluatedLayers) {
    return { allowed: true, reason: null, evaluatedLayers };
}
function deniedResult(reason, evaluatedLayers) {
    return { allowed: false, reason, evaluatedLayers };
}
export function createRouteGuardChain(permission, featureFlag, options = {}) {
...
export function createDomainUiConfig(domainId, overrides = {}) {
    return {
        domainId,
        featureVisibility: {},
        actionPolicy: {},
...
export function applyRedaction(policy, fieldPath, roleLevel, value) {
...
function matchesRule(rule, fieldPath, roleLevel) {
...
export function selectRedactionLevel(policy, fieldPath, roleLevel) {
