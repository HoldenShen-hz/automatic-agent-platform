...
export type ImplementationStatus = "Implemented/Contracted" | "Implemented/Internal" | "Implemented/Partial" | "Planned" | (string & {});
...
export interface PlatformAdapterCapabilityView {
    ...
    readonly process: {
        spawn(command: string, args: readonly string[]): Promise<{
            pid: number;
            kill(): Promise<void>;
        }>;
    };
