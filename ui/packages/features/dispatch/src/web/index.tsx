      ...
      <ThreePaneLayout
        left={(
          <Stack gap={10}>
            ...
            {vm.loading ? null : vm.listItems.length === 0 ? <p>No tasks are available for dispatch inspection.</p> : vm.listItems.map((item) => (
        ...
        center={vm.loading ? <p>Loading dispatch detail...</p> : vm.detailRows.length === 0 ? <p>No task selected</p> : (
          <Stack gap={16}>
