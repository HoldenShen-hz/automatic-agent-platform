...
export function DomainWizardWebView() {
    ...
    return (_jsx(FeatureScaffold, { title: "Domain Wizard", summary: "\u9886\u57DF\u63A5\u5165\u5411\u5BFC\u548C DomainUIConfig \u9A71\u52A8\u9875\u9762\u3002", status: "Implemented/Partial", children: _jsx("form", { onSubmit: (event) => {
