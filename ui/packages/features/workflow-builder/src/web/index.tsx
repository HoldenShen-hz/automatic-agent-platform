...
export function WorkflowBuilderWebView(): ReactElement {
  ...
  return (
    <FeatureScaffold title="Workflow Builder" summary="可视化工作流构建器" status="Planned">
      <div style={{ height: 280, marginBottom: 16, border: "1px solid #334155", borderRadius: 12, overflow: "hidden" }}>
        <Suspense fallback={<div style={{ padding: 16 }}>Loading workflow canvas...</div>}>
