...
const APPROVAL_RISK_PRIORITY: Record<string, number> = {
  critical: 0,
  high: 1,
  medium: 2,
  low: 3,
...
function readApprovalRiskPriority(riskLevel: ApprovalDTO["riskLevel"] | string | null | undefined): number {
  if (riskLevel == null) {
...
function compareApprovalPriority(left: ApprovalDTO, right: ApprovalDTO): number {
...
export function sortApprovalsByPriority(approvals: readonly ApprovalDTO[]): readonly ApprovalDTO[] {
