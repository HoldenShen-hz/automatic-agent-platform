...
import { activateMission, archiveMission, completeMission, fetchMissionBudget, fetchMissionEvidence, fetchMissionKnowledge, fetchMissionLearning, fetchMissionMembers, fetchMissionRuns, fetchMissionTasks, freezeMission, pauseMission, resumeMission, unfreezeMission, } from "@aa/shared-api-client";
...
export function useMissionConsoleVm() {
...
function buildOperatorNotices(mission, budget, memberCount) {
    const notices = [
        {
...
function buildKnowledgeLearningSummary(mission, knowledgeCount, learningCount, evidenceCount) {
    return [
        {
...
function buildRecommendedActions(mission) {
