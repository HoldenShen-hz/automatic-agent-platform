...
禁止在 src/platform/execution/** 新增 StepStatus / WorkflowStep
禁止在 src/platform/orchestration/** 输出 PlanStep[] 作为计划契约
禁止在 src/platform/interface/api/** 暴露 Step-centric response
```
