...
| 文件 | 说明 |
|------|------|
| `src/interaction/proactive-agent/user-preference-tracker.ts` | 用户偏好跟踪器 |
| `tests/unit/interaction/proactive-agent/user-preference-tracker.test.ts` | 偏好跟踪器测试（13 个测试） |
