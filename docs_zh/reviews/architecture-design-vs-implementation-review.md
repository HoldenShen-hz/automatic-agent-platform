...
#### IX-1: ops-maturity 叶子工具桩率仍偏高 (~36%) (P3)

**问题**: `platform-ops-agent/` (6/9 为桩), `capacity-planner/` (4/5 为桩), `compliance-reporter/` (4/5 为桩)

**实施方案**: 按模块逐步补厚，优先级低于 Harness 和域实现。属路线图增强项。
