...
import { isLeafOrgNode, type OrgNode } from "../../../src/org-governance/org-model/org-node/index.js";
...
test("org-governance support modules expose contract-aligned helpers", () => {
  assert.equal(
    ...
    ], "manager", "team_1", "2026-04-20T12:00:00.000Z"),
    "backup_manager",
  );
  ...
  assert.deepEqual(
    resolveCompliancePolicyForNode(orgNodes, "team_1", {
