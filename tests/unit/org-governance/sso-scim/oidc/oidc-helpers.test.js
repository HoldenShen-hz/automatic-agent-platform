...
import { toOidcSession, InMemoryOidcStateStore, } from "../../../../../src/org-governance/sso-scim/oidc/oidc-service.js";
...
test("toOidcSession converts session record with refresh token", () => {
    ...
    assert.equal(result.refreshToken, "rt_refresh_token");
...
//# sourceMappingURL=oidc-helpers.test.js.map