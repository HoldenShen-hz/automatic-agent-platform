...
import { OrgNodeSchema, OrgNodeTypeSchema, isLeafOrgNode, getPlatformMapping, validateHierarchyDepth, createCrossOrgCollaborator, requiresLegalEntityApproval, } from "../../../src/org-governance/org-model/org-node/index.js";
test("OrgNodeTypeSchema accepts canonical node types only", () => {
    for (const type of ["company", "division", "department", "team"]) {
...
//# sourceMappingURL=org-node.test.js.map