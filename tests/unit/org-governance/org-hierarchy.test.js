...
import { buildOrgChangeImpactArtifacts, buildReportingChain, detectOrgChangeEvents, findLowestCommonAncestor, listAncestorNodeIds, listDescendantNodeIds, validateOrgHierarchy, } from "../../../src/org-governance/org-model/hierarchy/index.js";
const nodes = [
...
test("org-hierarchy emits downstream remediation artifacts", () => {
    const after = [
        { orgNodeId: "dept", nodeType: "department", displayName: "Eng", parentOrgNodeId: "missing", ownerUserIds: ["director-2"], active: true, costCenter: "CC-2", metadata: {}, legalEntityBoundary: { boundaryId: "le-2", legalEntityId: "entity-2", jurisdictionCountry: "US", dataResidencyRegion: "us-east", crossBorderTransferPolicy: "approval_required", crossEntityApprovalRoles: ["compliance_officer"], restrictedDataClasses: [] } },
    ];
...
//# sourceMappingURL=org-hierarchy.test.js.map