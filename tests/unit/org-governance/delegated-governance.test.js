...
import { GovernanceDelegationSchema, GovernancePermissionSchema, GuardrailSchema, GuardrailTypeSchema, listActiveGovernanceDelegations, } from "../../../src/org-governance/delegated-governance/delegation-registry/index.js";
import { matchesGovernanceScope, evaluateGuardrail, isOperationAllowedByRole, } from "../../../src/org-governance/delegated-governance/scope-manager/index.js";
...
test("DelegatedGovernanceService.checkOperation respects org node boundaries", () => {
    ...
    const financeResult = service.checkOperation({ actorId: "admin", actorRole: "division_admin", orgNodeId: "finance" }, "adjust_agent_autonomy", 500);
    assert.equal(financeResult.allowed, true);
    // HR org has lower budget guardrail (max_budget: 500) - 500 is at limit, not exceeding
    const hrResult = service.checkOperation({ actorId: "admin", actorRole: "division_admin", orgNodeId: "hr" }, "adjust_agent_autonomy", 500);
    assert.equal(hrResult.allowed, true);
    // HR org trying higher budget - should fail
    const hrResultHigh = service.checkOperation({ actorId: "admin", actorRole: "division_admin", orgNodeId: "hr" }, "adjust_agent_autonomy", 600);
...
//# sourceMappingURL=delegated-governance.test.js.map