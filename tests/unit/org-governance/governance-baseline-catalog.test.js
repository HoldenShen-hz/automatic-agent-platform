...
import { listGovernanceCapabilityBaselines, resolveGovernanceCapabilityBaseline, } from "../../../src/org-governance/governance-baseline-catalog.js";
...
test("governance baseline service names resolve from canonical submodule and root exports", () => {
    ...
    for (const baseline of listGovernanceCapabilityBaselines()) {
        ...
        for (const serviceName of baseline.baselineServices) {
            ...
            assert.equal(serviceName in governance, true, `expected ${serviceName} to be exported by src/org-governance/index.ts`);
        }
    }
});
//# sourceMappingURL=governance-baseline-catalog.test.js.map