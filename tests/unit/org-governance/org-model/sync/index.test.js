...
test("diffOrgCharts returns empty array when no changes", () => {
    ...
    const before = { root: node, nodes: [node], syncSource: "manual", lastSyncedAt: "2026-04-14T12:00:00.000Z" };
    const after = { root: node, nodes: [node], syncSource: "manual", lastSyncedAt: "2026-04-14T12:01:00.000Z" };
    const changed = diffOrgCharts(before, after);
