...
test("HrGapAnalysisResult structure", () => {
  const result: HrGapAnalysisResult = {
    taskId: "task_123",
    targetDivisionId: "platform_team",
...
test("HrRoleSchemaShape structure", () => {
  const schema: HrRoleSchemaShape = {
