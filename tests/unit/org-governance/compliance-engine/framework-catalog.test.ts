...
test("ComplianceFrameworkSchema", () => {
  test("parses valid framework", () => {
    const valid = {
      frameworkId: "custom",
  ...
  test("throws on missing frameworkId", () => {
    assert.throws(() => {
...
test("DepartmentComplianceBindingSchema", () => {
  test("parses valid binding", () => {
    const valid = {
  ...
  test("defaults frameworkIds to empty array", () => {
    const valid = {
      bindingId: "binding-001",
      orgNodeId: "dept-001",
      attachedAt: "2024-01-15T00:00:00.000Z",
  ...
  test("throws on missing bindingId", () => {
    assert.throws(() => {
...
test("DEFAULT_COMPLIANCE_FRAMEWORKS", () => {
  test("contains SOX framework", () => {
  ...
  test("contains PCI DSS framework", () => {
