...
import {
  UserOperationsTaskTypeSchema,
  USER_OPERATIONS_DOMAIN_PRESET,
  requiresUserOperationsReview,
} from "../../../../src/domains/user-operations/index.js";

test("UserOperationsTaskTypeSchema accepts valid task types", () => {
  const types = ["segment", "operate", "follow-up"] as const;
