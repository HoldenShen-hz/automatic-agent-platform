...
import {
  FacilitiesTaskTypeSchema,
  FACILITIES_DOMAIN_PRESET,
  FacilitiesDomainPreset,
  requiresFacilitiesReview,
} from "../../../../src/domains/facilities/index.js";

test("FacilitiesTaskTypeSchema accepts valid task types", () => {
  const types = ["dispatch", "inspect", "coordinate"] as const;
