...
import { ExecutiveAssistantTaskTypeSchema, EXECUTIVE_ASSISTANT_DOMAIN_PRESET, requiresExecutiveAssistantReview, } from "../../../../src/domains/executive-assistant/index.js";
test("ExecutiveAssistantTaskTypeSchema accepts valid task types", () => {
    const types = ["schedule", "brief", "follow-up"];
