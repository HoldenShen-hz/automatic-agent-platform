...
test("seedDomainMetaModels creates multiple models", () => {
    const inputs = [
        { domainId: "domain-a", displayName: "Domain A", ownerOrgNodeId: "node-a", taskTypes: ["t1"], tags: [], riskLevel: "medium" },
        { domainId: "domain-b", displayName: "Domain B", ownerOrgNodeId: "node-b", taskTypes: ["t2"], tags: [], riskLevel: "high" },
    ];
...
test("seedDomainMetaModels returns array of models", () => {
    const models = seedDomainMetaModels([
        { domainId: "d1", displayName: "D1", ownerOrgNodeId: "n", taskTypes: [], tags: [], riskLevel: "medium" },
    ]);
    assert.ok(models[0]);
