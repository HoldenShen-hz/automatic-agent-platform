...
test("PluginRuntimeRequest input is polymorphic for different actions", () => {
    ...
    const presentRequest = {
        ...
        action: "present",
        context: null,
        input: { machineOutputs: [], artifacts: [], audience: "developer" },
    };
...
test("PluginRuntimeMessage accepts ready variant", () => {
    const msg = { type: "ready", pid: 33333 };
    assert.equal(msg.type, "ready");
});
test("PluginRuntimeMessage accepts response variant", () => {
    const msg = { type: "response", requestId: "req_x", ok: true, pid: 33333 };
...
//# sourceMappingURL=plugin-runtime-protocol-types.test.js.map