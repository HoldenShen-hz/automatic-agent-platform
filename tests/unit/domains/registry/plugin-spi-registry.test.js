...
import { buildContainerizedPluginRuntimeLaunchSpec, buildPluginRuntimeExecArgv, } from "../../../../src/domains/registry/plugin-runtime-host.js";
...
test("PluginSpiRegistry enforces namespace sandbox and timeout", async () => {
    ...
    registry.register({
        ...
        async retrieve() {
            ...
            return [{ knowledgeRef: "knowledge:chunk_1", snippet: "slow chunk", score: 0.9, namespace: "coding/repo", chunkId: "chunk_1", documentId: "doc_1", matchType: "semantic" }];
        },
    }, {
        pluginId: "plugin.coding.slow",
        name: "slow retriever",
...
test("PluginSpiRegistry serializes plugin invocations under isolation limits", async () => {
    ...
    registry.register({
        ...
        async retrieve() {
            ...
            inFlight -= 1;
            return [{ knowledgeRef: "knowledge:chunk_serial", snippet: "serial chunk", score: 0.9, namespace: "coding/repo", chunkId: "chunk_serial", documentId: "doc_serial", matchType: "semantic" }];
        },
    }, {
        pluginId: "plugin.coding.serial",
    ...
    registry.register({
        ...
        async retrieve() {
            ...
            if (invocationCount > 1) {
                return [{ knowledgeRef: "knowledge:chunk_queue", snippet: "queued chunk", score: 0.9, namespace: "coding/repo", chunkId: "chunk_queue", documentId: "doc_queue", matchType: "semantic" }];
            }
...
//# sourceMappingURL=plugin-spi-registry.test.js.map