    ...
    workflows: [
      {
        ...
        name: "Main",
        triggerConditions: {},
        steps: [{ stepName: "step-1", dependsOn: [] as string[], timeoutMs: 60000, toolHints: [] as string[], modelHints: {}, outputSchema: null, retryPolicy: { maxRetries: 0, backoffMs: 0 }, requiresReview: false }],
      },
    ],
    toolBundles: [
      {
    ...
    workflows: [
      {
        ...
        triggerConditions: {},
        steps: [
          { stepName: "step-a", dependsOn: ["step-b"], timeoutMs: 60000, toolHints: [] as string[], modelHints: {}, outputSchema: null, retryPolicy: { maxRetries: 0, backoffMs: 0 }, requiresReview: false },
          { stepName: "step-b", dependsOn: ["step-a"], timeoutMs: 60000, toolHints: [] as string[], modelHints: {}, outputSchema: null, retryPolicy: { maxRetries: 0, backoffMs: 0 }, requiresReview: false },
        ],
      },
    ],
  }));
    ...
    workflows: [
      {
        ...
        name: "Self Ref",
        triggerConditions: {},
        steps: [{ stepName: "step-1", dependsOn: ["step-1"], timeoutMs: 60000, toolHints: [] as string[], modelHints: {}, outputSchema: null, retryPolicy: { maxRetries: 0, backoffMs: 0 }, requiresReview: false }],
      },
    ],
    toolBundles: [
      {
