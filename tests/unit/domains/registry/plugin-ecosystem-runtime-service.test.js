...
test("PluginEcosystemRuntimeService.buildPlan creates plan for active domain", () => {
    ...
    const service = new PluginEcosystemRuntimeService(domainService, pluginRegistry, connectors);
...
test("PluginEcosystemRuntimeService.buildPlan throws for unknown domain", () => {
    ...
    const service = new PluginEcosystemRuntimeService(domainService, pluginRegistry, connectors);
    assert.throws(() => service.buildPlan({
...
test("PluginEcosystemRuntimeService.buildPlan includes connector targets", () => {
    ...
    const connectors = {
        ...
        listBindings: () => [{ connectorId: "conn_1", tenantId: "tenant_1", environment: "dev", bound: true }],
    };
    domainService.register({
        domainId: "coding",
        name: "Coding",
...
test("PluginEcosystemRuntimeService.buildPlan adds finding for non-prod-ready connector in prod", () => {
    ...
    const connectors = {
        ...
        listBindings: () => [{ connectorId: "conn_1", tenantId: "tenant_1", environment: "prod", bound: true }],
    };
    domainService.register({
        domainId: "coding",
        name: "Coding",
...
test("PluginEcosystemRuntimeService.activateRuntime auto-binds connectors when requested", async () => {
    ...
    const connectors = {
        getManifest: () => ({ lifecycleState: "verified" }),
        listBindings: () => [],
        bind: (connectorId, tenantId, environment) => ({
            connectorId,
            tenantId,
...
test("PluginEcosystemRuntimeService.activateRuntime does not auto-bind when autoBindConnectors is false", async () => {
    ...
    const connectors = {
        ...
        bind: () => {
            ...
            return { connectorId: "conn_1", tenantId: "tenant_1", environment: "dev", bound: true };
        },
    };
    domainService.register({
        domainId: "coding",
...
//# sourceMappingURL=plugin-ecosystem-runtime-service.test.js.map