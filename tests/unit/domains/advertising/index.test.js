...
import { AdvertisingTaskTypeSchema, ADVERTISING_DOMAIN_PRESET, requiresAdvertisingReview, } from "../../../../src/domains/advertising/index.js";
test("AdvertisingTaskTypeSchema accepts valid task types", () => {
    const types = ["plan", "launch", "optimize"];
