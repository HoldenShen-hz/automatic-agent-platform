...
import { FinancialServicesTaskTypeSchema, FINANCIAL_SERVICES_DOMAIN_PRESET, requiresFinancialServicesReview, } from "../../../../src/domains/financial-services/index.js";
test("FinancialServicesTaskTypeSchema accepts valid task types", () => {
    const types = ["review", "advise", "execute"];
