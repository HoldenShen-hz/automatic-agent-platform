...
import { ProjectManagementTaskTypeSchema, PROJECT_MANAGEMENT_DOMAIN_PRESET, requiresProjectManagementReview, } from "../../../../src/domains/project-management/index.js";
test("ProjectManagementTaskTypeSchema accepts valid task types", () => {
    const types = ["plan", "coordinate", "report"];
