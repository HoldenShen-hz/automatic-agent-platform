...
import { ManufacturingTaskTypeSchema, MANUFACTURING_DOMAIN_PRESET, requiresManufacturingReview, } from "../../../../src/domains/manufacturing/index.js";
test("ManufacturingTaskTypeSchema accepts valid task types", () => {
    const types = ["plan", "monitor", "correct"];
