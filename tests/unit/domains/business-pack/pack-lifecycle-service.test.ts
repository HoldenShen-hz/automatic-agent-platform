...
} from "../../../../src/domains/business-pack/pack-lifecycle-service.js";
import type { BusinessPackManifest } from "../../../../src/domains/business-pack/business-pack-manifest.js";

function createTestManifest(packId: string): BusinessPackManifest {
  return {
    packId,
...
describe("PackLifecycleService", () => {
  ...
  describe("submitForCertification", () => {
    ...
    it("should throw if pack not found", () => {
      assert.throws(
        () => service.submitForCertification("nonexistent"),
        /not found/,
      );
    });
  });
