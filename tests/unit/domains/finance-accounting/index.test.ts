...
import {
  FinanceAccountingTaskTypeSchema,
  FINANCE_ACCOUNTING_DOMAIN_PRESET,
  FinanceAccountingDomainPreset,
  requiresFinanceAccountingReview,
} from "../../../../src/domains/finance-accounting/index.js";

test("FinanceAccountingTaskTypeSchema accepts valid task types", () => {
  const types = ["reconcile", "report", "forecast"] as const;
