...
import {
  CreativeProductionTaskTypeSchema,
  CREATIVE_PRODUCTION_DOMAIN_PRESET,
  CreativeProductionDomainPreset,
  requiresCreativeProductionReview,
} from "../../../../src/domains/creative-production/index.js";

test("CreativeProductionTaskTypeSchema accepts valid task types", () => {
  const types = ["concept", "draft", "iterate"] as const;
