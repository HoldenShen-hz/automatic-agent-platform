...
import { QualityAssuranceTaskTypeSchema, QUALITY_ASSURANCE_DOMAIN_PRESET, requiresQualityAssuranceReview, } from "../../../../src/domains/quality-assurance/index.js";
test("QualityAssuranceTaskTypeSchema accepts valid task types", () => {
    const types = ["design", "validate", "certify"];
