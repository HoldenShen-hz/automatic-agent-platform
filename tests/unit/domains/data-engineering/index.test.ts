...
import {
  DataEngineeringTaskTypeSchema,
  DATA_ENGINEERING_DOMAIN_PRESET,
  DataEngineeringDomainPreset,
  requiresDataEngineeringReview,
} from "../../../../src/domains/data-engineering/index.js";

test("DataEngineeringTaskTypeSchema accepts valid task types", () => {
  const types = ["ingest", "clean", "transform"] as const;
