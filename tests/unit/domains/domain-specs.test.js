...
import { DomainRiskSpecSchema, DomainLifecycleStateSchema, DomainPlanningModeSchema, DomainHotPathModeSchema, DomainExecutionProfileSchema, DomainCoreDescriptorSchema, DomainKnowledgeSpecSchema, DomainEvalSpecSchema, DomainGovernanceSpecSchema, DomainInteractionSpecSchema, resolveDomainRiskSpec, } from "../../../src/domains/domain-specs.js";
// ─────────────────────────────────────────────────────────────────────────────
...
test("DomainRiskSpecSchema accepts all compensation models", () => {
    const models = ["refund", "reversal", "appeal", "manual_repair", "no_compensation"];
    const spec = DomainRiskSpecSchema.parse({
...
test("DomainLifecycleStateSchema accepts all valid states", () => {
    const states = ["draft", "validated", "registered", "active", "updating", "deprecated", "archived"];
...
test("DomainExecutionProfileSchema accepts all latency tiers", () => {
    const tiers = ["realtime", "near_realtime", "interactive", "batch"];
...
//# sourceMappingURL=domain-specs.test.js.map