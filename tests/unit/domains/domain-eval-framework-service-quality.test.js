...
test("DomainEvalFrameworkService assessQuality throws for missing domain", () => {
    ...
    assert.throws(() => service.assessQuality("nonexistent_domain", { accuracy: 0.9 }), /domain_eval\.framework_not_found/);
});
...
//# sourceMappingURL=domain-eval-framework-service-quality.test.js.map