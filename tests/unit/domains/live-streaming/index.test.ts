...
import {
  LiveStreamingTaskTypeSchema,
  LIVE_STREAMING_DOMAIN_PRESET,
  LiveStreamingDomainPreset,
  requiresLiveStreamingReview,
} from "../../../../src/domains/live-streaming/index.js";

test("LiveStreamingTaskTypeSchema accepts valid task types", () => {
  const types = ["prepare", "moderate", "respond"] as const;
