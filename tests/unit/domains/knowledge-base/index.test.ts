...
import {
  KnowledgeBaseTaskTypeSchema,
  KNOWLEDGE_BASE_DOMAIN_PRESET,
  requiresKnowledgeBaseReview,
} from "../../../../src/domains/knowledge-base/index.js";

test("KnowledgeBaseTaskTypeSchema accepts valid task types", () => {
  const types = ["ingest", "search", "curate"] as const;
