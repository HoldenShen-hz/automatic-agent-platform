...
import { HumanResourcesTaskTypeSchema, HUMAN_RESOURCES_DOMAIN_PRESET, requiresHumanResourcesReview, } from "../../../../src/domains/human-resources/index.js";
test("HumanResourcesTaskTypeSchema accepts valid task types", () => {
    const types = ["screen", "review", "coordinate"];
