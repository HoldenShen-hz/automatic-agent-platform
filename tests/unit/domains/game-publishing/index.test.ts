...
import {
  GamePublishingTaskTypeSchema,
  GAME_PUBLISHING_DOMAIN_PRESET,
  GamePublishingDomainPreset,
  requiresGamePublishingReview,
} from "../../../../src/domains/game-publishing/index.js";

test("GamePublishingTaskTypeSchema accepts valid task types", () => {
  const types = ["package", "review", "release"] as const;
