...
import {
  IndustryResearchTaskTypeSchema,
  INDUSTRY_RESEARCH_DOMAIN_PRESET,
  requiresIndustryResearchReview,
} from "../../../../src/domains/industry-research/index.js";

test("IndustryResearchTaskTypeSchema accepts valid task types", () => {
  const types = ["research", "summarize", "brief"] as const;
