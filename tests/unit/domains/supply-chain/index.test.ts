...
import {
  SupplyChainTaskTypeSchema,
  SUPPLY_CHAIN_DOMAIN_PRESET,
  SupplyChainDomainPreset,
  requiresSupplyChainReview,
} from "../../../../src/domains/supply-chain/index.js";

test("SupplyChainTaskTypeSchema accepts valid task types", () => {
  const types = ["plan", "route", "resolve"] as const;
