...
function createTestProfile(domainId, defaultRiskLevel = "medium") {
    return {
...
test("DomainRiskProfileService registers and retrieves a risk profile", () => {
...
test("DomainRiskProfileService returns null for unregistered domain", () => {
    const service = new DomainRiskProfileService();
    const retrieved = service.getProfile("unknown_domain");
    assert.strictEqual(retrieved, null);
});
test("DomainRiskProfileService computes effective risk level as low for low scores", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService computes effective risk level as medium for moderate scores", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService computes effective risk level as high for high scores", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService computes effective risk level as critical for very high scores", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService returns dimension scores with weighted calculations", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService throws error for unregistered domain", () => {
    const service = new DomainRiskProfileService();
    assert.throws(() => service.assessRisk("unknown", { data_sensitivity: 50 }), /profile_not_found/);
});
test("DomainRiskProfileService adds a risk override", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService applies overrides during risk assessment", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService removes an existing override", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService returns false when removing non-existent override", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService resolves domain_owner escalation for low scores", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService resolves platform_sre escalation for medium scores", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService resolves security_team escalation for critical scores", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService returns null escalation target when no chain defined", () => {
    const service = new DomainRiskProfileService();
    const profile = {
...
test("DomainRiskProfileService returns required approvals for matching patterns", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService does not return approvals when overrides do not require justification", () => {
    const service = new DomainRiskProfileService();
    const profile = {
...
test("DomainRiskProfileService handles missing dimension scores by using threshold", () => {
    const service = new DomainRiskProfileService();
...
test("DomainRiskProfileService handles empty dimensions array", () => {
    const service = new DomainRiskProfileService();
    const profile = {
...
test("DomainRiskProfileService handles wildcard action pattern matching", () => {
    const service = new DomainRiskProfileService();
...
//# sourceMappingURL=domain-risk-profile-service.test.js.map