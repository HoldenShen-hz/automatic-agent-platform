...
import {
  EducationTaskTypeSchema,
  EDUCATION_DOMAIN_PRESET,
  EducationDomainPreset,
  requiresEducationReview,
} from "../../../../src/domains/education/index.js";

test("EducationTaskTypeSchema accepts valid task types", () => {
  const types = ["design", "coach", "assess"] as const;
