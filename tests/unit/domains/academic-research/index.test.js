...
import { AcademicResearchTaskTypeSchema, ACADEMIC_RESEARCH_DOMAIN_PRESET, requiresAcademicResearchReview, } from "../../../../src/domains/academic-research/index.js";
test("AcademicResearchTaskTypeSchema accepts valid task types", () => {
    const types = ["collect", "evaluate", "synthesize"];
