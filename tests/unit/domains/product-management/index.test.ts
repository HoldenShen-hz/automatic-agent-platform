...
import {
  ProductManagementTaskTypeSchema,
  PRODUCT_MANAGEMENT_DOMAIN_PRESET,
  requiresProductManagementReview,
} from "../../../../src/domains/product-management/index.js";

test("ProductManagementTaskTypeSchema accepts valid task types", () => {
  const types = ["discover", "prioritize", "specify"] as const;
