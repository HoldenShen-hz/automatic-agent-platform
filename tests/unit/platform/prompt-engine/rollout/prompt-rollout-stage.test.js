...
import { PROMPT_ROLLOUT_STAGES, isPromptRolloutStage, comparePromptRolloutStage, nextPromptRolloutStage, } from "../../../../../src/platform/prompt-engine/rollout/prompt-rollout-stage.js";
...
test("nextPromptRolloutStage stage progression covers all non-terminal stages", () => {
    ...
    for (const stage of nonTerminal) {
        ...
        assert.ok(PROMPT_ROLLOUT_STAGES.includes(next), `Next stage ${next} is not a valid stage`);
    }
});
//# sourceMappingURL=prompt-rollout-stage.test.js.map