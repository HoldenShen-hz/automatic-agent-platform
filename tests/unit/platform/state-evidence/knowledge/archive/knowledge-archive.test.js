...
function createMockKnowledgeSource(overrides = {}) {
    return {
        sourceId: "src_1",
        sourceType: "document",
        checksum: "abc123",
...
function createMockKnowledgeDocument(overrides = {}) {
    return {
        documentId: "doc_1",
        namespace: "test",
...
function createMockKnowledgeChunk(overrides = {}) {
    return {
        chunkId: "chunk_1",
        documentId: "doc_1",
...
//# sourceMappingURL=knowledge-archive.test.js.map