...
test("EmbeddingProviderType is one of the provider types", () => {
    const types = ["hash", "openai", "minimax"];
...
test("createEmbeddingProviderFromEnv throws for openai without api key", () => {
    ...
    assert.throws(() => createEmbeddingProviderFromEnv(env), /OPENAI_API_KEY or AA_OPENAI_API_KEY/);
});
...
test("createEmbeddingProviderFromEnv throws for minimax without api key", () => {
    ...
    assert.throws(() => createEmbeddingProviderFromEnv(env), /MINIMAX_API_KEY or AA_MINIMAX_API_KEY/);
});
