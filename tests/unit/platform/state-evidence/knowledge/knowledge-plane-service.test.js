...
test("KnowledgePlaneService merges local and domain retriever results", async () => {
    ...
    let pluginKnowledgeRef = { knowledgeRef: "knowledge:missing", snippet: "Missing chunk", score: 0.5, namespace: "coding/repo", chunkId: "chunk:missing", documentId: "doc:missing", matchType: "keyword" };
    ...
    pluginKnowledgeRef = { knowledgeRef: `knowledge:${pluginChunk.chunkId}`, snippet: "Plugin supplied snippet", score: 0.9, namespace: "coding/repo", chunkId: pluginChunk.chunkId, documentId: "doc:plugin", matchType: "semantic" };
...
test("KnowledgePlaneService initialize fails closed when semantic backend bootstrap fails", async () => {
    class FailingSemanticVectorStore {
        backend = "pgvector";
        async upsertChunks(_records) {
            throw new Error("semantic.init_failed");
        }
        async querySimilar(_input) {
            return [];
        }
        inspect() {
            return {
...
test("KnowledgePlaneService audits and filters cross-domain plugin knowledge access", async () => {
    const pluginRegistry = new PluginSpiRegistry();
    let pluginKnowledgeRef = { knowledgeRef: "knowledge:missing", snippet: "Missing chunk", score: 0.5, namespace: "shared/finance", chunkId: "chunk:missing", documentId: "doc:missing", matchType: "keyword" };
    pluginRegistry.register({
...
//# sourceMappingURL=knowledge-plane-service.test.js.map