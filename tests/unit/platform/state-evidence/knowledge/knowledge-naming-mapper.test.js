...
toDocTrustLevel, toCodeTrustLevel, isTrustLevelAtOrAbove, TRUST_LEVEL_TO_DOC, TRUST_LEVEL_TO_CODE, 
// Memory layer conversions
toDocMemoryLayer, toCodeMemoryLayer, isMemoryLayerAtOrAbove, MEMORY_LAYER_TO_DOC, MEMORY_LAYER_TO_CODE, getMemoryLayerDescription, getTrustLevelDescription, } from "../../../../../src/platform/state-evidence/knowledge/governance/knowledge-naming-mapper.js";
...
test("TRUST_LEVEL_TO_DOC mapping is complete and bidirectional", () => {
    for (const code of ["trusted", "external", "untrusted"]) {
...
test("TRUST_LEVEL_TO_CODE mapping is complete and bidirectional", () => {
    for (const doc of ["verified", "unverified", "deprecated"]) {
...
test("MEMORY_LAYER_TO_DOC mapping is complete and bidirectional", () => {
    for (const code of ["layer_3", "layer_4", "layer_5"]) {
...
test("MEMORY_LAYER_TO_CODE mapping is complete and bidirectional", () => {
    for (const doc of ["working", "episodic", "semantic"]) {
