...
test("KnowledgeQueryService selectQueryLevel boundary at exactly quickConfidenceThreshold", () => {
    const service = new KnowledgeQueryService({ query: () => [], queryAsync: () => Promise.resolve([]) }, { quickConfidenceThreshold: 0.5 });
...
//# sourceMappingURL=knowledge-coverage-supplemental.test.js.map