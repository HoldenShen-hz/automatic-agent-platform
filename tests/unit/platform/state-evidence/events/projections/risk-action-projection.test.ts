...
import {
  ...
  createEmptyRiskActionState,
  createRiskActionProjectionHandler,
...
test("riskActionProjectionHandler handles risk:decision_requested", () => {
  ...
  const state = riskActionProjectionHandler(null, event) as unknown as RiskActionState;
...
test("riskActionProjectionHandler accumulates policyIds", () => {
  ...
  const state1 = riskActionProjectionHandler(null, event1) as unknown as RiskActionState;
  ...
  const state2 = riskActionProjectionHandler(state1 as unknown as Record<string, unknown>, event2) as unknown as RiskActionState;
...
test("riskActionProjectionHandler is idempotent - same event applied twice", () => {
  ...
  const state1 = riskActionProjectionHandler(null, event) as unknown as RiskActionState;
...
test("riskActionProjectionHandler builds timeline in order", () => {
  ...
  const finalState = state as unknown as RiskActionState;
...
test("riskActionProjectionHandler extracts riskScore from alternate field names", () => {
  ...
  const state2 = riskActionProjectionHandler(null, event2) as unknown as RiskActionState;
...
test("createRiskActionProjectionHandler returns handler function", () => {
  ...
  assert.equal((state as unknown as RiskActionState).riskDecisionId, "test_handler");
});