...
import { TrustLevelService, getTrustLevelMetadata, getTrustLevelPriority, compareTrustLevels, canTransitionTrustLevel, DEFAULT_TRUST_TRANSITION_RULES, } from "../../../../../src/platform/state-evidence/memory/index.js";
...
test("getTrustLevelMetadata returns null for invalid level", () => {
    assert.equal(getTrustLevelMetadata("invalid"), null);
});
...
test("getTrustLevelPriority returns 0 for invalid level", () => {
    assert.equal(getTrustLevelPriority("invalid"), 0);
});
...
//# sourceMappingURL=trust-level-service.test.js.map