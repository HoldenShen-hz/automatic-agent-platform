...
import { getMemoryState, matchesMemoryRecallQuery, filterAndSortMemories, buildMemoryQualityReport, } from "../../../../../src/platform/state-evidence/memory/memory-quality.js";
...
test("getMemoryState returns revoked when revokedAt is in past", () => {
    const record = createMemoryRecord({
        revokedAt: "2026-04-13T00:00:00.000Z",
    });
    const state = getMemoryState(record, "2026-04-14T00:00:00.000Z");
...
test("filterAndSortMemories sorts by createdAt descending", () => {
    const records = [
        createMemoryRecord({ id: "mem_1", createdAt: "2026-04-10T00:00:00.000Z" }),
        createMemoryRecord({ id: "mem_2", createdAt: "2026-04-14T00:00:00.000Z" }),
        createMemoryRecord({ id: "mem_3", createdAt: "2026-04-12T00:00:00.000Z" }),
    ];
...
test("buildMemoryQualityReport returns correct counts", () => {
    const records = [
        ...
        createMemoryRecord({ id: "mem_2", expiresAt: "2026-04-13T00:00:00.000Z", revokedAt: null }),
        createMemoryRecord({ id: "mem_3", expiresAt: null, revokedAt: "2026-04-13T00:00:00.000Z" }),
...
test("buildMemoryQualityReport calculates activeCount per breakdown group", () => {
    ...
    const records = [
        ...
        createMemoryRecord({ id: "mem_2", scope: "session", expiresAt: "2026-04-13T00:00:00.000Z", revokedAt: null }), // expired
...
//# sourceMappingURL=memory-quality.test.js.map