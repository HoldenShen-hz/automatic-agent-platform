...
import type { ArtifactRecord, ArtifactLink } from "../../../../../src/platform/state-evidence/artifacts/artifact-model.js";
...
test("ArtifactBundleService.build creates defensive copies of artifacts", () => {
  const service = new ArtifactBundleService();
  const originalArtifacts: readonly ArtifactRecord[] = [
    {
      artifactId: "artifact_1",
      taskId: "task_1",
      stepId: "step_1",
  ...
  (bundle.artifacts as ArtifactRecord[]).push({
    artifactId: "artifact_2",
    taskId: "task_1",
    stepId: "step_1",
    agentRole: "builder",
