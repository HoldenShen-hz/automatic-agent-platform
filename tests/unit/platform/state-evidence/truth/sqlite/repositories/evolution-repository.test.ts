...
test("EvolutionRepository inserts evolution proposal", () => {
  ...
  const proposal: Parameters<EvolutionRepository["insertEvolutionProposal"]>[0] = {
    id: "evo_proposal_1",
    taskId: "task_1",
    executionId: "exec_1",
...
test("EvolutionRepository updates evolution proposal", () => {
  ...
  const now = "2026-04-21T10:00:00.000Z";
  const proposal: Parameters<EvolutionRepository["updateEvolutionProposal"]>[0] = {
    id: "evo_proposal_2",
    taskId: "task_1",
    executionId: "exec_1",
    sourceAgentId: "agent_a",
...
test("EvolutionRepository lists evolution proposals by status", () => {
  ...
  const result = repo.listEvolutionProposals("pending_approval");
  assert.ok(Array.isArray(result));
});
...
test("EvolutionRepository inserts evolution policy", () => {
  ...
  const now = "2026-04-21T10:00:00.000Z";
  const policy: Parameters<EvolutionRepository["insertEvolutionPolicy"]>[0] = {
    id: "evo_policy_1",
...
test("EvolutionRepository lists evolution policies with filters", () => {
  ...
  const result = repo.listEvolutionPolicies({ kind: "budget_adjustment", status: "active" });
  assert.ok(Array.isArray(result));
});
...
test("EvolutionRepository inserts evolution log", () => {
  ...
  const now = "2026-04-21T10:00:00.000Z";
  const log: Parameters<EvolutionRepository["insertEvolutionLog"]>[0] = {
    id: "evo_log_1",
    proposalId: "evo_proposal_1",
    taskId: "task_1",
    executionId: "exec_1",
...
test("EvolutionRepository inserts PMF validation report", () => {
  ...
  const now = "2026-04-21T10:00:00.000Z";
  const report: Parameters<EvolutionRepository["insertPmfValidationReport"]>[0] = {
    id: "pmf_report_1",
