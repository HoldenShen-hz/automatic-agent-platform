...
import type { SessionStatus, ApprovalStatus } from "../../../../../../src/platform/contracts/types/status.js";
import type { MessageDirection, RemoteLogLevel, GatewayTargetKind, GatewayTargetSource, MessagePartType, TakeoverSessionStatus, OperatorActionType } from "../../../../../../src/platform/contracts/types/domain/primitives.js";
...
test("RemoteLogRecord level accepts all valid values", () => {
  const levels: RemoteLogRecord["level"][] = ["debug", "info", "warn", "error"];
...
test("OperatorActionRecord allows all action types", () => {
  const actionTypes: OperatorActionType[] = [
    "take_over_task",
    "modify_input",
    "retry_execution",
    "skip_step",
