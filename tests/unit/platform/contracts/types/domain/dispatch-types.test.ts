...
} from "../../../../../../src/platform/contracts/types/domain/dispatch-types.js";
import type {
...
test("DispatchDecisionTrace allows with evaluations", () => {
  const workerEval: DispatchWorkerEvaluation = {
...
test("RemoteAvailability accepts all valid values", () => {
  const avail: RemoteAvailability[] = ["healthy", "partial_available", "degraded", "unavailable"];
