...
test("ReleaseBundleRecord accepts all rollout strategies", () => {
    const rolling = { rolloutStrategy: "rolling" };
    const canary = { rolloutStrategy: "canary" };
    const blueGreen = { rolloutStrategy: "blue_green" };
...
//# sourceMappingURL=release-types.test.js.map