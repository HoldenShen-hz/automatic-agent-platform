...
import { createPlatformPrincipal, createRequestEnvelope, createControlDirective, createExecutionPlan, createExecutionReceipt, createStateCommand, createEvidenceRecord, createProjectionUpdate, } from "../../../../../src/platform/contracts/types/platform-contracts.js";
...
function createTestPrincipal(overrides) {
    return {
        actorId: "actor-1",
        tenantId: "tenant-1",
        roles: ["user"],
...
test("createExecutionPlan applies optional fields", () => {
    const principal = createTestPrincipal();
    const budget = { maxSteps: 5, maxDurationMs: 30000, maxCost: 50 };
    const sideEffect = {
        effectId: "effect-1",
        category: "write",
...
//# sourceMappingURL=platform-contracts.test.js.map