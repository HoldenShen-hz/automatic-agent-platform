...
import { mapPolicyModeToUnifiedRuntimeMode, mapHealthDegradationModeToUnifiedRuntimeMode, mapAutonomyLevelToUnifiedRuntimeMode, normalizeUnifiedRuntimeMode, toDocumentedUnifiedRuntimeMode, } from "../../../../../src/platform/contracts/types/unified-runtime-mode.js";
// ---------------------------------------------------------------------------
// UnifiedRuntimeMode type
// ---------------------------------------------------------------------------
test("UnifiedRuntimeMode accepts full_auto", () => {
    const mode = "full_auto";
    assert.equal(mode, "full_auto");
});
test("UnifiedRuntimeMode accepts supervised_auto", () => {
    const mode = "supervised_auto";
...
test("mapPolicyModeToUnifiedRuntimeMode falls back to manual_only for unknown values", () => {
    const result = mapPolicyModeToUnifiedRuntimeMode("unknown_value");
    assert.equal(result, "manual_only");
});
// ---------------------------------------------------------------------------
...
test("mapHealthDegradationModeToUnifiedRuntimeMode falls back to manual_only for unknown values", () => {
    const result = mapHealthDegradationModeToUnifiedRuntimeMode("unknown_mode");
    assert.equal(result, "manual_only");
});
// ---------------------------------------------------------------------------
...
test("mapAutonomyLevelToUnifiedRuntimeMode falls back to manual_only for unknown values", () => {
    const result = mapAutonomyLevelToUnifiedRuntimeMode("unknown_level");
    assert.equal(result, "manual_only");
});
// ---------------------------------------------------------------------------
...
//# sourceMappingURL=unified-runtime-mode.test.js.map