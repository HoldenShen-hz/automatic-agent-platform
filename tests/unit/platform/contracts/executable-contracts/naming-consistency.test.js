...
test("v4.3 canonical module does not re-export legacy contract entry names", () => {
    ...
    for (const forbiddenExport of forbiddenExports) {
        assert.equal(exportedNames.includes(forbiddenExport), false, `${forbiddenExport} must remain legacy/deprecated and outside the v4.3 canonical module`);
    }
});
...
//# sourceMappingURL=naming-consistency.test.js.map