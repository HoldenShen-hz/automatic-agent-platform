...
import { isPlatformFactEvent, isOapeflirViewEvent, canTruthConsumerConsume, getExecutableContract, } from "../../../../../src/platform/contracts/executable-contracts/index.js";
function createMockEventEnvelope(overrides = {}) {
    return {
...
test("type guards correctly narrow the event type", () => {
    ...
    if (isOapeflirViewEvent(oapeflirEvent)) {
        ...
        assert.ok(oapeflirEvent.eventType.startsWith("oapeflir.view.") ||
...
//# sourceMappingURL=event-type-guards.test.js.map