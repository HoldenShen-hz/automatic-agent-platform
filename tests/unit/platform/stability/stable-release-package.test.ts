...
function createProfileArtifactPath(profile: "smoke" | "24h" | "72h", fileName: string): string {
  return join(tmpdir(), "aa-stable-release", profile, fileName);
}
...
function createEvidenceBundleReport(profile: "smoke" | "24h" | "72h"): StableEvidenceBundleReport {
  return {
    ...
    outputDir: join(tmpdir(), "aa-stable-release", profile),
    profile: {
      name: profile,
    ...
    artifacts: {
      bundleReportPath: createProfileArtifactPath(profile, "stable-evidence-report.json"),
      chaosReportPath: createProfileArtifactPath(profile, "chaos-report.json"),
      promptInjectionReportPath: createProfileArtifactPath(profile, "prompt-injection-report.json"),
      concurrencyReportPath: createProfileArtifactPath(profile, "concurrency-report.json"),
      leaseReportPath: createProfileArtifactPath(profile, "lease-report.json"),
      validationReportPath: createProfileArtifactPath(profile, "validation-report.json"),
      soakReportPath: createProfileArtifactPath(profile, "soak-report.json"),
      doctorReportPath: createProfileArtifactPath(profile, "doctor-report.json"),
      acceptanceReportPath: createProfileArtifactPath(profile, "stable-acceptance-line-report.json"),
      repairReportPath: createProfileArtifactPath(profile, "repair-report.json"),
      drainEventsReportPath: createProfileArtifactPath(profile, "drain-events-report.json"),
      diagnosticSnapshotPath: createProfileArtifactPath(profile, "diagnostic-snapshot.json"),
      debugDumpPath: createProfileArtifactPath(profile, "debug-dump.json"),
      takeoverSamplePath: createProfileArtifactPath(profile, "takeover-sample.json"),
      rollbackReportPath: createProfileArtifactPath(profile, "rollback-report.json"),
      backupRestoreReportPath: createProfileArtifactPath(profile, "backup-restore-report.json"),
      backupRestorePlaybookPath: createProfileArtifactPath(profile, "backup-restore-playbook.json"),
      rollingUpgradeReportPath: createProfileArtifactPath(profile, "rolling-upgrade-report.json"),
      rollingUpgradePlaybookPath: createProfileArtifactPath(profile, "rolling-upgrade-playbook.json"),
      maintenanceReportPath: createProfileArtifactPath(profile, "maintenance-report.json"),
      maintenancePlaybookPath: createProfileArtifactPath(profile, "maintenance-playbook.json"),
      grayReleaseReportPath: createProfileArtifactPath(profile, "gray-release-report.json"),
      grayReleasePlaybookPath: createProfileArtifactPath(profile, "gray-release-playbook.json"),
      eventReplayReportPath: createProfileArtifactPath(profile, "event-replay-report.json"),
      dbQueueDisconnectReportPath: createProfileArtifactPath(profile, "db-queue-disconnect-report.json"),
      dbWritabilityReportPath: createProfileArtifactPath(profile, "db-writability-report.json"),
      queueDeliveryReportPath: createProfileArtifactPath(profile, "queue-delivery-report.json"),
      migrationCompatibilityReportPath: createProfileArtifactPath(profile, "migration-compatibility-report.json"),
      runtimeDbPath: createProfileArtifactPath(profile, "runtime/stable-evidence.db"),
    },
