...
test("RenderedMessageParts structure is correct", () => {
  const rendered: RenderedMessageParts = {
    content: "Hello world",
    trimmed: false,
    trimmedPartCount: 0,
  };
