...
test("resolvePlatformMainlineCapability works for all valid ids", () => {
  const validIds: PlatformMainlineCapabilityId[] = [
    "interface",
    "control-plane",
    "orchestration",
    "execution",
...
test("resolvePlatformMainlineCapability throws for invalid id", () => {
  assert.throws(
    () => resolvePlatformMainlineCapability("invalid" as PlatformMainlineCapabilityId),
    /platform_mainline.not_found/,
  );
  assert.throws(
    () => resolvePlatformMainlineCapability("" as PlatformMainlineCapabilityId),
    /platform_mainline.not_found/,
  );
});
...
test("PlatformMainlineCapabilityId type accepts all valid ids", () => {
  const allIds: PlatformMainlineCapabilityId[] = [
    "interface",
    "control-plane",
    "orchestration",
    "execution",
