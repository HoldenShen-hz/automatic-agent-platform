      ...
      await assert.rejects(
        ...
        (error: unknown) => {
          if (error instanceof Error && "code" in error) {
            return (error as { code: string }).code === "dek.active_exists";
          }
          return false;
        },
      );
  ...
  describe("createForSubject", () => {
    ...
    it("should throw for empty subject ID", async () => {
      await assert.rejects(
        ...
        (error: unknown) => {
          if (error instanceof Error && "code" in error) {
            return (error as { code: string }).code === "dek.missing_subject";
          }
          return false;
        },
      );
  ...
  describe("encryptForSubject and decrypt", () => {
    ...
    it("should throw when DEK is destroyed", async () => {
      ...
      await assert.rejects(
        ...
        (error: unknown) => {
          if (error instanceof Error && "code" in error) {
            return (error as { code: string }).code === "dek.destroyed";
          }
          return false;
        },
      );
  ...
  describe("shred", () => {
    ...
    it("should throw for empty subject ID", async () => {
      await assert.rejects(
        ...
        (error: unknown) => {
          if (error instanceof Error && "code" in error) {
            return (error as { code: string }).code === "shred.missing_subject";
          }
          return false;
        },
      );
...
describe("InMemoryShredAuditTrail", () => {
  let trail: InMemoryShredAuditTrail;
