...
test("ErasurePlanningService creates plan with erase action for PII", () => {
  ...
  const targets = [
    { targetRef: "task_123", targetKind: "task" as const, containsPii: true },
  ];
...
test("ErasurePlanningService creates plan with hold action for legal hold", () => {
  const service = new ErasurePlanningService();
  const targets = [
    { targetRef: "task_123", targetKind: "task" as const, containsPii: true, legalHold: true },
  ];
...
test("ErasurePlanningService creates plan with redact action for backup copies", () => {
  const service = new ErasurePlanningService();
  const targets = [
    { targetRef: "task_123", targetKind: "task" as const, containsPii: true, backupCopy: true },
  ];
...
test("ErasurePlanningService creates plan with skip action for non-PII", () => {
  const service = new ErasurePlanningService();
  const targets = [
    { targetRef: "task_123", targetKind: "task" as const, containsPii: false },
  ];
...
test("ErasurePlanningService sets blocked status when any target has legal hold", () => {
  ...
  const targets = [
    { targetRef: "task_123", targetKind: "task" as const, containsPii: false },
    { targetRef: "task_456", targetKind: "task" as const, containsPii: true, legalHold: true },
    { targetRef: "task_789", targetKind: "task" as const, containsPii: false },
  ];
...
test("ErasurePlanningService preserves target kind in steps", () => {
  ...
  const targets = [
    { targetRef: "task_123", targetKind: "task" as const, containsPii: false },
    { targetRef: "msg_456", targetKind: "message" as const, containsPii: false },
    { targetRef: "art_789", targetKind: "artifact" as const, containsPii: false },
  ];
