...
test("TelegramGatewayConfig structure", () => {
  const config: import("../../../../../../src/platform/five-plane-interface/channel-gateway/types.js").TelegramGatewayConfig = {
    botToken: "12345:ABC",
...
test("SlackGatewayConfig structure", () => {
  const config: import("../../../../../../src/platform/five-plane-interface/channel-gateway/types.js").SlackGatewayConfig = {
    botToken: "xoxb-12345",
...
test("WebhookGatewayConfig structure", () => {
  const config: import("../../../../../../src/platform/five-plane-interface/channel-gateway/types.js").WebhookGatewayConfig = {
