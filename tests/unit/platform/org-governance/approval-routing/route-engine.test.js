...
import { resolveApprovalRoute, applySodPolicy, resolveAmountRoute, } from "../../../../../src/org-governance/approval-routing/route-engine/index.js";
...
test("resolveApprovalRoute uses amount_based when threshold rules exist", () => {
    ...
    const rules = [{ maxAmountUsd: 1000, targetNodeTypes: ["department"] }];
