...
import { validateOrgHierarchy, listAncestorNodeIds, listDescendantNodeIds, findRootNode, getNodesAtLevel, getNodeDepth, findLowestCommonAncestor, buildReportingChain, } from "../../../../../src/org-governance/org-model/hierarchy/index.js";
function mockOrgNode(overrides = {}) {
    return {
        orgNodeId: "node-1",
        nodeType: "department",
        displayName: "Test",
