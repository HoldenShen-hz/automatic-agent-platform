...
test("ServiceRegistry throws for unregistered service", () => {
    const registry = ServiceRegistry.getInstance();
    assert.throws(() => registry.get("nonexistent-service"), /ServiceRegistry: no service registered/);
});
test("ServiceRegistry reset clears all services", () => {
    ...
    registry.reset();
    assert.throws(() => registry.get("reset-test-service"), /ServiceRegistry: no service registered/);
});
// ============================================================================
...
// ============================================================================
import { provideContext, getContextOrNull, withContextPatch, hasTenantContext, hasWorkspaceContext, } from "../../../src/platform/shared/index.js";
