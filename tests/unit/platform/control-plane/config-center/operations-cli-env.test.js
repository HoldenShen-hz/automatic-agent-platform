...
import { loadDataPlaneCliEnv, loadEnterpriseGovernanceCliEnv, loadEnvironmentDeploymentCliEnv, loadOpsProgramCliEnv, loadPlatformOperatorCliEnv, } from "../../../../../src/platform/control-plane/config-center/operations-cli-env.js";
...
test("operations cli env loader fail-closes on malformed data-plane json", () => {
    assert.throws(() => loadDataPlaneCliEnv({
        AA_DB_PATH: "/tmp/data-plane.db",
