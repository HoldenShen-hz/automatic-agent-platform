...
test("HierarchicalConfigLoader.loadConfig tenant overrides platform", () => {
    ...
    const result = loader.loadConfig(platformConfig, tenantConfigs, {}, {}, "tenant-1");
...
test("HierarchicalConfigLoader.loadConfig pack overrides tenant", () => {
    ...
    const result = loader.loadConfig(platformConfig, tenantConfigs, packConfigs, {}, "tenant-1", "pack-1");
...
test("HierarchicalConfigLoader.loadConfig task_type overrides pack", () => {
    ...
    const result = loader.loadConfig(platformConfig, {}, packConfigs, taskTypeConfigs, null, "pack-1", "task-type-1");
...
test("HierarchicalConfigLoader.loadConfig returns layerMap with correct layer per key", () => {
    ...
    const result = loader.loadConfig(platformConfig, tenantConfigs, packConfigs, taskTypeConfigs, "tenant-1", "pack-1", "task-type-1");
...
//# sourceMappingURL=hierarchical-config-loader.test.js.map