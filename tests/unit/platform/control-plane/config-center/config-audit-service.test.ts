...
import { ConfigAuditService, type ConfigAuditAction } from "../../../../../src/platform/control-plane/config-center/config-audit-service.js";
...
test("ConfigAuditService query filters by action", () => {
  ...
  const result = service.query({ action: "delete" as ConfigAuditAction });
