...
import { ConfigRolloutService, RolloutPhase, } from "../../../../../src/platform/control-plane/config-center/config-rollout-service.js";
...
test("startRollout emits config.rollout.started event with event bus", () => {
    ...
    const service = new ConfigRolloutService({ eventBus: mockBus });
    const rollout = service.startRollout("runtime.timeout", "platform", null);
