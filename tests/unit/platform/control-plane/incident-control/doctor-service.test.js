...
import { DoctorService, summarizeDoctorChecks, } from "../../../../../src/platform/control-plane/incident-control/doctor-service.js";
...
test("doctor service builds unified self-check summaries for locks and backlog", () => {
    ...
    }, "/tmp/runtime.backup.db", null, null, {
        listWorkers: () => [
            {
                workerId: "worker-1",
                status: "idle",
...
//# sourceMappingURL=doctor-service.test.js.map