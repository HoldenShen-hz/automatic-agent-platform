...
import { RunbookExecutor, IncidentDrillService, parseRunbookMarkdown, PREDEFINED_SCENARIOS, } from "../../../../../../src/platform/control-plane/incident-control/runbook-executor/index.js";
...
test("IncidentDrillService records observations", () => {
    ...
    const observation = drillService.recordObservation("operator-1", "decision", "Identified worker disconnect as root cause", "good");
