...
import { TakeoverQueueManager, } from "../../../../../src/platform/control-plane/incident-control/takeover-queue-manager.js";
// =============================================================================
// Type Tests
// =============================================================================
...
test("EscalationLevel accepts all valid levels", () => {
    const levels = ["operator", "supervisor", "admin", "auto_close"];
...
test("TakeoverQueueManager enqueue throws when full", () => {
    ...
    assert.throws(() => manager.enqueue({
        taskId: "task-3",
        operatorId: "op",
        reasonCode: "test",
        actionType: "open_session",
        payload: { type: "open_session", reasonCode: "test" },
    }), (err) => err.code === "takeover.queue_full");
});
// =============================================================================
...
//# sourceMappingURL=human-takeover-service-async.test.js.map