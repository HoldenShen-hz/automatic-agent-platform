...
test("TenantBoundaryRegistryService assertSameTenant uses custom reasonCode", () => {
  ...
  assert.throws(
    ...
    (error: unknown) => error instanceof Error && (error as Record<string, unknown>).code === "custom.denial",
  );
});
...
test("TenantBoundaryRegistryService addOrganizationMembership throws for invalid userId", () => {
  ...
  assert.throws(
    ...
    (error: unknown) => error instanceof Error && (error as Record<string, unknown>).code === "tenant.invalid_user_id",
  );
});
...
test("TenantBoundaryRegistryService addOrganizationMembership throws for invalid organizationId", () => {
  ...
  assert.throws(
    ...
    (error: unknown) => error instanceof Error && (error as Record<string, unknown>).code === "tenant.invalid_organization_id",
  );
});
...
test("TenantBoundaryRegistryService addWorkspaceMembership throws for invalid workspaceId", () => {
  ...
  assert.throws(
    ...
    (error: unknown) => error instanceof Error && (error as Record<string, unknown>).code === "tenant.invalid_workspace_id",
  );
});
...
test("TenantBoundaryRegistryService listDeploymentBindingsForTenant throws for invalid tenantId", () => {
  ...
  assert.throws(
    ...
    (error: unknown) => error instanceof Error && (error as Record<string, unknown>).code === "tenant.invalid_tenant_id",
  );
});
