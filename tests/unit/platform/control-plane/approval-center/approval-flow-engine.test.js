...
import { VoteType, createInitialQuorumStatus, calculateQuorumStatus, mergeVotes, determineFinalStatus, validateVote, hasApproverVoted, getApproverVote, countEffectiveVotes, } from "../../../../../src/platform/control-plane/approval-center/quorum-calculator.js";
import { EscalationManager, EscalationReason, DelegationStatus, } from "../../../../../src/platform/control-plane/approval-center/escalation-manager.js";
...
test("calculateQuorumStatus detects quorum met", () => {
    const config = { minApprovals: 3, minRejectionsToDeny: 2 };
    const votes = [
...
test("calculateQuorumStatus with voting window expired", () => {
    const config = { minApprovals: 3, minRejectionsToDeny: 2, votingWindowMs: 1000 };
    const votes = [
        { approverId: "user1", voteType: VoteType.APPROVE, votedAt: "2026-04-21T00:00:00.000Z" },
    ];
...
test("validateVote throws for invalid vote", () => {
    const invalidVote = { approverId: "", voteType: VoteType.APPROVE, votedAt: "2026-04-21T00:00:00.000Z" };
...
test("EscalationManager resetDelegationTtl throws on max resets", () => {
    ...
    assert.throws(() => manager.resetDelegationTtl(updatedDelegation, 3600000), /Cannot reset TTL more than/);
});
...
//# sourceMappingURL=approval-flow-engine.test.js.map
