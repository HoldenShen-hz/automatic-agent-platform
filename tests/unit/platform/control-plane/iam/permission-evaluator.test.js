...
import { capabilitiesForRole, evaluateAuthorizationContext, inferCapabilitiesForAction, resolvePrincipalAccessProfile, roleGrantsCapabilities, } from "../../../../../src/platform/control-plane/iam/access-model.js";
...
test("PermissionEvaluator combines multiple roles to grant capabilities", () => {
    const result = roleGrantsCapabilities(["viewer", "human_operator"], ["fs:write", "exec:command"]);
    assert.equal(result, true);
});
...
//# sourceMappingURL=permission-evaluator.test.js.map
