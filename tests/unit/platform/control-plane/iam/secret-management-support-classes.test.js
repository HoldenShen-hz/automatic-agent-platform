...
import { EnvironmentBackedManagedSecretProvider, HybridManagedSecretProvider, createDefaultProviders, } from "../../../../../src/platform/control-plane/iam/secret-management-support.js";
// Helper to create a mock provider
function createMockProvider(config) {
    return {
        providerKind: config.providerKind,
        isConfigured: config.isConfigured,
        async describeSecret(_secretRef) {
            return config.describeSecretResponse;
        },
        async requireSecret(_secretRef) {
...
//# sourceMappingURL=secret-management-support-classes.test.js.map