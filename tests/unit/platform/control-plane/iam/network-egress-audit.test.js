...
import { parseUrlForAudit, classifyUrl, extractDestination, createEgressAuditEvent, NetworkEgressAuditService, } from "../../../../../src/platform/control-plane/iam/network-egress-audit.js";
...
test("NetworkEgressAuditService throws when disabled", () => {
    ...
    assert.throws(() => service.recordEgress("https://example.com", "fetch", true), /Network egress audit is disabled/);
});
...
//# sourceMappingURL=network-egress-audit.test.js.map