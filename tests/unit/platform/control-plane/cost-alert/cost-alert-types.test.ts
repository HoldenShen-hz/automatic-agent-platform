...
test("BudgetPolicy allows optional limit fields", () => {
  const policyWithLimits: BudgetPolicy = {
    scope: "platform",
    scopeId: "platform",
    period: "monthly",
    limitTokens: 1000000,
  ...
  const policyWithoutLimits: BudgetPolicy = {
    scope: "step",
    scopeId: "step-456",
    period: "per_run",
...
test("CostThresholdExceededEvent eventTier values", () => {
  const tiers: Array<CostThresholdExceededEvent["eventTier"]> = ["tier_1", "tier_2", "tier_3"];
...
test("BudgetPolicy validation - warningThreshold range", () => {
  ...
  const validPolicy: BudgetPolicy = {
    scope: "tenant",
    scopeId: "tenant-123",
    period: "monthly",
  ...
  const lowThreshold: BudgetPolicy = {
    scope: "pack",
    scopeId: "pack-1",
    period: "weekly",
  ...
  const highThreshold: BudgetPolicy = {
    scope: "pack",
    scopeId: "pack-2",
    period: "weekly",
