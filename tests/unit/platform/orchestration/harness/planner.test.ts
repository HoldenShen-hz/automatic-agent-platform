...
/**
 * Tests for src/platform/five-plane-orchestration/harness/planner/index.ts
 *
...
test("HARNESS_PLANNER_ROLE is distinct from HARNESS_GENERATOR_ROLE", async () => {
  const { HARNESS_GENERATOR_ROLE } = await import("../../../../../src/platform/five-plane-orchestration/harness/generator/index.js");
...
test("HARNESS_PLANNER_ROLE is distinct from other harness roles", async () => {
  const { HARNESS_GENERATOR_ROLE } = await import("../../../../../src/platform/five-plane-orchestration/harness/generator/index.js");
  const { HARNESS_PLANNER_ROLE: PLANNER_ROLE } = await import("../../../../../src/platform/five-plane-orchestration/harness/planner/index.js");
...
test("HARNESS_PLANNER_ROLE value is stable across module reloads", async () => {
  const { HARNESS_PLANNER_ROLE: role1 } = await import("../../../../../src/platform/five-plane-orchestration/harness/planner/index.js");
  const { HARNESS_PLANNER_ROLE: role2 } = await import("../../../../../src/platform/five-plane-orchestration/harness/planner/index.js");
