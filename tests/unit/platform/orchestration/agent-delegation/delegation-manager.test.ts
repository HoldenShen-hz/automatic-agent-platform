...
test("DelegationManagerService returns null chain for unknown agent", async () => {
  const service = createDelegationManager();
...
test("DelegationManagerService revokeExpiredDelegations handles empty store", async () => {
  const service = createDelegationManager();
