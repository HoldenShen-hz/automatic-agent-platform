...
import { REQUIRED_STABLE_ROLLBACK_TARGETS, buildStableRollbackPlaybook, } from "../../../../../src/platform/shared/stability/stable-rollback-rehearsal.js";
...
test("buildStableRollbackPlaybook covers required rollback targets, owners, and evidence", () => {
    ...
    try {
        ...
        assert.deepEqual(playbook.targets.map((target) => target.targetId), [...REQUIRED_STABLE_ROLLBACK_TARGETS]);
...
//# sourceMappingURL=stable-rollback-rehearsal.test.js.map