...
test("stable-worker-handshake-rehearsal module exports something [stable-worker-handshake-rehearsal]", () => {
...
test("stable-worker-handshake-rehearsal module exports StableWorkerHandshakeRehearsalService or similar [stable-worker-handshake-rehearsal]", () => {
