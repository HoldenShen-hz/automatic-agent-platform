...
function seedCompleted24hEvidence(evidenceRoot) {
    const outputDir = join(evidenceRoot, "24h");
    mkdirSync(outputDir, { recursive: true });
    writeFileSync(join(outputDir, "stable-evidence-campaign-state.json"), JSON.stringify({
    ...
    writeFileSync(join(outputDir, "stable-evidence-report.json"), JSON.stringify({
        startedAt: "2026-04-09T00:00:00.000Z",
...
test("stable evidence sequence advances from completed 24h evidence into 72h and records short synthetic evidence as blocked", async () => {
...
//# sourceMappingURL=stable-evidence-sequence.test.js.map
