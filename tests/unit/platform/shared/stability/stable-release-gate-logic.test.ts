...
function createMockEvidenceReport(overrides: Partial<StableEvidenceBundleReport["summary"]> = {}): StableEvidenceBundleReport {
  return {
    ...
    artifacts: {
      ...
      dispatchReportPath: "/tmp/evidence/dispatch-report.json",
      workerHandshakeReportPath: "/tmp/evidence/worker-handshake-report.json",
      workerWritebackReportPath: "/tmp/evidence/worker-writeback-report.json",
    ...
    summary: {
      ...
      totalDispatchScenarios: 2,
      totalWorkerHandshakeScenarios: 2,
      totalWorkerWritebackScenarios: 2,
      ...
      failedDispatchScenarios: 0,
      failedWorkerHandshakeScenarios: 0,
      failedWorkerWritebackScenarios: 0,
