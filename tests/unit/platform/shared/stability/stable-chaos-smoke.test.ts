...
test("stable-chaos-smoke module exports something [stable-chaos-smoke]", () => {
  const exports = Object.keys(stableChaosSmoke);
  assert.ok(exports.length > 0, "stable-chaos-smoke should export something");
});

test("stable-chaos-smoke module exports chaos smoke related symbols [stable-chaos-smoke]", () => {
