...
import { configureStructuredLogTransports, type StructuredLogTransportBootstrapConfig } from "../../../../../src/platform/shared/observability/log-transport-bootstrap.js";
...
test("configureStructuredLogTransports enables all three transports", () => {
  const config: StructuredLogTransportBootstrapConfig = {
    stdout: true,
    fluentd: { host: "fluentd.example.com", port: 24224, tag: "my-service" },
    datadog: { apiKey: "datadog-api-key", site: "datadoghq.com", service: "my-service" },
  };
