...
test("CacheMetrics record increments hits", () => {
...
test("CacheMetrics record increments misses", () => {
  const metrics = new CacheMetrics();
...
test("CacheMetrics hitRate calculated correctly", () => {
  const metrics = new CacheMetrics();
...
test("CacheMetrics record tracks layer distribution", () => {
  const metrics = new CacheMetrics();
...
test("CacheMetrics record tracks miss reason distribution", () => {
  const metrics = new CacheMetrics();
...
test("CacheMetrics snapshot returns correct total across namespaces", () => {
  const metrics = new CacheMetrics();
...
test("CacheMetrics hitRate is 0 when no entries", () => {
  const metrics = new CacheMetrics();
  const snap = metrics.snapshot();
  assert.equal(snap.hitRate, 0);
});

test("CacheMetrics namespace defaults to unknown when not provided", () => {
  const metrics = new CacheMetrics();
