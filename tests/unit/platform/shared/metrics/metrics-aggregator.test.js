...
class MockMetricsAggregator {
    ...
    percentile(sortedValues, quantile) {
...
test("MetricsAggregator normalizes labels with null/undefined", () => {
    aggregator.reset();
    aggregator.record("test_metric", { a: "value", b: null }, 10);
...
//# sourceMappingURL=metrics-aggregator.test.js.map