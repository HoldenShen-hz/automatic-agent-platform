...
import { clamp, roundCurrency, roundRatio, buildRecommendedBudgetPolicy, assertEvolutionScope, parseProposalPayload, parsePolicyValue, } from "../../../../../src/ops-maturity/drift-detection/evolution-mvp-support.js";
// ─────────────────────────────────────────────────────────────────────────────
...
test("parseProposalPayload handles budget adjustment with all fields", () => {
    ...
    assert.strictEqual(payload.proposalReason, "Normal increase");
});
test("parseProposalPayload handles experience promotion with empty keywords", () => {
    ...
    assert.deepEqual(payload.matchedKeywords, []);
});
test("parseProposalPayload handles experience promotion with all fields", () => {
    ...
    assert.strictEqual(payload.sourceTaskContext, "context here");
    assert.strictEqual(payload.sourceTaskIntent, "intent here");
    assert.strictEqual(payload.targetScope, "project");
    assert.strictEqual(payload.promotedSummary, "Reuse successful pattern");
    assert.strictEqual(payload.qualityScore, 0.95);
    assert.deepEqual(payload.matchedKeywords, ["kw1", "kw2", "kw3"]);
});
// ─────────────────────────────────────────────────────────────────────────────
...
//# sourceMappingURL=evolution-mvp-coverage-gaps.test.js.map