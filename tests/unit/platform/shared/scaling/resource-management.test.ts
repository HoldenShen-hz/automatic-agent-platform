...
import {
  ...
  // Fair Scheduler
  FairScheduler,
} from "../../../../../src/platform/shared/scaling/index.js";
...
describe("ResourceQuota", () => {
  ...
  describe("canAllocate", () => {
    const quota: ResourceQuota = createResourceQuota("org-1", {
...
describe("FairScheduler", () => {
  const totalCapacity: ResourceAllocation = {
