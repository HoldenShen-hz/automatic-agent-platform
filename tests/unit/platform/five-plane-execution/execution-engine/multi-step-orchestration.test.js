...
function createMockStorageContext(dbPath) {
...
test("runMultiStepOrchestration emits routing:decided event", async () => {
    ...
    try {
        ...
        const routingEvent = events.find((e) => e.eventType === "routing:decided");
...
//# sourceMappingURL=multi-step-orchestration.test.js.map