...
interface MockGracefulShutdown {
  initiateShutdownCalls: string[];
}

function createMockGracefulShutdown(): GracefulShutdown & MockGracefulShutdown {
  const mock: MockGracefulShutdown = {
  ...
  return {
    ...
    reset() {},
  } as unknown as GracefulShutdown & MockGracefulShutdown;
}
