...
test("MULTI_STEP_TOOL_DEFINITIONS tools have valid inputSchema structure", () => {
  for (const tool of MULTI_STEP_TOOL_DEFINITIONS) {
...
test("MULTI_STEP_TOOL_DEFINITIONS git tool has correct required fields", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS web_search tool has correct required fields", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS web_fetch tool has correct required fields", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS edit_replace tool has correct required fields", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS spawn-agent tool allows additionalProperties", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS read tool has correct properties", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS write tool has correct properties", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS grep tool has correct properties", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS glob tool has correct properties", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS repo_map tool has correct properties", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS todo_write tool has correct properties", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS question tool has correct properties", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS batch_edit_replace tool has correct properties", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS multifile_edit_replace tool has correct properties", () => {
...
test("getMultiStepToolDefinitions handles empty string in toolNames array", () => {
  const result = getMultiStepToolDefinitions(["read", "", "write"]);
  assert.equal(result.length, 2, "Should return only matching tools");
});

test("getMultiStepToolDefinitions handles whitespace-only strings in toolNames array", () => {
  const result = getMultiStepToolDefinitions(["read", "   ", "write"]);
