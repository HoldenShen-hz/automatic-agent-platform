...
test("complexity-router exports routeComplexity function [complexity-router-simple]", () => {
  assert.equal(typeof routeComplexity, "function");
});

test("routeComplexity returns expected structure [complexity-router-simple]", () => {
...
test("routeComplexity returns valid ComplexityPath [complexity-router-simple]", () => {
...
test("routeComplexity: short input returns passthrough [complexity-router-simple]", () => {
...
test("routeComplexity: full path keywords route to full [complexity-router-simple]", () => {
...
test("routeComplexity: fast path keywords route to fast [complexity-router-simple]", () => {
...
test("routeComplexity: default route is standard [complexity-router-simple]", () => {
...
test("routeComplexity: qaMode forces full path [complexity-router-simple]", () => {
...
test("routeComplexity: high token estimate routes to full [complexity-router-simple]", () => {
...
test("routeComplexity: multi-step workflow routes to standard or full [complexity-router-simple]", () => {
...
test("routeComplexity: custom config fullPathKeywords works [complexity-router-simple]", () => {
