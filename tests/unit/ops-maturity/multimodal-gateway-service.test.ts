...
test("MultimodalGatewayService builds explicit route decisions for supported modalities", () => {
  ...
  const result = service.handle({
    ...
    inputParts: [
      { partId: "part_text", type: "text", contentRef: "inline", text: "hello", mimeType: "text/plain" },
      { partId: "part_image", type: "image", contentRef: "img://1", mimeType: "image/png", imageMetadata: { width: 1920, height: 1080 } },
      { partId: "part_doc", type: "document", contentRef: "doc://1", mimeType: "application/pdf", documentChunks: ["a", "b"] },
    ],
