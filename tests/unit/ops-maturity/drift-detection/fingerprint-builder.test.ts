...
test.describe("BehaviorFingerprintBuilder", () => {
  test("build produces correct fingerprintId format", () => {
  ...
  test("build normalizes tools to sorted comma-separated string", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
      agentId: "agent-tools",
  ...
  test("build normalizes failureCategories to sorted comma-separated string", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
  ...
  test("build buckets latency as fast when below 1000ms", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
      agentId: "fast-agent",
      tools: [],
  ...
  test("build buckets latency as medium when between 1000ms and 5000ms", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
  ...
  test("build buckets latency as slow when 5000ms or above", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
      agentId: "slow-agent",
      tools: [],
  ...
  test("build buckets latency as slow when above 5000ms", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
  ...
  test("build buckets cost as low when below 0.1", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
      agentId: "cheap-agent",
      tools: [],
  ...
  test("build buckets cost as medium when between 0.1 and 1", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
  ...
  test("build buckets cost as high when 1 or above", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
  ...
  test("build handles empty tools array", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
  ...
  test("build handles empty failureCategories array", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
  ...
  test("build produces deterministic hash for same input", () => {
    const builder = new BehaviorFingerprintBuilder();
    const input = {
  ...
  test("build produces different hash for different agentId", () => {
    const builder = new BehaviorFingerprintBuilder();
  ...
  test("build produces different hash when tools differ", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result1 = builder.build({
      agentId: "same-agent",
      tools: ["read"],
  ...
  test("build produces different hash when failureCategories differ", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result1 = builder.build({
      agentId: "same-agent",
      tools: [],
  ...
  test("build produces different hash when latency differs across buckets", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result1 = builder.build({
      agentId: "same-agent",
      tools: [],
  ...
  test("build produces different hash when cost differs across buckets", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result1 = builder.build({
      agentId: "same-agent",
      tools: [],
  ...
  test("build produces same hash regardless of tool order (sorting)", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result1 = builder.build({
  ...
  test("build produces same hash regardless of failureCategory order (sorting)", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result1 = builder.build({
      agentId: "sorted-agent",
      tools: [],
  ...
  test("build returns all normalized features including agent, tools, failures, latency, cost", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
      agentId: "full-agent",
      tools: ["read", "edit"],
  ...
  test("build hash matches manually computed SHA-256", () => {
    const builder = new BehaviorFingerprintBuilder();
    const result = builder.build({
    ...
    const expectedHash = createHash("sha256")
      .update("subject_type:agent|baseline_ref:none|agent:verify-agent|tools:|failures:|latency_bucket:fast|cost_bucket:low|avg_step_count:0|step_count_bucket:short|window:none|tool_usage:{}|success_rate:0|risk_distribution:{}|drift_score:0")
      .digest("hex");

    assert.equal(result.hash, expectedHash);
  });

  test("build does not mutate original input arrays", () => {
    const builder = new BehaviorFingerprintBuilder();
