...
import { PromotionGate, DEFAULT_PROMOTION_GATE_CONFIG, type PromotionGateConfig, type PromotionDecision } from "../../../../src/ops-maturity/drift-detection/promotion-gate.js";
...
test("PromotionGate uses custom config", () => {
  const customConfig: PromotionGateConfig = {
