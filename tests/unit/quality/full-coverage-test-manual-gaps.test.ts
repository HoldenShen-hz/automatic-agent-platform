...
const SELF_QUALITY_GUARD_PATH = "tests/unit/quality/full-coverage-test-manual-gaps.test.ts";
...
const GAP_EVIDENCE: readonly GapEvidence[] = [
  ...
  },
  {
    ...
    tests: ["tests/unit/platform/contracts/mission-contracts.test.ts", "tests/unit/platform/control-plane/mission-services.test.ts", "tests/integration/platform/interface/api/mission-task-binding.test.ts", "tests/integration/quality/full-coverage-real-paths.test.ts"],
  },
  {
    id: "T-GAP-04",
    ...
    tests: ["tests/unit/domains/yono/yono-domain.test.ts", "tests/integration/platform/interface/api/yono-routes.test.ts", "tests/integration/quality/full-coverage-real-paths.test.ts"],
  },
  {
    id: "T-GAP-05",
    ...
    tests: ["tests/integration/platform/prompt-engine/eval/evaluation-integration.test.ts", "tests/e2e/prompt-injection-guard-e2e.test.ts", "tests/golden/prompt-assembly.test.ts", "tests/integration/quality/full-coverage-real-paths.test.ts"],
  },
  {
    id: "T-GAP-06",
    topic: "API 契约兼容与版本演进",
  ...
  },
  {
    ...
    tests: ["tests/unit/ops-maturity/chaos/chaos-experiment-scheduler.test.ts", "tests/integration/ops-maturity/chaos.integration.test.ts", "tests/e2e/ops-maturity/chaos-drift-e2e.test.ts", "tests/integration/quality/full-coverage-operational-real-paths.test.ts"],
  },
  {
    id: "T-GAP-09",
    topic: "灾备与多区域演练",
    ...
    tests: ["tests/unit/platform/stability/dr-drill-gate.test.ts", "tests/e2e/multi-region-failover.test.ts", "tests/e2e/failover-flow.test.ts", "tests/integration/quality/full-coverage-operational-real-paths.test.ts"],
  },
  {
    id: "T-GAP-10",
    topic: "可观测性语义测试",
    ...
    tests: ["tests/integration/platform/shared/observability/metrics-service.test.ts", "tests/integration/platform/shared/observability/structured-logging-integration.test.ts", "tests/golden/metrics-service-output.test.ts", "tests/integration/quality/full-coverage-operational-real-paths.test.ts"],
  },
  {
    id: "T-GAP-11",
    topic: "成本与预算防线",
    runtime: ["src/platform/model-gateway/cost-tracker/budget-guard.ts", "src/platform/five-plane-execution/budget-allocator.ts"],
    tests: ["tests/integration/platform/model-gateway/cost-tracker-budget-guard.test.ts", "tests/invariants/budget-reserve-before-execute.test.ts", "tests/e2e/budget-execution-blocking-e2e.test.ts", "tests/integration/quality/full-coverage-real-paths.test.ts"],
  },
  {
    id: "T-GAP-12",
    topic: "隐私、数据保留与脱敏",
    ...
    tests: ["tests/unit/ops-maturity/compliance-reporter/pii-redaction-and-auditor-access.test.ts", "tests/integration/platform/security/data-leakage-prevention.test.ts", "tests/e2e/tenant-isolation-flow.test.ts", "tests/integration/quality/full-coverage-operational-real-paths.test.ts"],
  },
  {
    id: "T-GAP-13",
    topic: "插件/Pack 生态兼容",
  ...
  },
  {
    ...
    tests: ["tests/unit/sdk/plugin-sdk-signature-sbom.test.ts", "tests/unit/domains/supply-chain/index.test.ts", "tests/integration/quality/full-coverage-operational-real-paths.test.ts"],
  },
  {
    id: "T-GAP-15",
    topic: "性能容量与资源泄漏",
  ...
  },
  {
    ...
    runtime: ["scripts/run-layered-tests.mjs", "tests/helpers/concurrent-runner.ts"],
  ...
  },
  {
    ...
    tests: ["tests/unit/platform/control-plane/config-center/startup-env-schema.test.ts", "tests/golden/deploy/helm-ingress-guardrails.test.ts", "tests/e2e/config-governance-e2e.test.ts", "tests/integration/quality/full-coverage-operational-real-paths.test.ts"],
  },
  {
    id: "T-GAP-18",
