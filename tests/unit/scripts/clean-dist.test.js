...
test("clean-dist prunes stale compiled tests even when dist is preserved", () => {
    ...
    try {
        ...
        const staleJs = join(workspace, "dist", "tests", "integration", "platform", "control-plane", "control-plane-integration.test.js");
        ...
        writeFileSync(staleMap, JSON.stringify({
            version: 3,
            file: "control-plane-integration.test.js",
            sources: ["../../../../../tests/integration/platform/control-plane/control-plane-integration.test.ts"],
            names: [],
            mappings: "",
        }));
        ...
        const liveJs = join(workspace, "dist", "tests", "integration", "platform", "control-plane", "operator-governance-integration.test.js");
        const liveMap = `${liveJs}.map`;
        writeFileSync(liveJs, "console.log('live');\n");
        writeFileSync(liveMap, JSON.stringify({
            version: 3,
...
//# sourceMappingURL=clean-dist.test.js.map