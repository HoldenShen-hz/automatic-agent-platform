...
import { PLATFORM_SURFACE_MANIFESTS, listPlatformSurfaceManifests, resolvePlatformSurfaceManifest, registerPlatformSurfaceCatalog, } from "../../src/platform/platform-module-catalog.js";
import { ServiceRegistry } from "../../src/platform/shared/lifecycle/service-registry.js";
const VALID_SURFACE_IDS = [
    "contracts",
    "interface",
    "x1-fabric",
    "control-plane",
...
test("resolvePlatformSurfaceManifest throws for unknown surfaceId", () => {
    assert.throws(() => resolvePlatformSurfaceManifest("unknown-surface"), (error) => error.message.includes("Unknown platform surface"));
});
...
test("registerPlatformSurfaceCatalog can be retrieved after registration", async () => {
    ...
    const retrieved = registry.get("platform.surface-catalog");
