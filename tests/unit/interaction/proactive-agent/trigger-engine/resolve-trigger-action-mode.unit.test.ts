...
test("resolveTriggerActionMode returns suggest when requireConfirmation is true [resolve-trigger-action-mode]", () => {
...
test("resolveTriggerActionMode returns auto_execute for low risk and suggest for medium/high risk without confirmation", () => {
