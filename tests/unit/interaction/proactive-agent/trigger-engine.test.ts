...
test("resolveTriggerActionMode returns suggest when requireConfirmation is true [interaction-trigger-engine]", () => {
...
test("resolveTriggerActionMode returns auto_execute only for low risk without confirmation", () => {
