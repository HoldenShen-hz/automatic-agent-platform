...
test("ProgressiveAutonomyService promotes highly reliable capability to semi_auto under engineering-ops guardrails", () => {
...
test("AutonomyAuditService returns recent changes sorted by time", () => {
  ...
  const event1: AutonomyChangeEvent = {
    eventType: "agent.autonomy.promoted",
    agentId: "agent_1",
    capabilityId: "cap_1",
  ...
  const event2: AutonomyChangeEvent = {
    eventType: "agent.autonomy.promoted",
    agentId: "agent_1",
    capabilityId: "cap_2",
    fromLevel: "supervised",
