...
test("resolveRequiredSlots returns empty missing when all slots resolved", () => {
  const entities = [
    { entityType: "user", value: "alice", normalized: "alice", sourceSpan: [0, 5] as const },
    { entityType: "task", value: "report", normalized: "report", sourceSpan: [6, 12] as const },
  ];
...
test("resolveRequiredSlots identifies missing slots", () => {
  const entities = [
    { entityType: "user", value: "bob", normalized: "bob", sourceSpan: [0, 3] as const },
  ];
...
test("resolveRequiredSlots handles empty requiredEntityTypes", () => {
  const entities = [
    { entityType: "user", value: "charlie", normalized: "charlie", sourceSpan: [0, 7] as const },
  ];
...
test("resolveRequiredSlots preserves normalized values", () => {
  const entities = [
    { entityType: "date", value: "2026-04-22", normalized: new Date("2026-04-22"), sourceSpan: [0, 10] as const },
    { entityType: "money", value: "$100", normalized: 100, sourceSpan: [11, 15] as const },
  ];
...
test("resolveRequiredSlots handles readonly entities array", () => {
  const entities: readonly { readonly entityType: string; readonly value: string; readonly normalized: unknown; readonly sourceSpan: readonly [number, number] }[] = [
    { entityType: "env", value: "prod", normalized: "prod", sourceSpan: [0, 4] as const },
  ];
...
test("resolveRequiredSlots handles empty string entityType", () => {
  const entities = [
    { entityType: "", value: "empty", normalized: "empty", sourceSpan: [0, 5] as const },
  ];
...
test("resolveRequiredSlots handles null normalized value", () => {
  const entities = [
    { entityType: "user", value: "null_user", normalized: null, sourceSpan: [0, 9] as const },
  ];
...
test("resolveRequiredSlots handles undefined normalized value", () => {
  const entities = [
    { entityType: "meta", value: "undef", normalized: undefined, sourceSpan: [0, 5] as const },
  ];
...
test("resolveRequiredSlots handles numeric entityType", () => {
  const entities = [
    { entityType: "123", value: "numeric_key", normalized: "numeric_key", sourceSpan: [0, 12] as const },
  ];
...
test("resolveRequiredSlots handles mixed resolved and missing", () => {
  const entities = [
    { entityType: "user", value: "alice", normalized: "alice", sourceSpan: [0, 5] as const },
    { entityType: "task", value: "job", normalized: "job", sourceSpan: [6, 9] as const },
    { entityType: "user", value: "bob", normalized: "bob_replaced", sourceSpan: [10, 13] as const },
  ];
...
test("resolveRequiredSlots handles special characters in entityType", () => {
  const entities = [
    { entityType: "user-name.with/special", value: "special", normalized: "special", sourceSpan: [0, 7] as const },
  ];
...
test("resolveRequiredSlots handles zero requiredEntityTypes and multiple entities", () => {
  const entities = [
    { entityType: "a", value: "1", normalized: 1, sourceSpan: [0, 1] as const },
    { entityType: "b", value: "2", normalized: 2, sourceSpan: [1, 2] as const },
    { entityType: "c", value: "3", normalized: 3, sourceSpan: [2, 3] as const },
  ];
