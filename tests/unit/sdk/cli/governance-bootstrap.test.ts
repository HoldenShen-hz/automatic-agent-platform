...
test("GovernanceServices interface requires health service", () => {
  const services = {
    health: {} as unknown as object,
    diagnostics: {} as unknown as object,
    doctor: {} as unknown as object,
    checker: {} as unknown as object,
    stalledDetector: {} as unknown as object,
    retentionService: {} as unknown as object,
    logger: {} as unknown as object,
  };
