...
import { loadGatewayTargetsCliEnv } from "../../../../src/platform/five-plane-control-plane/config-center/remaining-cli-env.js";
...
test("loadGatewayTargetsCliEnv throws ValidationError for unknown action", () => {
  assert.throws(
    ...
    (e: unknown) =>
      ...
      (e as ValidationError).code === "invalid_env:AA_GATEWAY_TARGET_ACTION",
  );
});
