...
import { INSPECT_KINDS } from "../../../../src/platform/five-plane-control-plane/config-center/remaining-cli-env-support.js";
...
test("loadInspectCliEnv throws for missing AA_INSPECT_KIND", () => {
  assert.throws(
    () => loadInspectCliEnv({}),
    (e) => e instanceof ValidationError && (e as ValidationError).code.includes("missing_env"),
  );
});
