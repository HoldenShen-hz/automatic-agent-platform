...
import { loadDispatchReconcileCliEnv } from "../../../../src/platform/five-plane-control-plane/config-center/ops-cli-env.js";
...
test("DispatchReconcileCliEnvConfig has correct action types", () => {
  const scanAction: "scan" = "scan";
  const repairAction: "repair" = "repair";
