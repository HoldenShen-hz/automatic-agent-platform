...
test("loadBillingCliEnv parses evaluate action", () => {
  const config = loadBillingCliEnv({
...
test("loadBillingCliEnv parses usage action", () => {
  const config = loadBillingCliEnv({
...
test("loadBillingCliEnv parses summary action", () => {
  const config = loadBillingCliEnv({
...
test("loadBillingCliEnv parses create_invoice action", () => {
  const config = loadBillingCliEnv({
...
test("loadBillingCliEnv parses list_invoices action with limit", () => {
  const config = loadBillingCliEnv({
...
test("loadBillingCliEnv parses list_payment_sessions action", () => {
  const config = loadBillingCliEnv({
...
test("loadBillingCliEnv parses reconcile_pending action", () => {
  const config = loadBillingCliEnv({
...
test("loadBillingCliEnv parses stripe payment gateway configuration", () => {
  const config = loadBillingCliEnv({
...
test("loadBillingCliEnv parses paddle payment gateway configuration", () => {
  const config = loadBillingCliEnv({
    AA_BILLING_ACTION: "create_checkout",
    AA_DB_PATH: "/tmp/test.db",
...
test("loadBillingCliEnv throws ValidationError for unknown action", () => {
  assert.throws(
    () =>
      loadBillingCliEnv({
...
test("loadBillingCliEnv returns null stripe fields when gateway credentials are not provided", () => {
  const config = loadBillingCliEnv({
    AA_BILLING_ACTION: "create_checkout",
    AA_DB_PATH: "/tmp/test.db",
    AA_PAYMENT_GATEWAY_KIND: "stripe",
