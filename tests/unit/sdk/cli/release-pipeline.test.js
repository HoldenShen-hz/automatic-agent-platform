...
test("loadReleasePipelineCliEnv invalid action throws", () => {
    assert.throws(() => loadReleasePipelineCliEnv({ AA_RELEASE_ACTION: "invalid" }), /release\.invalid_action/);
});
...
test("loadReleasePipelineCliEnv invalid runner throws", () => {
    assert.throws(() => loadReleasePipelineCliEnv({ AA_RELEASE_RUNNER: "invalid", AA_RELEASE_ACTION: "list" }), /release\.invalid_runner/);
});
...
test("loadReleasePipelineCliEnv invalid environment throws", () => {
    assert.throws(() => loadReleasePipelineCliEnv({
        AA_RELEASE_ACTION: "summary",
...
//# sourceMappingURL=release-pipeline.test.js.map