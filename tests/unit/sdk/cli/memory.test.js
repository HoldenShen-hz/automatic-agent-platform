...
test("loadMemoryCliEnv parses remember and sync_turn actions with current keys", () => {
...
test("loadMemoryCliEnv parses list and consolidate filters", () => {
...
test("loadMemoryCliEnv parses revoke and rejects unknown actions", () => {
    ...
    }), (error) => error instanceof ValidationError && error.code === "invalid_env:AA_MEMORY_ACTION");
});
