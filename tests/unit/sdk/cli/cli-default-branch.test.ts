...
test("loadBillingCliEnv throws billing.invalid_action for invalid AA_BILLING_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "billing.invalid_action",
  );
});
...
test("loadInspectCliEnv throws invalid_env for invalid AA_INSPECT_KIND", () => {
  assert.throws(
    ...
    (e: unknown) => e instanceof ValidationError && e.code === "invalid_env:AA_INSPECT_KIND",
  );
});
...
test("loadMemoryCliEnv throws invalid_env for invalid AA_MEMORY_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) => e instanceof ValidationError && e.code === "invalid_env:AA_MEMORY_ACTION",
  );
});
...
test("loadWorkerRegisterCliEnv throws invalid_env for invalid AA_WORKER_REGISTER_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "invalid_env:AA_WORKER_REGISTER_ACTION",
  );
});
...
test("loadWorkerHandshakeCliEnv throws invalid_env for invalid AA_WORKER_HANDSHAKE_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "invalid_env:AA_WORKER_HANDSHAKE_ACTION",
  );
});
...
test("loadPerceptionCliEnv throws invalid_env for invalid AA_PERCEPTION_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) => e instanceof ValidationError && e.code === "invalid_env:AA_PERCEPTION_ACTION",
  );
});
...
test("loadSkillCreatorCliEnv throws invalid_env for invalid AA_SKILL_CREATOR_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) => e instanceof ValidationError && e.code === "invalid_env:AA_SKILL_CREATOR_ACTION",
  );
});
...
test("loadMarketplaceCliEnv throws invalid_env for invalid AA_MARKETPLACE_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) => e instanceof ValidationError && e.code === "invalid_env:AA_MARKETPLACE_ACTION",
  );
});
...
test("loadShadowSnapshotCliEnv throws invalid_env for invalid AA_SHADOW_SNAPSHOT_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "invalid_env:AA_SHADOW_SNAPSHOT_ACTION",
  );
});
...
test("loadPmfCliEnv throws invalid_env for invalid AA_PMF_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) => e instanceof ValidationError && e.code === "invalid_env:AA_PMF_ACTION",
  );
});
...
test("loadEvolutionCliEnv throws invalid_env for invalid AA_EVOLUTION_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) => e instanceof ValidationError && e.code === "invalid_env:AA_EVOLUTION_ACTION",
  );
});
...
test("loadGatewayTargetsCliEnv throws invalid_env for invalid AA_GATEWAY_TARGET_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "invalid_env:AA_GATEWAY_TARGET_ACTION",
  );
});
...
test("loadTakeoverCliEnv throws unknown_takeover_action for invalid AA_TAKEOVER_ACTION", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "unknown_takeover_action:not_a_real_action",
  );
});
...
test("loadTakeoverCliEnv throws missing_env when AA_TAKEOVER_ACTION is absent", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "missing_env:AA_TAKEOVER_ACTION",
  );
});
...
test("loadDiagnosticsCliEnv throws missing_env when AA_DIAGNOSTICS_KIND is absent", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "missing_env:AA_DIAGNOSTICS_KIND",
  );
});
...
test("loadWorkerHandshakeCliEnv throws missing_env when AA_WORKER_ID is absent", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "missing_env:AA_WORKER_ID",
  );
});
...
test("loadWorkerHandshakeCliEnv throws missing_env when AA_LEASE_ID is absent", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "missing_env:AA_LEASE_ID",
  );
});
...
test("loadBillingCliEnv throws billing.missing_env when AA_DB_PATH is absent", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "billing.missing_env:AA_DB_PATH",
  );
});
...
test("loadShadowSnapshotCliEnv throws missing_env when AA_WORKSPACE_ROOT is absent", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "missing_env:AA_WORKSPACE_ROOT",
  );
});
...
test("loadShadowSnapshotCliEnv throws missing_env when AA_SHADOW_ROOT is absent", () => {
  assert.throws(
    ...
    (e: unknown) =>
      e instanceof ValidationError && e.code === "missing_env:AA_SHADOW_ROOT",
  );
});
