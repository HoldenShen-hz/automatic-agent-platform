...
import { CallGovernance, CallCircuitBreaker, CallHistoryRecorder, CallRateLimiter, createRetryPolicy, createBreakerPolicy, createLimiterPolicy, } from "../../../src/platform/execution/execution-engine/call-governance.js";
...
test("CallGovernance can use a distributed rate limiter when provided", async () => {
    ...
    const gov = new CallGovernance({ limiter: { maxCalls: 99, windowMs: 1000 } }, { distributedRateLimiter });
...
//# sourceMappingURL=call-governance.test.js.map