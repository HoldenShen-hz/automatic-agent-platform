...
test("MULTI_STEP_TOOL_DEFINITIONS should contain all expected tools", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS should have valid input schemas", () => {
...
test("todo_write tool should have correct schema structure", () => {
...
test("web_search tool should have required query field", () => {
...
test("git tool should have required args field", () => {
...
test("repo-map tool should have required query field", () => {
...
test("spawn-agent tool should allow additional properties", () => {
...
test("edit_replace tool should require filePath, oldString, and newString", () => {
...
test("read tool should have required path field", () => {
...
test("write tool should require path and content", () => {
...
test("grep tool should require pattern and path", () => {
...
test("glob tool should require pattern", () => {
...
test("getMultiStepToolDefinitions should filter by tool names", () => {
...
test("getMultiStepToolDefinitions should return empty array for empty input", () => {
  const result = getMultiStepToolDefinitions([]);
  assert.equal(result.length, 0, "should return empty array for empty input");
});

test("getMultiStepToolDefinitions should return empty array when no tools match", () => {
...
test("MULTI_STEP_TOOL_DEFINITIONS should be readonly", () => {
  assert.ok(
...
test("batch_edit_replace tool should require filePath and edits", () => {
...
test("multifile_edit_replace tool should require edits", () => {
...
test("web_fetch tool should require url", () => {
...
test("question tool should have question and context properties", () => {
