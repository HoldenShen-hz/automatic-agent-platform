...
describe("LicenseEnforcementService buildMeterKey", () => {
    test("meter key includes all context levels", () => {
        ...
        const meter = meters.find(m => m.accountId === "acct_1" &&
            m.workspaceId === "ws_1" &&
            m.tenantId === "tenant_1");
...
describe("LicenseEnforcementService usage metering edge cases", () => {
    ...
    test("recordFeatureUsage does nothing when metering disabled", () => {
        const service = new LicenseEnforcementService(createMockStore(), { enableUsageMetering: false });
...
//# sourceMappingURL=license-enforcement-service-edge-cases.test.js.map