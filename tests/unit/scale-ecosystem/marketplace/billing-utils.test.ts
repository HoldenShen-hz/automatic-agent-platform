...
test("assertIdentifier throws for invalid identifiers [billing-utils]", () => {
  ...
  assert.throws(
    () => assertIdentifier("a", "test.invalid"), // too short
    (e: any) => e.code === "test.invalid"
  );
  assert.throws(
    () => assertIdentifier("invalid name", "test.invalid"), // space
    (e: any) => e.code === "test.invalid"
  );
  assert.throws(
    () => assertIdentifier("invalid@name", "test.invalid"), // special char
    (e: any) => e.code === "test.invalid"
  );
  assert.throws(
    () => assertIdentifier("a".repeat(129), "test.invalid"), // too long
    (e: any) => e.code === "test.invalid"
  );
});
...
test("assertIdentifier throws for invalid special characters [billing-utils]", () => {
  ...
  // # is not allowed
  assert.throws(
    () => assertIdentifier("test#name", "test.invalid"),
    (e: any) => e.code === "test.invalid"
  );
});
...
test("assertPositiveNumber throws for negative numbers [billing-utils]", () => {
  ...
  assert.throws(
    () => assertPositiveNumber(-0.5, "test.invalid"),
    (e: any) => e.code === "test.invalid"
  );
});
...
test("assertPositiveNumber throws for non-finite values [billing-utils]", () => {
  ...
  assert.throws(
    () => assertPositiveNumber(NaN, "test.invalid"),
    (e: any) => e.code === "test.invalid"
  );
});
