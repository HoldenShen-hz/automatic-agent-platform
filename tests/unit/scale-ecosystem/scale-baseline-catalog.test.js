...
test("scale baseline services resolve from canonical submodule and root exports", () => {
    ...
    const submodulesByEntryModule = {
        "src/scale-ecosystem/billing/index.ts": billing,
        "src/scale-ecosystem/enterprise/index.ts": enterprise,
        ...
        "src/scale-ecosystem/intelligence/index.ts": intelligence,
        "src/scale-ecosystem/operations/index.ts": operations,
        "src/scale-ecosystem/tenant-platform/index.ts": tenantPlatform,
    };
