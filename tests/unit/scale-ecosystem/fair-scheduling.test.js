...
import { isQuotaExceeded, evaluateQuota, QuotaPolicySchema, } from "../../../src/scale-ecosystem/resource-manager/quota-enforcer/index.js";
...
function createPreemptionCandidate(overrides = {}) {
    return {
        ...
        lastCheckpointTimestampMs: overrides.lastCheckpointTimestampMs ?? Date.now() - 1000,
    };
}
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
function createResourcePool(overrides = {}) {
    return {
...
//# sourceMappingURL=fair-scheduling.test.js.map
