...
test("SlaExpiryChecker returns active status for SLA expiring in > 7 days", () => {
...
test("SlaExpiryChecker returns expiring_soon status for SLA expiring in <= 7 days", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
...
test("SlaExpiryChecker returns expired status for SLA that has passed", () => {
  const checker = new SlaExpiryChecker();
...
test("SlaExpiryChecker returns no warning for SLA expiring in > 7 days", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
...
test("SlaExpiryChecker issues info warning at 7 days", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
...
test("SlaExpiryChecker issues warning level at 3 days", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
...
test("SlaExpiryChecker issues critical warning at 1 day", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
...
test("SlaExpiryChecker handles same-day expiry as critical", () => {
  const checker = new SlaExpiryChecker();
...
test("SlaExpiryChecker handles expired SLA", () => {
  const checker = new SlaExpiryChecker();
  const pastDate = new Date();
...
test("SlaExpiryChecker uses custom warning intervals when provided", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
...
test("SlaExpiryChecker uses custom warning thresholds when provided", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
  futureDate.setDate(futureDate.getDate() + 5);
...
test("SlaExpiryChecker respects custom severity levels", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
  futureDate.setDate(futureDate.getDate() + 10);
...
test("SlaExpiryChecker handles domain thresholds with no custom thresholds", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
  futureDate.setDate(futureDate.getDate() + 30);
...
test("SlaExpiryChecker.checkBatch processes multiple SLAs", () => {
  const checker = new SlaExpiryChecker();
...
test("SlaExpiryChecker.checkBatch handles empty array", () => {
  const checker = new SlaExpiryChecker();
...
test("SlaExpiryChecker.checkBatch includes warning for expiring SLAs", () => {
  const checker = new SlaExpiryChecker();
...
test("SLA_EXPIRY_WARNING_DAYS contains expected intervals", () => {
  assert.deepEqual([...SLA_EXPIRY_WARNING_DAYS], [7, 3, 1]);
});

test("SLA_EXPIRY_WARNING_DAYS is frozen and ordered", () => {
...
test("SlaExpiryChecker handles exact boundary at 7 days", () => {
  const checker = new SlaExpiryChecker();
...
test("SlaExpiryChecker handles SLA with 0 days remaining", () => {
  const checker = new SlaExpiryChecker();
  const today = new Date();
...
test("SlaExpiryChecker records warning messages issued", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
  futureDate.setDate(futureDate.getDate() + 3);
...
test("SlaExpiryChecker handles different tier IDs", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
  futureDate.setDate(futureDate.getDate() + 3);
...
test("SlaExpiryChecker handles different domain IDs", () => {
  const checker = new SlaExpiryChecker();
  const futureDate = new Date();
  futureDate.setDate(futureDate.getDate() + 3);
