...
import { loadEnterpriseGovernanceCliEnv, loadOpsProgramCliEnv, loadPlatformOperatorCliEnv, loadDataPlaneCliEnv, loadAcceptanceReadinessCliEnv, } from "../../../src/platform/control-plane/config-center/operations-cli-env.js";
...
test("loadEnterpriseGovernanceCliEnv rejects invalid environment", () => {
    assert.throws(() => loadEnterpriseGovernanceCliEnv({
        AA_DB_PATH: "/tmp/db",
...
test("loadPlatformOperatorCliEnv rejects invalid target status", () => {
    assert.throws(() => loadPlatformOperatorCliEnv({
        AA_DB_PATH: "/tmp/db",
        AA_ENVIRONMENT: "prod",
...
//# sourceMappingURL=operations-cli-env.test.js.map