...
const REVIEW_DOC = join(process.cwd(), "docs_zh", "reviews", "architecture-code-cross-review.md");
...
//# sourceMappingURL=architecture-code-cross-review-alignment.test.js.map