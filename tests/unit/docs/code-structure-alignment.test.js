...
function resolveWorkspaceRoot(startDirectory) {
...
function extractDocumentedSourceDirectories(documentPath) {
    ...
    for (const line of lines) {
        ...
        const level = (prefix.match(/│   /g) ?? []).length + (prefix.match(/    /g) ?? []).length;
...
//# sourceMappingURL=code-structure-alignment.test.js.map