...
import {
  // Re-exported types from plugin-spi
  type DomainPlannerPlugin,
  type DomainPresenterPlugin,
  type DomainRetrieverPlugin,
  type DomainValidatorPlugin,
  type ExternalAdapterPlugin,
...
test("plugins root barrel exports all plugin types", () => {
  ...
  const plannerPlugin: DomainPlannerPlugin | undefined = undefined;
  const presenterPlugin: DomainPresenterPlugin | undefined = undefined;
  const retrieverPlugin: DomainRetrieverPlugin | undefined = undefined;
  const validatorPlugin: DomainValidatorPlugin | undefined = undefined;
  const adapterPlugin: ExternalAdapterPlugin | undefined = undefined;
  const context: PluginLifecycleContext | undefined = undefined;
  const state: PluginLifecycleState | undefined = undefined;
  const manifest: PluginManifest | undefined = undefined;
  const policy: PluginSandboxPolicy | undefined = undefined;
  const spiType: PluginSpiType | undefined = undefined;
