 ...
 */
export function createMinimalTask(overrides = {}) {
    return {
        id: "task-test-001",
        parentId: null,
 ...
 */
export function createMinimalExecution(taskId, overrides = {}) {
    return {
        id: "exec-test-001",
        taskId,
 ...
 */
export function createMinimalApproval(overrides = {}) {
    return {
 ...
 */
export function createMinimalHarnessRun(overrides = {}) {
    return {
 ...
 */
export function createMinimalPlanNode(nodeId, overrides = {}) {
    return {
        nodeId,
        nodeType: "tool",
        inputRefs: [],
 ...
 */
export function createMinimalPlanEdge(edgeId, fromNodeId, toNodeId, overrides = {}) {
    return {
        edgeId,
        fromNodeId,
        toNodeId,
 ...
 */
export function createMinimalPlanGraphBundle(harnessRunId, overrides = {}) {
 ...
 */
export function createMinimalNodeRun(harnessRunId, planGraphBundleId, overrides = {}) {
    return {
 ...
 */
export function createMinimalBudgetLedger(harnessRunId, overrides = {}) {
    return {
        budgetLedgerId: "bledger-test-001",
        tenantId: "tenant-test-001",
        harnessRunId,
 ...
 */
export function createMinimalBudgetReservation(budgetLedgerId, harnessRunId, overrides = {}) {
    return {
