...
function createCustomScenario(overrides: Partial<IncidentDrillScenario> = {}): IncidentDrillScenario {
  return {
...
test("E2E: runbook execution can be added to drill", () => {
  ...
  const execution = {
    ...
    runbook: { runbookId: "rb-001", title: "Test", severity: "P2" as const, sections: [], rawMarkdown: "", parsedAt: "" },
...
test("E2E: runbook execution added to completed drill is ignored", () => {
  ...
  const execution = {
    ...
    runbook: { runbookId: "rb-002", title: "Test2", severity: "P2" as const, sections: [], rawMarkdown: "", parsedAt: "" },
    status: "completed" as const,
    sectionResults: [],
    outcome: "success" as const,
...
test("E2E: drill report is generated correctly", () => {
  ...
  const completed = service.completeDrill(
    ["Issue 1", "Issue 2"],
    ["Recommendation 1"],
    criteriaResults,
  );
