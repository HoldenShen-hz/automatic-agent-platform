...
function seedTaskWithExecution(store, db, taskId, executionId, status = "in_progress", executionStatus = "executing", maxRetries = 1, traceId = "test-trace") {
    const now = nowIso();
    db.transaction(() => {
        store.insertTask({
            id: taskId,
...
//# sourceMappingURL=task-retry-recovery-flow.test.js.map