...
test("E2E Approval: timeout executor auto-rejects expired approvals with reject policy", async () => {
    ...
    try {
        ...
        const executor = new ApprovalTimeoutExecutor(approvals, harness.store, approvalRepo, { defaultTimeoutMs: 60 * 60 * 1000 }); // 1 hour
        // Run sweep
...
test("E2E Approval: timeout executor auto-approves expired approvals with approve policy", async () => {
    ...
    try {
        ...
        const executor = new ApprovalTimeoutExecutor(approvals, harness.store, approvalRepo, { defaultTimeoutMs: 60 * 60 * 1000 });
        // Run sweep
        const result = executor.sweep();
...
//# sourceMappingURL=approval-flows.test.js.map