...
test("E2E: multi-party approval records partial approvals before quorum is met", () => {
    ...
    try {
        ...
        const inFlightRequest = JSON.parse(inFlightRecord?.requestJson ?? "{}");
        ...
        const finalResponse = JSON.parse(finalRecord?.responseJson ?? "{}");
...
//# sourceMappingURL=multi-party-approval-flow.test.js.map