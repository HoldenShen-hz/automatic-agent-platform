...
test("E2E Ticket Priority: tickets ordered correctly across multiple queues", () => {
    ...
    try {
        ...
        const queues = ["default", "background", "critical"];
        const ticketData = [
            { queue: "default", priority: "normal" },
            { queue: "background", priority: "low" },
            { queue: "critical", priority: "urgent" },
        ];
...
//# sourceMappingURL=execution-ticket-priority-ordering.test.js.map