...
test("E2E: checkpoint created at each workflow step boundary", () => {
    ...
    try {
        ...
        h.db.transaction(() => {
            h.store.updateWorkflowState(taskId, "running", 1, JSON.stringify(step0Checkpoint.outputs), nowIso(), null);
        });
        ...
        h.db.transaction(() => {
            h.store.updateWorkflowState(taskId, "running", 2, JSON.stringify({ ...step0Checkpoint.outputs, ...step1Checkpoint.outputs }), nowIso(), null);
        });
...
//# sourceMappingURL=checkpoint-artifact-flow.test.js.map