...
// Helper Functions
// ---------------------------------------------------------------------------
function assertHighConfidenceBlock(classification, reason) {
...
function assertNotBlocked(classification, reason) {
    assert.equal(classification.blocked, false, `Should not be blocked: ${reason}`);
}
function assertMediumConfidence(classification, reason) {
...
//# sourceMappingURL=prompt-injection-guard-e2e.test.js.map