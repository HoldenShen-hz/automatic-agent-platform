...
function makeWorkflowCommand(taskId, fromStatus, toStatus, currentStepIndex, outputsJson, traceId) {
    return {
        entityKind: "workflow",
        entityId: taskId,
        fromStatus,
...
function makeSessionCommand(sessionId, fromStatus, toStatus, traceId) {
    return {
        entityKind: "session",
        entityId: sessionId,
        fromStatus,
...
function seedTaskWithExecution(store, db, taskId, executionId, sessionId, traceId, workflowId = "single_agent_minimal", taskStatus = "queued", executionStatus = "created", sessionStatus = "open") {
    const now = nowIso();
    db.transaction(() => {
        store.insertTask({
            id: taskId,
...
//# sourceMappingURL=execution-flow.test.js.map