...
function runCli(env) {
    const stdout = execFileSync(process.execPath, [join(process.cwd(), "dist", "src", "sdk", "cli", "enterprise-capability.js")], {
        cwd: process.cwd(),
        env: {
            ...process.env,
            ...env,
...
//# sourceMappingURL=enterprise-capability-cli.test.js.map