...
test("integration: DomainRecipeService creates recipes from prototype", () => {
    const service = new DomainRecipeService();
    const fromPrototype = service.createFromPrototype("prototype-domain", "prototype_analysis", {
    ...
    const failedPrototype = service.createFromPrototype("prototype-domain", "nonexistent_template");
...
//# sourceMappingURL=recipe-service-integration.test.js.map