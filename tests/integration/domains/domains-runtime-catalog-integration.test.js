...
import { DOMAINS_RUNTIME_CATALOG_SERVICE_ID, buildDomainsRuntimeCatalog, registerDomainsRuntimeCatalog, } from "../../../src/domains-runtime-catalog.js";
...
test("integration: registerDomainsRuntimeCatalog depends on bootstrap and phase services", async () => {
    ...
    const retrieved = registry.get(DOMAINS_RUNTIME_CATALOG_SERVICE_ID);
...
//# sourceMappingURL=domains-runtime-catalog-integration.test.js.map