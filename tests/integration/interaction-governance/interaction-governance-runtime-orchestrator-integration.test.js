...
import { INTERACTION_GOVERNANCE_RUNTIME_ORCHESTRATOR_SERVICE_ID, InteractionGovernanceRuntimeOrchestrator, registerInteractionGovernanceRuntimeOrchestrator, } from "../../../src/interaction-governance-runtime-orchestrator.js";
import { INTERACTION_GOVERNANCE_RUNTIME_CATALOG_SERVICE_ID, } from "../../../src/interaction-governance-runtime-catalog.js";
import { INTERACTION_BOOTSTRAP_SERVICE_ID, } from "../../../src/interaction/interaction-bootstrap.js";
import { GOVERNANCE_BOOTSTRAP_SERVICE_ID, } from "../../../src/org-governance/governance-bootstrap.js";
...
test("integration: InteractionGovernanceRuntimeOrchestrator registers all services", async () => {
    ...
    assert.ok(registry.isInitialized(INTERACTION_GOVERNANCE_RUNTIME_ORCHESTRATOR_SERVICE_ID), "orchestrator should be registered");
    ...
    assert.ok(registry.isInitialized(INTERACTION_GOVERNANCE_RUNTIME_CATALOG_SERVICE_ID), "runtime catalog should be registered");
    assert.ok(registry.isInitialized(INTERACTION_GOVERNANCE_STARTUP_PLAN_SERVICE_ID), "startup plan should be registered");
    // Verify orchestrator instance
    const retrieved = registry.get(INTERACTION_GOVERNANCE_RUNTIME_ORCHESTRATOR_SERVICE_ID);
...
test("integration: InteractionGovernanceRuntimeOrchestrator startup returns correct phase order", async () => {
    ...
    assert.deepEqual(result.startupOrder, ["interaction", "org-governance"], "startup order should follow phase sequence");
});
...
//# sourceMappingURL=interaction-governance-runtime-orchestrator-integration.test.js.map