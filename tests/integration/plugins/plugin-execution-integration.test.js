...
test("plugin execution integration: coding retriever retrieves knowledge", async () => {
    ...
    try {
        ...
        writeFileSync(join(workspace, "src", "api.ts"), "export async function fetchUserData(userId: string) {\n  return { id: userId, name: 'Test User' };\n}\n", "utf8");
        writeFileSync(join(workspace, "src", "utils.ts"), "export function parseConfig(config: unknown) {\n  return JSON.parse(JSON.stringify(config));\n}\n", "utf8");
...
test("plugin execution integration: basic evaluator validates output", async () => {
    ...
    const validation = await evaluator.validate({
...
//# sourceMappingURL=plugin-execution-integration.test.js.map