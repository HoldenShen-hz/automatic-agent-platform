...
import { VcrFixtureStore, buildRequestFingerprint, } from "../../../../../src/platform/stability/vcr-replay-fixture.js";
...
test("VcrFixtureStore.loadFixture integration: throws for malformed interaction object", () => {
    ...
    assert.throws(() => VcrFixtureStore.loadFixture(malformedInteractions), (error) => error.code === "vcr.fixture_schema_invalid");
});
...
test("VcrFixtureStore integration: settings with reasoningLevel affect fingerprint", () => {
    ...
    assert.throws(() => store.replay(request2), (error) => error.code === "vcr.fixture_missing");
});
test("VcrFixtureStore integration: replay preserves responsePayload exactly", () => {
    ...
    store.recordInteraction(store.createInteraction({
...
//# sourceMappingURL=vcr-replay-fixture-integration.test.js.map