...
test("CrossProviderJudgeService integration: full multi-judge pipeline", () => {
  ...
  const report = crossProvider.evaluateWithCrossProviderJudge({
    ...
    results: [
      ...
      { caseId: "cpi-case-25", output: "ok", criterionSignals: { "judge-25": 0.86 } },
      { caseId: "cpi-case-26", output: "ok", criterionSignals: { "judge-26": 0.91 } },
      { caseId: "cpi-case-27", output: "ok", criterionSignals: { "judge-27": 0.89 } },
      { caseId: "cpi-case-28", output: "ok", criterionSignals: { "judge-28": 0.9 } },
      { caseId: "cpi-case-29", output: "ok", criterionSignals: { "judge-29": 0.88 } },
      { caseId: "cpi-case-30", output: "ok", criterionSignals: { "judge-30": 0.87 } },
      { caseId: "cpi-case-31", output: "ok", criterionSignals: { "judge-31": 0.92 } },
      { caseId: "cpi-case-32", output: "ok", criterionSignals: { "judge-32": 0.91 } },
      { caseId: "cpi-case-33", output: "ok", criterionSignals: { "judge-33": 0.89 } },
      { caseId: "cpi-case-34", output: "ok", criterionSignals: { "judge-34": 0.9 } },
      { caseId: "cpi-case-35", output: "ok", criterionSignals: { "judge-35": 0.88 } },
      { caseId: "cpi-case-36", output: "ok", criterionSignals: { "judge-36": 0.87 } },
      { caseId: "cpi-case-37", output: "ok", criterionSignals: { "judge-37": 0.91 } },
      { caseId: "cpi-case-38", output: "ok", criterionSignals: { "judge-38": 0.89 } },
      { caseId: "cpi-case-39", output: "ok", criterionSignals: { "judge-39": 0.9 } },
      { caseId: "cpi-case-40", output: "ok", criterionSignals: { "judge-40": 0.88 } },
      { caseId: "cpi-case-41", output: "ok", criterionSignals: { "judge-41": 0.87 } },
      { caseId: "cpi-case-42", output: "ok", criterionSignals: { "judge-42": 0.92 } },
      { caseId: "cpi-case-43", output: "ok", criterionSignals: { "judge-43": 0.91 } },
      { caseId: "cpi-case-44", output: "ok", criterionSignals: { "judge-44": 0.89 } },
      { caseId: "cpi-case-45", output: "ok", criterionSignals: { "judge-45": 0.9 } },
      { caseId: "cpi-case-46", output: "ok", criterionSignals: { "judge-46": 0.88 } },
      { caseId: "cpi-case-47", output: "ok", criterionSignals: { "judge-47": 0.87 } },
      { caseId: "cpi-case-48", output: "ok", criterionSignals: { "judge-48": 0.91 } },
      { caseId: "cpi-case-49", output: "ok", criterionSignals: { "judge-49": 0.89 } },
    ],
  });
...
test("CrossProviderJudgeService integration: evaluateWithPipeline with no ready judges returns hold", () => {
  ...
  judgeService.registerDataset({
    ...
    stage: "assess",
    createdBy: "test",
    cases: generateStandardCases(50, "ej-"),
  });
