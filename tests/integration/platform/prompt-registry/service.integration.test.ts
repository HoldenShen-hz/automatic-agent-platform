  ...
  const bundle = registry.registerBundle(
    {
      ...
      taskType: "test-task",
      packId: undefined,
      systemPrompt: { content: "You are a helpful assistant", templateVariables: [] as string[], channel: "system" },
      userPrompt: undefined,
      fewShotExamples: [] as import("../../../../src/platform/contracts/prompt-bundle/index.js").FewShotExample[],
      constraints: undefined,
      compatibilityMatrix: {
        toolSchemaVersions: [] as { toolName: string; schemaVersion: number }[],
        evaluatorSchemaVersions: [] as { evaluatorName: string; schemaVersion: number }[],
        domainDescriptorVersions: [] as { domainId: string; version: number }[],
        modelRoutingProfiles: [] as { modelId: string; profileVersion: number }[],
      },
      metadata: undefined,
    },
    "global",
  ...
  const newBundle = registry.registerBundle(
    {
      ...
      taskType: "test-task",
      packId: undefined,
      systemPrompt: { content: "You are a very helpful assistant", templateVariables: [] as string[], channel: "system" },
      userPrompt: undefined,
      fewShotExamples: [] as import("../../../../src/platform/contracts/prompt-bundle/index.js").FewShotExample[],
      constraints: undefined,
      compatibilityMatrix: {
  ...
  const globalBundle = registry.registerBundle(
    {
      ...
      taskType: "general",
      packId: undefined,
      systemPrompt: { content: "Company default prompt", templateVariables: [] as string[], channel: "system" },
      userPrompt: undefined,
      fewShotExamples: [] as import("../../../../src/platform/contracts/prompt-bundle/index.js").FewShotExample[],
      constraints: undefined,
      compatibilityMatrix: {
  ...
  const domainBundle = registry.registerBundle(
    {
      ...
      taskType: "general",
      packId: undefined,
      systemPrompt: { content: "Finance-specific prompt", templateVariables: [] as string[], channel: "system" },
      userPrompt: undefined,
      fewShotExamples: [] as import("../../../../src/platform/contracts/prompt-bundle/index.js").FewShotExample[],
      constraints: undefined,
      compatibilityMatrix: {
  ...
  registry.registerBundle(
    {
      ...
      taskType: "test-task",
      packId: undefined,
      systemPrompt: { content: "Control version", templateVariables: [] as string[], channel: "system" },
      userPrompt: undefined,
      fewShotExamples: [] as import("../../../../src/platform/contracts/prompt-bundle/index.js").FewShotExample[],
      constraints: undefined,
      compatibilityMatrix: {
  ...
  registry.registerBundle(
    {
      ...
      taskType: "test-task",
      packId: undefined,
      systemPrompt: { content: "Treatment version", templateVariables: [] as string[], channel: "system" },
      userPrompt: undefined,
      fewShotExamples: [] as import("../../../../src/platform/contracts/prompt-bundle/index.js").FewShotExample[],
      constraints: undefined,
      compatibilityMatrix: {
  ...
  const bundle = registry.registerBundle(
    {
      ...
      taskType: "test",
      packId: undefined,
      systemPrompt: { content: "Old content", templateVariables: [] as string[], channel: "system" },
      userPrompt: undefined,
      fewShotExamples: [] as import("../../../../src/platform/contracts/prompt-bundle/index.js").FewShotExample[],
      constraints: undefined,
      compatibilityMatrix: {
  ...
  registry.registerBundle(
    {
      ...
      taskType: "general",
      packId: undefined,
      systemPrompt: { content: "Global", templateVariables: [] as string[], channel: "system" },
      userPrompt: undefined,
      fewShotExamples: [] as import("../../../../src/platform/contracts/prompt-bundle/index.js").FewShotExample[],
      constraints: undefined,
      compatibilityMatrix: {
  ...
  registry.registerBundle(
    {
      ...
      taskType: "general",
      packId: undefined,
      systemPrompt: { content: "Domain level", templateVariables: [] as string[], channel: "system" },
      userPrompt: undefined,
      fewShotExamples: [] as import("../../../../src/platform/contracts/prompt-bundle/index.js").FewShotExample[],
      constraints: undefined,
      compatibilityMatrix: {
  ...
  registry.registerBundle(
    {
      ...
      taskType: "general",
      packId: "premium-pack",
      systemPrompt: { content: "Pack level", templateVariables: [] as string[], channel: "system" },
      userPrompt: undefined,
      fewShotExamples: [] as import("../../../../src/platform/contracts/prompt-bundle/index.js").FewShotExample[],
      constraints: undefined,
      compatibilityMatrix: {
