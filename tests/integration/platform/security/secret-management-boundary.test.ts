  ...
  try {
    execFileSync("node", ["--enable-source-maps", CLI_PATH], {
      ...
      env: {
        ...
        AA_SECRET_CURRENT_VERSION: "v1.0",
      },
      encoding: "utf8",
    });
    ...
    const resolvedOutput = execFileSync("node", ["--enable-source-maps", CLI_PATH], {
      ...
      env: {
        ...
        AA_SECRET_CALLER_SCOPE_TYPE: "system",
        AA_SECRET_CALLER_SCOPE_REF: "deploy.kubeconfig.prod",
      ...
      () =>
        execFileSync("node", ["--enable-source-maps", CLI_PATH], {
          ...
          env: {
            ...
            AA_SECRET_USAGE_PURPOSE: "publish_image",
            AA_SECRET_CALLER_SCOPE_TYPE: "system",
            AA_SECRET_CALLER_SCOPE_REF: "registry.ghcr.prod",
            AA_SECRET_SYSTEM_REGISTRY_GHCR_PROD: "registry-token-123456",
          },
          encoding: "utf8",
          stdio: "pipe",
