...
test("workflow repository updates workflow step index", () => {
    ...
    try {
        ...
        ctx.db.transaction(() => {
            ctx.store.updateWorkflowState(taskId, "running", 2, outputs, updateTime, null);
        });
...
test("workflow repository records workflow completion", () => {
    ...
    try {
        ...
        ctx.db.transaction(() => {
            ctx.store.updateWorkflowState(taskId, "completed", 3, finalOutputs, completeTime, null);
        });
...
//# sourceMappingURL=workflow-repository-integration.test.js.map