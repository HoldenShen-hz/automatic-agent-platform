...
test.describe("AsyncWorkflowRepository", () => {
    ...
    test("updateWorkflowStateCas uses optimistic locking", async () => {
        ...
        const affected1 = await harness.workflowRepo.updateWorkflowStateCas("task-wf-cas", 0, "running", "running", 1, '{"step0":{"done":true}}', "2026-04-23T11:00:00.000Z", null);
        ...
        "running", "running", 2, '{"step1":{"done":true}}', "2026-04-23T12:00:00.000Z", null);
