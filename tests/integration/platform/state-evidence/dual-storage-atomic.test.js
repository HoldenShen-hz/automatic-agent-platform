...
test("[SYS-REL-2.8] dual storage detects and repairs partial write", () => {
    ...
    try {
        ...
        assert.equal(sessionLines.length, indexLines.length, `Session file and task index must have same line count. Session: ${sessionLines.length}, Index: ${indexLines.length}`);
...
//# sourceMappingURL=dual-storage-atomic.test.js.map