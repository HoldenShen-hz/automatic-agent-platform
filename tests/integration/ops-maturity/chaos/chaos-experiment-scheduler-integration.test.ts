...
import { ChaosExperimentScheduler, type ExperimentScheduleInput, type GameDayScheduleInput } from "../../../../src/ops-maturity/chaos/chaos-experiment-scheduler.js";
...
test("ChaosExperimentScheduler schedules experiment and transitions through lifecycle", () => {
  ...
  const input: ExperimentScheduleInput = {
...
test("ChaosExperimentScheduler lists experiments by status", () => {
  ...
  const input1: ExperimentScheduleInput = {
    name: "scheduled_test",
    description: "test1",
  ...
  const input2: ExperimentScheduleInput = {
    name: "running_test",
    description: "test2",
