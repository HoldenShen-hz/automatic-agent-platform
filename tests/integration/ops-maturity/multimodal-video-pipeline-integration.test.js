...
test("integration: multimodal video pipeline materializes transcript scenes keyframes and gateway summary", () => {
    ...
    assert.equal(gatewayResult.normalizedInputs[0].summary, "video_duration_ms=45000,resolution=1920x1080,scenes=3,transcript_segments=1,quality=ready");
});
//# sourceMappingURL=multimodal-video-pipeline-integration.test.js.map