...
test("performance: State transition latency <5ms per transition", (t) => {
  ...
  for (let i = 0; i < 100; i++) {
    ...
    stateMachine.transition({
      ...
      auditRef: "audit://performance/harness-run/warmup",
  ...
  for (let i = 0; i < iterations; i++) {
    ...
    stateMachine.transition({
      ...
      reasonCode: "test",
      emittedBy: "test-emitter",
      auditRef: "audit://performance/harness-run/measure",
      runVersionLockId: newId("rvlock"),
      leaseId: newId("lease"),
      fencingToken: newId("fence"),
    });
  ...
  try {
    ...
    for (let i = 0; i < iterations; i++) {
      ...
      stateMachine.transition({
        ...
        emittedBy: "test-emitter",
        auditRef: "audit://performance/task-lifecycle/admitted",
        runVersionLockId: newId("rvlock"),
        leaseId: newId("lease"),
        fencingToken: newId("fence"),
      });
      ...
      stateMachine.transition({
        ...
        emittedBy: "test-emitter",
        auditRef: "audit://performance/task-lifecycle/planning",
        runVersionLockId: newId("rvlock"),
        leaseId: newId("lease"),
        fencingToken: newId("fence"),
      });
      ...
      stateMachine.transition({
        ...
        emittedBy: "test-emitter",
        auditRef: "audit://performance/task-lifecycle/ready",
        runVersionLockId: newId("rvlock"),
        leaseId: newId("lease"),
        fencingToken: newId("fence"),
      });
      ...
      stateMachine.transition({
        ...
        emittedBy: "test-emitter",
        auditRef: "audit://performance/task-lifecycle/running",
        runVersionLockId: newId("rvlock"),
        leaseId: newId("lease"),
        fencingToken: newId("fence"),
      });
