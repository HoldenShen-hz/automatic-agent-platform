...
test("entry security gates enforce tenant scope, endpoint class limits, SDK handshake, and worker identity", () => {
    const scopeFilter = new TenantScopeFilter((taskId) => (taskId === "task-1"
...
test("compatibility, drift, resume, sequencing, timers, and guardrail breakers are executable", () => {
    ...
    const resume = new ResumeCompatibilityCheck().compare({ runId: "run-1", contractVersion: "4.3", runtimeVersion: "1", graphHash: "a", artifactLockHash: "a" }, { runId: "run-1", contractVersion: "4.3", runtimeVersion: "1", graphHash: "b", artifactLockHash: "a" }, { timeoutMs: 1000, startedAtMs: 0, nowMs: 10 });
...
//# sourceMappingURL=platform-architecture-hardening-audit.test.js.map