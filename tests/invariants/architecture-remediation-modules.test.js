...
import { buildOrgGovernanceRemediationEvidence, cascadeRevokePermission, evaluateApprovalConflicts, evaluateUnknownDelegatedGuardrail, mergeDenyPolicy, } from "../../src/org-governance/architecture-remediation.js";
import { buildScaleEcosystemRemediationEvidence, buildBillingAdjustment, compareFairQueueEntries, validateListingDependencies, } from "../../src/scale-ecosystem/architecture-remediation.js";
import { buildOpsMaturityRemediationEvidence, driftResponse, transitionAgentLifecycle, validatePanicDirective, validateResumePlan, } from "../../src/ops-maturity/architecture-remediation.js";
import { buildInteractionRemediationEvidence, createClarificationState, deriveUrgency, detectTriggerFeedbackLoop, } from "../../src/interaction/architecture-remediation.js";
import { buildDomainsSdkRemediationEvidence, canTransitionDomain, DOMAIN_META_MODEL_QUESTIONS, validateActiveDomainDescriptor, } from "../../src/domains/architecture-remediation.js";
...
test("scale-ecosystem remediation implements S-1 through S-20 behavior", () => {
    ...
    assert.ok(compareFairQueueEntries({ tenantId: "tenant-b", orgId: "org", domainId: "domain", slaTier: 1, priority: 1 }, { tenantId: "tenant-a", orgId: "org", domainId: "domain", slaTier: 2, priority: 1 }) > 0);
});
...
//# sourceMappingURL=architecture-remediation-modules.test.js.map