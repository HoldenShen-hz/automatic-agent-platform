...
import { listRiskRegisterRecords, RiskRegister, } from "../../src/platform/architecture/risk-register.js";
test("RiskRegister turns architecture risk catalog into release-gate records", () => {
    ...
    assert.deepEqual(risks.map((risk) => risk.riskId), ["RISK-GRAPH-001", "RISK-SIDEEFFECT-001", "RISK-BUDGET-001", "RISK-DOMAIN-001"]);
...
//# sourceMappingURL=risk-register.test.js.map