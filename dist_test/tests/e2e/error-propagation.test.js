...
function insertTaskAndExecution(db, store, taskId, executionId, traceId, taskStatus = "in_progress", executionStatus = "executing") {
    const now = nowIso();
    db.transaction(() => {
        store.insertTask({
            id: taskId,
...
//# sourceMappingURL=error-propagation.test.js.map