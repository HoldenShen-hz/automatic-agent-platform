...
import { FeedbackBatchOutcomeSchema, FeedbackBatchSchema, LearningSignalSchema, parseFeedbackBatch, parseLearningSignal, } from "../../../../../src/scale-ecosystem/feedback-loop/collector/feedback-model.js";
import { FeedbackSignalSchema, parseFeedbackSignal, } from "../../../../../src/platform/orchestration/oapeflir/types/feedback-signal.js";
...
test("FeedbackBatchOutcomeSchema accepts valid outcomes", () => {
    const outcomes = ["completed", "failed", "repairable", "escalated", "partial"];
...
test("LearningSignalSchema accepts all valid learning types", () => {
    const learningTypes = ["failure_pattern", "user_correction", "recovery_playbook"];
...
//# sourceMappingURL=feedback-model.test.js.map