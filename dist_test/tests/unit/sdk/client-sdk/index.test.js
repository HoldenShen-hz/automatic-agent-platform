...
import { buildApiUrl, buildAuthHeaders, } from "../../../../src/sdk/client-sdk/index.js";
test("client-sdk builds versioned API URLs with tenant and query params", () => {
    const url = buildApiUrl({ baseUrl: "https://api.example.com/", apiVersion: "v1", tenantId: "tenant_a" }, { path: "/tasks", query: { limit: 5, status: "open" } });
