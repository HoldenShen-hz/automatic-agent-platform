...
import { AppError, AuthError, ValidationError, PolicyDeniedError, ProviderError, ToolExecutionError, SandboxError, StorageError, WorkflowStateError, TenantBoundaryError, MonetizationError, InternalAppError, LockingError, MemoryError, RuntimeError, TransientExternalError, PermanentExternalError, createErrorCode, isAppError, getErrorCode, normalizeToAppError, } from "../../../../src/platform/contracts/errors.js";
...
test("normalizeToAppError preserves existing AppError instances", () => {
    ...
    assert.equal(normalizeToAppError(existing, {
