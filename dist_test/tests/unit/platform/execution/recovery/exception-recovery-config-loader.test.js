...
import { loadExceptionRecoveryConfig, clearExceptionRecoveryConfigCache, } from "../../../../../src/platform/execution/recovery/exception-recovery-config-loader.js";
...
test("byExceptionType has all required exception types", () => {
    ...
    for (const type of requiredTypes) {
        assert.ok(config.recoveryStrategyTable.byExceptionType[type], `Missing strategy for ${type}`);
    }
});
...
//# sourceMappingURL=exception-recovery-config-loader.test.js.map