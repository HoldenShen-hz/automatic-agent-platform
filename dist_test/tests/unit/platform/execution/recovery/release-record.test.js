...
import { createReleaseRecord, createRollbackRecord, isReleaseApproved, requiresHumanApproval, } from "../../../../../src/platform/execution/recovery/release-record.js";
...
test("ReleaseDecision type accepts all valid values", () => {
    const decisions = ["approved", "rejected", "rolled_back"];
...
//# sourceMappingURL=release-record.test.js.map