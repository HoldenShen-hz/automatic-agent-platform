...
import { validateToolExecutionMetadata, validateToolMetadataRegistry, } from "../../../../../src/platform/execution/tool-executor/tool-contract-validator.js";
...
test("validateToolExecutionMetadata detects invalid retryable error code", () => {
    const metadata = createValidMetadata({ retryableErrorCodes: ["", "valid"] });
    const violations = validateToolExecutionMetadata(metadata);
...
//# sourceMappingURL=tool-contract-validator.test.js.map