...
import { SkillGovernanceService, computeSkillHealth, } from "../../../../../src/platform/execution/tool-executor/skill-governance-service.js";
const createMockStore = () => {
    ...
    return {
        withConnection: (work) => work(connection),
    };
};
...
//# sourceMappingURL=skill-governance-service.test.js.map