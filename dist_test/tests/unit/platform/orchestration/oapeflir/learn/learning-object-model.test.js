...
test("LearningObjectSchema applies defaults", () => {
    ...
    assert.equal(result.promotionStatus, "draft");
});
test("LearningObjectSchema accepts all learning types", () => {
    const types = ["failure_pattern", "user_correction", "recovery_playbook"];
...
test("LearningObjectSchema accepts all validatedBy values", () => {
    const values = ["none", "evidence", "human_review", "shadow_execution"];
...
test("LearningObjectSchema accepts all promotionStatus values", () => {
    const statuses = ["draft", "validated", "promoted", "retired"];
...
//# sourceMappingURL=learning-object-model.test.js.map