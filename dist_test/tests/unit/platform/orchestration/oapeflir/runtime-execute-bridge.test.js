...
import { MockExecuteBridge, mapStepOutputRecord, mapToDualChannelStepOutputs, extractStepOutputRecords, serialiseOapeflirPlan, RuntimeExecuteBridge, } from "../../../../../src/platform/orchestration/oapeflir/runtime-execute-bridge.js";
function createMockPlanStep(overrides = {}) {
    return {
        stepId: "step_1",
        action: "test_action",
        inputs: {},
...
test("extractStepOutputRecords returns stepOutputs from executionRecord", () => {
    ...
    const result = extractStepOutputRecords({
        snapshot: { task: {}, executionRecord: { stepOutputs } },
        streamFrames: [],
        routing: null,
        plannedWorkflow: null,
        compaction: null,
...
//# sourceMappingURL=runtime-execute-bridge.test.js.map