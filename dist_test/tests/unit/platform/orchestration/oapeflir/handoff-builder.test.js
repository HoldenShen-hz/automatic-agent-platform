...
import { buildFromStepResults } from "../../../../../src/platform/orchestration/oapeflir/handoff-builder.js";
function makeStepOutput(stepId, summary, durationMs, validationPassed = true) {
    return {
        stepId,
        planRef: "plan_test",
        userFacingResult: {
...
//# sourceMappingURL=handoff-builder.test.js.map