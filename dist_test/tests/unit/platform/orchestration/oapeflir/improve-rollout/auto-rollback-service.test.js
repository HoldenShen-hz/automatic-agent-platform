...
test("AutoRollbackService evaluates insufficient sample size", () => {
    ...
    const result = service.evaluate({}, metrics);
...
test("AutoRollbackService uses minimumObservationWindowMs from config when observationWindowMs is null", () => {
    ...
    const metrics = {
        ...
        p99LatencyMs: 100,
        baselineP99LatencyMs: 100,
        observationWindowMs: null, // null triggers fallback to minimumObservationWindowMs
    };
    const result = service.evaluate({}, metrics);
...
//# sourceMappingURL=auto-rollback-service.test.js.map