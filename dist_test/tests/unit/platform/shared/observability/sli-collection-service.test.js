...
import { SliCollectionService, DEFAULT_SLO_DEFINITIONS, } from "../../../../../src/platform/shared/observability/sli-collection-service.js";
...
test("autoStart option begins collection immediately", async () => {
    ...
    `);
        ...
        const autoCollectionService = new SliCollectionService(db, healthService, metricsService, sloService, { autoStart: true, collectionIntervalMs: 60000 });
...
//# sourceMappingURL=sli-collection-service.test.js.map