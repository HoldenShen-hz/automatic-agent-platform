...
import { createRootTraceContext, createChildTraceContext, injectTraceContext, extractTraceContext, parseSystemSituation, } from "../../../../../src/platform/shared/observability/index.js";
...
test("extractTraceContext uses fallback values", () => {
    const result = extractTraceContext({ data: "test" }, { traceId: "fallback_trace", correlationId: "fallback_corr" });
...
test("DiagnosticWarningEscalation type accepts valid values", () => {
    const escalations = ["none", "task", "operator"];
