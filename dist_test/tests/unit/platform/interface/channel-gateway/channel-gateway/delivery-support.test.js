...
import { calculateBackoffForAttempt, toDeliveryMessageRecord, buildDeadLetterQuery, buildDeadLetterCountQuery, CHANNEL_DELIVERY_DDL, DEFAULT_DELIVERY_CONFIG, DEFAULT_RATE_LIMIT_CONFIG, } from "../../../../../../src/platform/interface/channel-gateway/channel-gateway-delivery-support.js";
...
test("toDeliveryMessageRecord handles string values from SQLite", () => {
    const row = { attempts: "2", max_retries: "7" };
    const result = toDeliveryMessageRecord(row);
...
//# sourceMappingURL=delivery-support.test.js.map