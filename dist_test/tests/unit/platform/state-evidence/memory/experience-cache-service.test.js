    ...
    const mockConnection = {
        ...
        prepare: (sql) => ({
            ...
            get: () => ({
                ...
                avg_quality: experiences.length > 0 ? experiences.reduce((sum, e) => sum + e.quality_score, 0) / experiences.length : null,
                total_hits: experiences.reduce((sum, e) => sum + (e.hit_count || 0), 0),
            }),
...
//# sourceMappingURL=experience-cache-service.test.js.map