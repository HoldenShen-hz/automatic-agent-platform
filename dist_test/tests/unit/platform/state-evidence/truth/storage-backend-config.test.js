...
import { resolveStorageDriver, buildStorageBackendConfigIssues, inspectStorageBackendConfig, } from "../../../../../src/platform/state-evidence/truth/storage-backend-config.js";
...
test("resolveStorageDriver throws for invalid driver", () => {
    assert.throws(() => resolveStorageDriver({ AA_STORAGE_DRIVER: "mongodb" }), (error) => error.code === "storage.driver_invalid:mongodb");
});
...
//# sourceMappingURL=storage-backend-config.test.js.map