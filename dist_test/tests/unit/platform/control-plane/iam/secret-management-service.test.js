...
test("secret management service issues, expires, and revokes short-lived secret leases", async () => {
    ...
    try {
        ...
        const expired = service.listSecretLeases("secret://system/registry/ghcr/prod", new Date(Date.parse(expiringLease.lease.expiresAt) + 1).toISOString());
...
//# sourceMappingURL=secret-management-service.test.js.map