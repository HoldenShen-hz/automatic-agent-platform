...
import { roundCurrency, roundRatio, clamp, summarizeBudgetProposal, buildRecommendedBudgetPolicy, } from "../../../../src/ops-maturity/drift-detection/evolution-mvp-support.js";
...
test("buildRecommendedBudgetPolicy throws for sampleSize < 3", () => {
    assert.throws(() => buildRecommendedBudgetPolicy({
        taskId: "task_123",
    ...
    }), (e) => e?.message?.includes("insufficient_budget_samples"));
});
test("buildRecommendedBudgetPolicy throws for invalid successRate", () => {
    ...
    }), (e) => e?.message?.includes("invalid_success_rate"));
});
test("buildRecommendedBudgetPolicy throws for zero observed cost", () => {
    ...
    }), (e) => e?.message?.includes("invalid_observed_cost"));
});
...
//# sourceMappingURL=evolution-mvp-support.test.js.map