...
test("SimpleProposalEngine.canAutoPromote handles unknown proposal kind", () => {
    ...
    assert.equal(engine.canAutoPromote("unknown_kind"), false);
});
test("SimpleProposalEngine.requiresManualApproval handles unknown proposal kind", () => {
    ...
    assert.equal(engine.requiresManualApproval("unknown_kind"), false);
});
//# sourceMappingURL=proposal-engine.test.js.map