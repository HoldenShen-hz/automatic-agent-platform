...
function createTestEvaluation(proposalId, overrides = {}) {
    return {
        proposalId,
        benchmarkCases: 10,
...
function createTestRollout(proposalId, overrides = {}) {
    return {
        proposalId,
        stage: "canary",
        percentage: 10,
...
function createTestReflection(overrides = {}) {
    return {
        id: "ref_1",
        evidenceIds: ["ev_1"],
        taskType: "test_task",
...
//# sourceMappingURL=evolution-registry.test.js.map