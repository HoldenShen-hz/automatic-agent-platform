...
test("createUpgradePlan creates plan with batches", () => {
    ...
    try {
        ...
        const targets = [
            ...
            { targetId: "worker-3", targetType: "worker_pool", currentVersion: "v1.0.0", targetVersion: "v1.1.0" },
            { targetId: "worker-4", targetType: "worker_pool", currentVersion: "v1.0.0", targetVersion: "v1.1.0" },
        ];
...
//# sourceMappingURL=hot-upgrade-service.test.js.map