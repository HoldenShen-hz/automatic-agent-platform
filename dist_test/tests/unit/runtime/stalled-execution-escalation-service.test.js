...
test("stalled execution escalation service builds a missing-heartbeat escalation package", () => {
    ...
    try {
        ...
        db.connection.prepare(`UPDATE executions SET updated_at = ? WHERE id = ?`).run("2026-04-04T10:00:00.000Z", "exec-stalled-escalation");
...
test("stalled execution escalation service recommends restart when heartbeat is still present", () => {
    ...
    try {
        ...
        db.connection.prepare(`UPDATE executions SET updated_at = ? WHERE id = ?`).run("2026-04-04T10:00:00.000Z", "exec-stalled-heartbeat");
...
//# sourceMappingURL=stalled-execution-escalation-service.test.js.map