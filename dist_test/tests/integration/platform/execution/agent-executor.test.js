...
import { createAgentExecutor, initializeAgentExecutor, getAgentExecutorContext, } from "../../../../src/platform/execution/execution-engine/agent-executor.js";
...
test("AgentExecutor sandbox: loop detection escalation", async () => {
    ...
    await executor.wrapToolCall("repeat_tool", { data: "same" }, async () => {
        return "first_call";
    });
    await executor.wrapToolCall("repeat_tool", { data: "same" }, async () => {
        return "second_call";
