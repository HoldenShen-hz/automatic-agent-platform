...
test("soak: heap growth stays below 2x threshold over 200 memory operations", () => {
    ...
    try {
        ...
        assert.ok(growthRatio < 2.0, `Heap growth ratio ${growthRatio.toFixed(2)} should be below 2.0x initial heap (initial: ${(initialHeap / 1_048_576).toFixed(1)}MB, peak: ${(peakHeap / 1_048_576).toFixed(1)}MB)`);
        db.close();
    }
    finally {
        cleanupPath(workspace);
...
//# sourceMappingURL=memory-soak.test.js.map