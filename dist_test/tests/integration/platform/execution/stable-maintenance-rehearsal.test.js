...
import { runStableMaintenanceRehearsal, writeStableMaintenanceRehearsalReport, } from "../../../../src/platform/shared/stability/stable-maintenance-rehearsal.js";
...
test("stable maintenance rehearsal validates drain rejection and controlled handover", async () => {
    ...
    try {
        ...
        assert.ok(report.scenarios.some((scenario) => scenario.scenarioId === "step_boundary_handover_preserves_execution_lineage"));
