...
test("MultiLevelCacheStore cleanupExpired removes expired entries from all layers", async () => {
    ...
    const rExpired = await store.get("ns", "expired-l1");
