...
test("workflow state sync: workflow step progression updates state correctly", () => {
    ...
    try {
        ...
        db.transaction(() => {
            ...
            db.connection
                .prepare(`UPDATE workflow_state SET current_step_index = ?, updated_at = ?, outputs_json = ? WHERE task_id = ?`)
...
//# sourceMappingURL=workflow-state-sync-integration.test.js.map