...
`,
        ...
        const rollbackColumns = failingDb.connection.prepare("PRAGMA table_info(runtime_state);").all();
        ...
        const recoveredColumns = recoveredDb.connection.prepare("PRAGMA table_info(runtime_state);").all();
...
//# sourceMappingURL=sqlite-migration-ledger.test.js.map