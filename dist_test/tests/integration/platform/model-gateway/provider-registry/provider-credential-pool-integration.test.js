...
test("ProviderCredentialPool fromEnvironment loads multiple key formats", () => {
    const pool = ProviderCredentialPool.fromEnvironment("openai", {
...
test("ProviderCredentialPool releaseCredential with active lease", () => {
    const pool = new ProviderCredentialPool({
        ...
        managedSecretAccess: {
            secretLeaseRevoker: (leaseId, _context) => {
...
//# sourceMappingURL=provider-credential-pool-integration.test.js.map