...
const CLI_PATH = `${REPO_ROOT}/dist/src/cli/release-pipeline.js`;
...
test("release-pipeline CLI lists environments and exports a release bundle", () => {
    ...
    try {
        ...
        const listed = JSON.parse(execFileSync("node", ["--enable-source-maps", CLI_PATH], {
            cwd: REPO_ROOT,
            env: {
                ...process.env,
                AA_DB_PATH: dbPath,
...
//# sourceMappingURL=release-pipeline-cli.test.js.map