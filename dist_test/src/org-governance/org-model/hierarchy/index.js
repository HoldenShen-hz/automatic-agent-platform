...
export function validateOrgHierarchy(nodes) {
    const findings = [];
...
export function listAncestorNodeIds(nodes, nodeId) {
    const ancestors = [];
 ...
 */
export function listDescendantNodeIds(nodes, nodeId) {
    const descendants = [];
    const stack = [nodeId];
 ...
 */
export function getNodesAtLevel(nodes, level) {
 ...
 */
export function findLowestCommonAncestor(nodes, nodeId1, nodeId2) {
 ...
 */
export function buildReportingChain(nodes, employeeId, memberNodeId) {
    const chain = [];
 ...
 */
export function detectOrgChangeEvents(before, after) {
    const events = [];
