...
export function createOperationsRetrieverPlugin() {
    return {
        ...
        async retrieve(query) {
            ...
            const results = [
                {
                    knowledgeRef: `knowledge:ops/runbooks?query=${encodeURIComponent(searchQuery)}`,
                ...
                {
                    knowledgeRef: `knowledge:ops/incidents?query=${encodeURIComponent(searchQuery)}`,
...
//# sourceMappingURL=operations-retriever.js.map