...
export function createCrmAdapterPlugin(options = {}) {
    ...
    return {
        ...
        async execute(action, params) {
            ...
            if (!decision.allowed) {
                throw new PolicyDeniedError("egress.denied", `CRM adapter: action "${action}" denied by egress policy`);
            }
...
//# sourceMappingURL=crm-adapter.js.map