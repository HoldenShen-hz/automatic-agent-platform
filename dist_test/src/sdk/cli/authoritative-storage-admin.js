 ...
 */
import { describeCliAuthoritativeStoragePlan, withCliStorageBackendAsync, } from "./authoritative-storage.js";
...
async function main() {
    ...
    await withCliStorageBackendAsync(async (storage) => {
        ...
        const migrationSummary = action === "summary"
...
await main();
//# sourceMappingURL=authoritative-storage-admin.js.map