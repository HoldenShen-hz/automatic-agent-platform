...
import { ManualBillingPaymentGateway, PaddleBillingPaymentGateway, StripeBillingPaymentGateway, } from "../../scale-ecosystem/marketplace/billing-payment-gateway.js";
 ...
 */
function createPaymentGateway(envConfig) {
        ...
        switch (action) {
            ...
            case "evaluate":
                return billing.evaluateEntitlement({
                    ...
                    metricType: envConfig.metricType,
