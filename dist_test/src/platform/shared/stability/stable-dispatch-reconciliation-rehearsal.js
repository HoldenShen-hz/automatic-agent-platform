...
async function runOrphanClaimScenario(outputDir) {
    return measureScenario("orphan_claim_requeued", async () => {
        ...
        db.close();
        return {
            passed: before.some((issue) => issue.issueType === "orphan_queue_claim") &&
...
async function runTerminalTicketScenario(outputDir) {
    return measureScenario("terminal_execution_ticket_cancelled", async () => {
        ...
        store.execution.updateExecutionStatus("exec-dispatch-reconcile-terminal", "succeeded", "2026-04-04T14:10:06.000Z", null, "2026-04-04T14:10:06.000Z", null);
        const reconcile = new ExecutionDispatchReconciliationService(db, store);
        ...
        db.close();
        return {
            passed: before.some((issue) => issue.issueType === "terminal_execution_ticket") &&
...
export async function runStableDispatchReconciliationRehearsal(options) {
...
export function writeStableDispatchReconciliationRehearsalReport(path, report) {
    writeJson(path, report);
}
//# sourceMappingURL=stable-dispatch-reconciliation-rehearsal.js.map