...
import { sanitizeToolOutput, } from "../../execution/tool-executor/tool-output-sanitizer.js";
export const STABLE_PROMPT_INJECTION_RED_TEAM_CASES = [
    {
...
async function measureScenario(definition) {
    ...
    const passed = output.injectionRisk === definition.expectedRisk &&
...
export async function runStablePromptInjectionRedTeam(options) {
...
export function writeStablePromptInjectionRedTeamReport(outputFile, report) {
    writeJson(outputFile, report);
}
//# sourceMappingURL=stable-prompt-injection-red-team.js.map