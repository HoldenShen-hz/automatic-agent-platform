 ...
 */
function seedDispatchedExecution(dbPath) {
 ...
 */
async function runClaimScenario(outputDir) {
 ...
 */
async function runHeartbeatScenario(outputDir) {
...
async function runStaleFencingScenario(outputDir) {
    return measureScenario("stale_fencing_handshake_rejected", async () => {
        ...
        db.close();
        return {
            passed: renewed.outcome === "granted" &&
 ...
 */
export async function runStableWorkerHandshakeRehearsal(options) {
 ...
 */
export function writeStableWorkerHandshakeRehearsalReport(outputFile, report) {
    writeJson(outputFile, report);
}
//# sourceMappingURL=stable-worker-handshake-rehearsal.js.map