...
async function runLeaseReclaimScenario(outputDir) {
...
async function runStaleWriteScenario(outputDir) {
...
async function runLeaseHandoverScenario(outputDir) {
...
async function runWorkerRegistryScenario(outputDir) {
...
export async function runStableLeaseRehearsal(options) {
...
export function writeStableLeaseRehearsalReport(outputFile, report) {
    writeJson(outputFile, report);
}
//# sourceMappingURL=stable-lease-rehearsal.js.map