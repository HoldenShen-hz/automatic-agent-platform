 ...
 */
export declare const StepTypeRiskSchema: z.ZodEnum<["read", "write", "delete", "external_call"]>;
export type StepTypeRisk = z.infer<typeof StepTypeRiskSchema>;
/**
 * Target system classification per §10.2
 */
export declare const TargetSystemRiskSchema: z.ZodEnum<["internal", "staging", "production"]>;
export type TargetSystemRisk = z.infer<typeof TargetSystemRiskSchema>;
/**
 * Data classification per §10.2
 */
export declare const DataClassRiskSchema: z.ZodEnum<["public", "internal", "confidential", "restricted"]>;
export type DataClassRisk = z.infer<typeof DataClassRiskSchema>;
/**
 * Blast radius scope per §10.2
 */
export declare const BlastRadiusSchema: z.ZodEnum<["single_task", "workflow", "tenant", "platform"]>;
 ...
 */
export declare const RiskFactorsSchema: z.ZodObject<{
    stepTypeRisk: z.ZodEnum<["read", "write", "delete", "external_call"]>;
    targetSystemRisk: z.ZodEnum<["internal", "staging", "production"]>;
    dataClassRisk: z.ZodEnum<["public", "internal", "confidential", "restricted"]>;
    blastRadius: z.ZodEnum<["single_task", "workflow", "tenant", "platform"]>;
    priorFailureRatePercent: z.ZodNumber;
    confidence: z.ZodEnum<["high", "medium", "low"]>;
}, "strip", z.ZodTypeAny, {
    confidence: "low" | "high" | "medium";
    blastRadius: "tenant" | "workflow" | "platform" | "single_task";
    stepTypeRisk: "read" | "write" | "delete" | "external_call";
    targetSystemRisk: "staging" | "internal" | "production";
    dataClassRisk: "internal" | "public" | "confidential" | "restricted";
