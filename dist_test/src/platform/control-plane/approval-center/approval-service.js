 ...
 */
export function validateApprovalDecision(decision) {
...
function readCascadeSessionId(request) {
...
export class ApprovalService {
    ...
    applyDecision(decision) {
        ...
        this.db.transaction(() => {
            ...
            const nextStatus = decision.decisionType === "rejected" || decision.decisionType === "expired"
