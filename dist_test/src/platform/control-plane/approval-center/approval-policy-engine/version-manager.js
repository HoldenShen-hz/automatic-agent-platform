...
export class PolicyVersionManager {
    ...
    config;
    constructor(initialBundle, config = {}) {
        this.config = {
     ...
     */
    createDraft(bundleId, baseVersion, createdBy) {
     ...
     */
    submitForApproval(bundle, submittedBy, changeSummary) {
        if (bundle.status !== "draft") {
     ...
     */
    approve(bundle, approvedBy, approvalRequestId) {
     ...
     */
    activate(bundleId, version, activatedBy) {
     ...
     */
    deprecate(bundleId, version, deprecatedBy) {
        const bundle = this.getVersion(bundleId, version);
        if (!bundle) {
            return null;
        }
     ...
     */
    getAllChangeHistory() {
        return [...this.changeHistory].sort((a, b) => b.changedAt.localeCompare(a.changedAt));
    }
    /**
     ...
     */
    compareVersions(bundleId, fromVersion, toVersion) {
     ...
     */
    addChangeEntry(bundleId, fromVersion, toVersion, changedBy, changeType) {
        const entry = {
     ...
     */
    cleanupDeprecatedVersions(bundleId) {
 ...
 */
export function createDefaultVersionManager(bundle) {
