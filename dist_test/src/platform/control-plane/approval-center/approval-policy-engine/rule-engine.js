 ...
 */
const DEFAULT_TIMEOUT_POLICY = "remain_pending";
/**
...
export class ApprovalPolicyEngine {
     ...
     */
    matchesConditions(rule, context) {
    ...
    applyRule(rule) {
        switch (rule.action) {
            ...
            default:
                return this.defaultResult(`Unknown rule action: ${rule.action}`);
        }
    }
    /**
     ...
     */
    ruleAlwaysOverrides(higher, lower) {
