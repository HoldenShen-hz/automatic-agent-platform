 ...
 */
export const REQUIRED_CONSUMERS_BY_EVENT_TYPE = {
...
export function getEventTier(eventType) {
    if (TIER_1_EVENT_TYPES.includes(eventType)) {
        return "tier_1";
    }
    return "tier_2";
}
 ...
 */
export function getRequiredConsumers(eventType) {
    return REQUIRED_CONSUMERS_BY_EVENT_TYPE[eventType] ?? [];
}
