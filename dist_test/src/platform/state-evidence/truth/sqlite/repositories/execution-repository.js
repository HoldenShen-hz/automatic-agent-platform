...
export class ExecutionRepository {
    ...
    listExecutionsByStatuses(statuses, limit) {
        ...
        last_error_message AS lastErrorMessage, started_at AS startedAt,
        finished_at AS finishedAt, created_at AS createdAt, updated_at AS updatedAt
       FROM executions WHERE status IN (${placeholders}) ORDER BY created_at DESC${limit ? ` LIMIT ${limit}` : ""}`;
        return queryAll(this.conn, sql, ...statuses);
    }
