...
export class ArtifactRepository {
    ...
    insertArtifact(artifact) {
        this.conn
          ...
          size_bytes, checksum, lineage_json, created_at
            ...
            .run(artifact.artifactId, artifact.taskId, artifact.executionId, artifact.stepId, artifact.kind, artifact.storagePath, artifact.fileName, artifact.mimeType, artifact.sizeBytes, artifact.checksum, artifact.lineageJson, artifact.createdAt);
    }
    /**
    ...
    getArtifact(artifactId) {
       ...
       FROM artifacts
       WHERE artifact_id = ?`, artifactId) ?? null;
    }
    /**
     * List artifacts for a task.
     */
    listArtifactsByTask(taskId, tenantId) {
