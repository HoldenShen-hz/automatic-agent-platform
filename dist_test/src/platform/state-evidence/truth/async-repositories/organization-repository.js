...
export class AsyncOrganizationRepository {
    ...
    async upsertTenantRecord(record) {
      ...
      ON CONFLICT(tenant_id) DO UPDATE SET
        ...
        updated_at = excluded.updated_at`, record.tenantId, record.organizationId, record.storageScope, record.identityScope, record.policyScope, record.artifactScope, record.isolationMode, record.deploymentMode, record.createdAt, record.updatedAt);
    }
