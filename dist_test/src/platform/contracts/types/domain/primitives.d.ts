...
export type BudgetScope = "task_execution" | "compaction" | "skill_execution" | "recovery_retry" | "approval_review";
...
export type MessagePartType = "text" | "reasoning" | "tool_use" | "tool_result" | "summary" | "artifact_ref" | "decision_prompt" | "agent_ref" | "subtask_ref" | "retry_record" | "step_boundary" | "compaction_marker" | "hook_event" | "command_execution" | "mcp_call";
...
export type DispatchWorkerRejectionReason = "worker_unavailable" | "worker_quarantined" | "worker_offline" | "worker_draining" | "worker_degraded_filtered" | "worker_untrusted" | "worker_capacity_full" | "queue_affinity_mismatch" | "missing_capabilities" | "worker_placement_mismatch" | "worker_isolation_mismatch" | "worker_repo_version_mismatch" | "worker_remote_session_unready";
export type LeaseAuditEventType = "lease_granted" | "lease_renewed" | "lease_expired" | "lease_reclaimed" | "stale_write_rejected" | "lease_released" | "lease_handover";
export type TakeoverSessionStatus = "open" | "closed";
export type OperatorActionType = "take_over_task" | "modify_input" | "retry_execution" | "skip_step" | "set_current_step" | "switch_worker" | "write_step_output" | "complete_task";
export type EvolutionProposalKind = "budget_adjustment" | "experience_promotion";
export type EvolutionProposalStatus = "pending_approval" | "approved" | "rejected" | "applied" | "rolled_back";
export type EvolutionScopeType = "division" | "role" | "task_intent";
export type EvolutionPolicyStatus = "active" | "rolled_back";
export type EvolutionLogEventType = "proposal_created" | "approval_synced" | "proposal_applied" | "proposal_rolled_back";
...
export type SecretCategory = "provider_api_key" | "tenant_credential" | "oauth_client_secret" | "signing_key" | "db_connection_secret" | "break_glass_secret";
...
export type TenantIsolationMode = "shared_logical" | "shared_hard_scoped" | "dedicated_runtime" | "dedicated_environment";
...
export type EnvironmentReadinessComponentType = "provider" | "gateway" | "sandbox" | "worker_fleet" | "artifact_store" | "notification_channel" | "external_service";
...
export type ExtensionLifecycleState = "discovered" | "installed" | "enabled" | "disabled" | "reloaded" | "removed";
export type MarketplaceReviewStatus = "submitted" | "approved" | "rejected";
export type MarketplacePublicationStatus = "published" | "revoked";
