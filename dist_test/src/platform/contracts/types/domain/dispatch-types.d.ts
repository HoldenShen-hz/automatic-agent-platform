 ...
 */
import type { DispatchWorkerRejectionReason, DispatchTarget, RemoteAvailability, TaskPriority, WorkerPlacement, WorkerIsolationLevel, RemoteSessionStatus, SessionConsistencyCheckStatus, WorkspaceSyncStatus, WorkerStatus, WorkerSchedulingStatus, Timestamp } from "./primitives.js";
/**
