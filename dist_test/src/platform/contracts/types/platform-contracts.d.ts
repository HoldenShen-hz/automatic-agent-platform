...
export type ControlDirectiveType = "mode_switch" | "pause" | "resume" | "rollback" | "quota_adjust" | "kill";
...
export declare function createPlatformPrincipal(input: {
    actorId: string;
...
export declare function createRequestEnvelope<TPayload>(input: {
...
export declare function createControlDirective<TParams extends Record<string, unknown>>(input: {
...
export declare function createExecutionPlan(input: {
    traceId: string;
    principal: PlatformPrincipal;
...
export declare function createExecutionReceipt(input: {
    planId: string;
    stepId: string;
...
export declare function createStateCommand<TPayload>(input: {
    traceId: string;
    principal: PlatformPrincipal;
...
export declare function createEvidenceRecord(input: {
    traceId: string;
    principal: PlatformPrincipal;
...
export declare function createProjectionUpdate(input: {
    projectionId: string;
