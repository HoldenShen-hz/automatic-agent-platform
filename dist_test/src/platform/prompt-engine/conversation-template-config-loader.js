 ...
 */
export function loadConversationTemplateConfig(configPath) {
    try {
 ...
 */
export function getTemplatesFromConfig(config) {
    return config.templates;
}
//# sourceMappingURL=conversation-template-config-loader.js.map