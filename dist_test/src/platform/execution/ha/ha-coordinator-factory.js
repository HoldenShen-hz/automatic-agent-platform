 ...
 */
export function createHaCoordinatorService(backend, options) {
 ...
 */
export function createHaRepositoryForBackend(backend, coordinatorId) {
    return createHaRepository(backend, coordinatorId);
}
//# sourceMappingURL=ha-coordinator-factory.js.map