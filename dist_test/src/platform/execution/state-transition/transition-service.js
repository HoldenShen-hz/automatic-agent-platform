...
export class WorkflowTransitionService {
    ...
    apply(command) {
        ...
        this.repository.updateWorkflowState(command.entityId, command.toStatus, command.currentStepIndex, command.outputsJson, command.occurredAt);
    }
}
/**
...
export class ExecutionTransitionService {
    ...
    apply(command) {
        ...
        const finishedAt = command.toStatus === "succeeded" || command.toStatus === "failed" || command.toStatus === "cancelled"
            ? command.occurredAt
            : null;
        this.repository.updateExecutionStatus(command.entityId, command.toStatus, command.occurredAt, startedAt, finishedAt);
    }
}
/**
