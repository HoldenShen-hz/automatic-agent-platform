...
function resolveWorkerStatus(snapshot, runningExecutionIds) {
...
export class OrphanCleanupService {
    ...
    collectIssues(checkedAt) {
        ...
        const orphanQueueClaims = this.dispatchReconciliation.scan(checkedAt).flatMap((issue) => issue.issueType === "orphan_queue_claim"
            ? [
                {
     ...
     */
    scanWorkerExecutionReferenceOrphans() {
     ...
     */
    closeOrphanSession(issue, occurredAt) {
     ...
     */
    requeueOrphanTicket(issue, occurredAt) {
        ...
        return {
            ...
            detail: repaired.replacementTicketId == null
     ...
     */
    cleanWorkerExecutionRefs(issue, occurredAt) {
