...
export type EditReplacementAttemptLevel = "exact" | "whitespace_normalized" | "indentation_normalized" | "fuzzy" | "context_anchored";
...
export interface EditBatchRequest extends Omit<EditReplacementRequest, "toolName" | "oldString" | "newString" | "beforeAnchor" | "afterAnchor"> {
    toolName: string;
...
export interface EditReplacementResult extends ToolCallResult<string | null, EditReplacementData, EditReplacementMetadata> {
    attempts: EditReplacementAttempt[];
    warnings: string[];
    matchLevel: EditReplacementAttemptLevel | null;
    similarityScore: number | null;
...
export interface EditBatchResult extends ToolCallResult<string | null, EditBatchData, EditBatchMetadata> {
    edits: EditBatchItemResult[];
    warnings: string[];
}
