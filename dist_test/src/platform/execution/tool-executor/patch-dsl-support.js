 ...
 * *** End Patch
 */
function parseCodexPatch(content) {
    const patches = [];
    const lines = content.split("\n");
    let index = 0;
 ...
 */
export function isNullPath(inputPath) {
 ...
 */
function deriveHunkCounts(lines) {
    let oldCount = 0;
    let newCount = 0;
 ...
 */
export function createSkippedResult(patch) {
    return {
 ...
 */
//# sourceMappingURL=patch-dsl-support.js.map