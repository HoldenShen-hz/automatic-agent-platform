...
export interface WorkerHandshakeDecision {
    accepted: boolean;
    reasonCode: "ticket_not_found" | "ticket_not_claimed" | "worker_mismatch" | "lease_mismatch" | "worker_not_registered" | "worker_not_trusted" | "lease_not_found" | "no_active_lease" | "stale_fencing_token" | "execution_not_found" | "lease_not_active" | "lease_expired" | "remote_session_viewer_only" | "remote_session_consistency_mismatch" | "remote_workspace_sync_conflict" | "remote_session_resume_offset_missing" | "resource_limit_exceeded" | null;
