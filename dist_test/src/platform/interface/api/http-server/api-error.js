...
import { GatewayTargetAmbiguousError, GatewayTargetNotFoundError, } from "../../channel-gateway/gateway-target-directory-service.js";
...
export function inferApiErrorCategory(statusCode, code) {
...
export function inferApiErrorSource(code) {
    if (code.startsWith("gateway.")) {
        return "gateway";
    }
    if (code.startsWith("approval.")) {
