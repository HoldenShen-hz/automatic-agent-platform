...
export function normalizeCorsConfig(config) {
    return {
...
function resolveAllowOrigin(origin, config) {
...
export function buildPreflightHeaders(origin, config) {
...
export function decorateResponseHeaders(payload, origin, corsConfig) {
    const headers = {
        ...payload.headers,
...
//# sourceMappingURL=response-hardening.js.map