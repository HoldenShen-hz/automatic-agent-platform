...
import { parseArtifactBundlePreviewPayload, parseArtifactBundlePublishPayload, } from "./schemas.js";
import { buildJsonResponse, requirePrincipal, readLimit, readQueryParam } from "./utils.js";
function buildNotEnabled(requestId, capability) {
...
export function createPlaneRoutes(deps) {
    return [
        {
            method: "GET",
        ...
        },
        {
            ...
            handler: (ctx) => {
                ...
                const payload = readValidatedJsonBody(ctx.request.body, parseArtifactBundlePreviewPayload);
        ...
        },
        {
            ...
            handler: (ctx) => {
                ...
                const payload = readValidatedJsonBody(ctx.request.body, parseArtifactBundlePublishPayload);
...
//# sourceMappingURL=plane-routes.js.map