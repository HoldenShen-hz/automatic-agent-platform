 ...
 */
export function detectToolPermissionDenial(signal) {
    ...
    for (const pattern of DENIAL_PATTERNS) {
        if (detail.includes(pattern.toLowerCase())) {
            ...
            return {
                ...
                recommendation: "Approve the tool in sandbox settings, adjust the sandbox policy for this tool, or route this task through HITL approval.",
