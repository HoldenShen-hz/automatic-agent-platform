 ...
 */
export function serializeHandoff(handoff, options) {
 ...
 */
function trimPlanDelta(delta) {
    const clone = JSON.parse(JSON.stringify(delta));
 ...
 */
function minimalHandoff(original) {
    return {
...
//# sourceMappingURL=handoff-serializer.js.map