...
export declare const AgentDefinitionSchema: z.ZodObject<{
    ...
    domainId: string;
    lifecycleState: "staging" | "active" | "draft" | "paused" | "archived" | "canary" | "deprecated" | "testing";
    components: {
        pack: {
            version: string;
            packId: string;
    ...
    lifecycleState?: "staging" | "active" | "draft" | "paused" | "archived" | "canary" | "deprecated" | "testing" | undefined;
