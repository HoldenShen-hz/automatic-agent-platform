import { shouldReplicateToRegion } from "./data-replicator/index.js";
import { resolveRegionFailover } from "./failover-controller/index.js";
import { selectPreferredRegion } from "./region-router/index.js";
function includesAllCapabilities(region, requiredCapabilities) {
...
export class CrossRegionRoutingService {
    route(request) {
        ...
        const blockedRegions = request.regions
            .filter((region) => blockedRegionIds.has(region.regionId)
...
//# sourceMappingURL=cross-region-routing-service.js.map