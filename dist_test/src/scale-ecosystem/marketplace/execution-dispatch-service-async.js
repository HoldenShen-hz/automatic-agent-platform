...
export class ExecutionDispatchServiceAsync extends EventEmitter {
     ...
     */
    constructor(db, store, backpressureSnapshot = null, queueAvailabilitySnapshot = null, options = {}) {
        super();
     ...
     */
    async createTicket(input, options) {
        return this.executeWithRetryAndTimeout("createTicket", () => this.sync.createTicket(input), options?.timeoutMs ?? this.options.defaultTimeoutMs, options?.signal);
    }
    /**
     ...
     */
    async dispatchNext(options, timeoutOptions) {
        return this.executeWithRetryAndTimeout("dispatchNext", () => this.sync.dispatchNext(options), timeoutOptions?.timeoutMs ?? this.options.defaultTimeoutMs, timeoutOptions?.signal);
    }
    /**
     ...
     * @returns Promise resolving to the ticket decision
     */
    enqueueTicketCreation(input, options) {
        return this.enqueueOperation("createTicket", () => this.sync.createTicket(input), options?.timeoutMs ?? this.options.defaultTimeoutMs, options?.signal);
    }
    /**
     ...
     * @returns Promise resolving to the dispatch decision
     */
    enqueueDispatch(options, timeoutOptions) {
        return this.enqueueOperation("dispatchNext", () => this.sync.dispatchNext(options), timeoutOptions?.timeoutMs ?? this.options.defaultTimeoutMs, timeoutOptions?.signal);
    }
    /**
     ...
     */
    enqueueOperation(operationName, operation, timeoutMs, signal) {
        if (this.disposed) {
