...
import { DeploymentExecutionService, } from "../../platform/control-plane/incident-control/deployment-execution-service.js";
import { ReleasePipelineService, } from "../../platform/control-plane/incident-control/release-pipeline-service.js";
...
if (dbPath == null || dbPath.length === 0) {
    ...
    if (action === "list") {
        ...
        const input = {
            environment: requiredEnv("AA_RELEASE_ENVIRONMENT"),
            version: requiredEnv("AA_RELEASE_VERSION"),
            commitSha: requiredEnv("AA_RELEASE_COMMIT_SHA"),
            rolloutStrategy: requiredEnv("AA_RELEASE_ROLLOUT_STRATEGY"),
...
//# sourceMappingURL=release-pipeline.js.map