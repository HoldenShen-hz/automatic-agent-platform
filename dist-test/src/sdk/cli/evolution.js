...
function main() {
    ...
    const result = withCliStorage((storage) => {
        ...
        switch (envConfig.action) {
            ...
            case "list":
                return evolution.listProposalViews(envConfig.status);
            case "resolve_budget":
                ...
                return evolution.resolveBudgetPolicy(envConfig.basePolicy, envConfig.scopeType, envConfig.scopeRef);
            case "evaluate_budget":
                ...
                return new BudgetGuard().evaluateTaskSpend({
                    policy: evolution.resolveBudgetPolicy(envConfig.basePolicy, envConfig.scopeType, envConfig.scopeRef).policy,
