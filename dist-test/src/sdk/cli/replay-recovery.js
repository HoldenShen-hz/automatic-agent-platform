...
function resolveLegacyReplayOutput() {
...
function main() {
    ...
    const output = withCliStorage((storage) => {
        ...
        switch (envConfig.kind) {
            ...
            default:
                throw new ValidationError(`unknown_recovery_replay_kind:${envConfig.kind}`, `unknown_recovery_replay_kind:${envConfig.kind}`);
        }
