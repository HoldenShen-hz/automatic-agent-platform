...
import { buildMemoryProviderQuery, buildStructuredMemoryContentFromCliEnv, loadMemoryCliEnv, } from "../../platform/control-plane/config-center/remaining-cli-env.js";
    ...
    await withCliStorageAsync(async (storage) => {
        ...
        switch (action) {
            case "initialize":
                ...
                break;
            case "remember": {
                const memoryLayer = envConfig.memoryLayer;
                const sourceTrustLevel = envConfig.sourceTrustLevel;
            ...
            case "sync_turn": {
                ...
                const hasExperience = envConfig.experienceTaskContext
            ...
            case "revoke":
                output = memory.revoke(envConfig.memoryId ?? missingRequired("AA_MEMORY_ID"), envConfig.revocationReason ?? missingRequired("AA_MEMORY_REVOCATION_REASON"));
                break;
            default:
