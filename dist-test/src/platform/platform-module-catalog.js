...
export const PLATFORM_SURFACE_MANIFESTS = Object.freeze([
    {
        surfaceId: "contracts",
...
export function listPlatformSurfaceManifests() {
    return PLATFORM_SURFACE_MANIFESTS;
}
export function resolvePlatformSurfaceManifest(surfaceId) {
...
export function registerPlatformSurfaceCatalog(registry = ServiceRegistry.getInstance()) {
    registry.register("platform.surface-catalog", {
        init: () => PLATFORM_SURFACE_MANIFESTS,
    });
    return registry.get("platform.surface-catalog");
}
//# sourceMappingURL=platform-module-catalog.js.map