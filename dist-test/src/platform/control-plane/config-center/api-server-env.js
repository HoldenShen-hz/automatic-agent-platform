...
import { loadGatewayEnv, readTrimmedEnv } from "./gateway-env.js";
/**
...
function parseBoolean(raw, errorCode) {
    if (raw == null) {
        return undefined;
    }
 ...
 */
function validateJwtSecret(secret, apiKeys) {
 ...
 */
export function loadApiServerEnv(env = process.env) {
    ...
    const fluentdReconnectIntervalMs = parsePositiveInteger(readTrimmedEnv(env, "AA_LOG_FLUENTD_RECONNECT_INTERVAL_MS"), "api.invalid_log_fluentd_reconnect_interval_ms") ?? undefined;
    const fluentdBufferLimit = parsePositiveInteger(readTrimmedEnv(env, "AA_LOG_FLUENTD_BUFFER_LIMIT"), "api.invalid_log_fluentd_buffer_limit") ?? undefined;
    ...
    const datadogBatchSize = parsePositiveInteger(readTrimmedEnv(env, "AA_LOG_DATADOG_BATCH_SIZE"), "api.invalid_log_datadog_batch_size") ?? undefined;
    const datadogFlushIntervalMs = parsePositiveInteger(readTrimmedEnv(env, "AA_LOG_DATADOG_FLUSH_INTERVAL_MS"), "api.invalid_log_datadog_flush_interval_ms") ?? undefined;
    ...
    return {
        ...
        logFileMaxFiles,
        logStdout,
        logFluentd: fluentdHost == null || fluentdPort == null || fluentdTag == null
            ? null
            : {
                host: fluentdHost,
                port: fluentdPort,
        ...
        logDatadog: datadogApiKey == null || datadogService == null
            ? null
            : {
...
//# sourceMappingURL=api-server-env.js.map