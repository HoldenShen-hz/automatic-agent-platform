...
export declare function createScopedExternalAccessPolicy(workspaceRoot: string): SandboxPolicy;
export declare function createRestrictedExecPolicy(workspaceRoot: string): SandboxPolicy;
/**
 ...
 */
export declare function createConfigReadPolicy(configRoot: string): SandboxPolicy;
