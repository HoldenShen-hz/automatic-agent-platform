...
export class DataClassificationService {
     ...
     */
    getHandlingDecision(level, dimension, content) {
     ...
     */
    filterForPrompt(content, context) {
     ...
     * @returns Filtered content, decision made, and PII annotations
     */
    filterForMemory(content, context) {
        const classification = this.classify(content, context);
     ...
     */
    redactContent(content, annotations) {
     ...
     */
    inferClassificationLevel(content, context) {
...
//# sourceMappingURL=data-classification-service.js.map