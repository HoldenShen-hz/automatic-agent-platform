...
import { loadExceptionRecoveryConfig, } from "./exception-recovery-config-loader.js";
import { ERROR_CLASS_TO_EXCEPTION_TYPE, } from "./exception-recovery-types.js";
 ...
 */
function toCandidate(record, reason, config) {
    return {
 ...
 */
function inferSuggestedAction(record, reason, config) {
 ...
 */
function resolveExceptionType(errorCode, reasonCode) {
...
//# sourceMappingURL=runtime-recovery-service.js.map