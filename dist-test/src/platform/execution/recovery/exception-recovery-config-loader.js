 ...
 */
export function loadExceptionRecoveryConfig(configPath = DEFAULT_CONFIG_PATH, sandboxPolicy) {
    if (cachedConfig) {
        return cachedConfig;
    }
    ...
    if (sandboxPolicy != null) {
        ...
        if (!check.allowed) {
            throw new PolicyDeniedError(check.reasonCode ?? "config.exception_recovery_denied", check.reasonCode ?? "config.exception_recovery_denied");
        }
 ...
 */
export function clearExceptionRecoveryConfigCache() {
    cachedConfig = null;
}
//# sourceMappingURL=exception-recovery-config-loader.js.map