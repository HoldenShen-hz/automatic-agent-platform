 ...
 */
export declare class ExecutionWorkerHandshakeServiceAsync {
     ...
     */
    claimExecution(input: WorkerClaimExecutionInput): Promise<WorkerHandshakeDecision>;
    /**
     * Records a heartbeat from a worker.
     */
    recordHeartbeat(input: WorkerExecutionHeartbeatInput): Promise<WorkerHandshakeDecision>;
    /**
