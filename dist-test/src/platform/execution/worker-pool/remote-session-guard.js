...
function hasAcknowledgedOffset(value) {
 ...
 */
export function resolveRemoteAuthorityBlockReason(state) {
    ...
    if (state.remoteSessionStatus != null
...
//# sourceMappingURL=remote-session-guard.js.map