 ...
 */
export function normalizeToolPathScopeRoots(roots) {
 ...
 */
export function hasToolPathScopeRestrictions(roots) {
 ...
 */
export function checkToolPathScope(inputPath, roots) {
...
//# sourceMappingURL=tool-path-scope.js.map