 ...
 */
export function normalizeIndentationAware(value) {
 ...
 */
export function stripCommonIndent(value) {
 ...
 */
export function detectCommonIndent(value) {
 ...
 */
export function trimTerminalEmptyLine(lines) {
 ...
 */
export function preserveTrailingNewline(replacement, matchedText) {
