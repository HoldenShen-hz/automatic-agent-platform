 ...
 */
export interface ToolCallResult<TOutput, TData extends object | null = Record<string, unknown> | null, TMetadata extends object | null = Record<string, unknown> | null> {
 ...
 */
export declare function isToolCallSuccessful(status: ToolCallStatus): boolean;
