...
import { ExecutionResourceCeilingGuard, } from "./execution-resource-ceiling-guard.js";
/**
...
export class ExecutionResourceMonitor {
    store;
    guard;
    constructor(store, guard = new ExecutionResourceCeilingGuard()) {
        this.store = store;
        this.guard = guard;
    }
    /**
...
//# sourceMappingURL=execution-resource-monitor.js.map