export const EXECUTION_CAPABILITY_BASELINES = Object.freeze([
...
export function listExecutionCapabilityBaselines() {
    return EXECUTION_CAPABILITY_BASELINES;
}
export function resolveExecutionCapabilityBaseline(capabilityId) {
...
//# sourceMappingURL=execution-plane-baseline.js.map