...
export class EffectBuffer {
    scopes = new BoundedCache(50);
    log;
    // C-10: TTL-based eviction to prevent memory leaks
    MAX_SCOPES = 100;
    SCOPE_TTL_MS = 60 * 60 * 1000; // 1 hour
    lastEvictionTime = 0;
    EVICTION_INTERVAL_MS = 5 * 60 * 1000; // Once per 5 minutes
    constructor(logger) {
        this.log = logger ?? (() => { });
    }
    /**
...
//# sourceMappingURL=effect-buffer.js.map