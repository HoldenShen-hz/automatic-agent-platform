...
export class PromptRendererService {
    render(input) {
        ...
        if (unresolvedVariables.length > 0) {
            throw new ValidationError(`prompt_renderer.missing_required_variables:${unresolvedVariables.join(",")}`, `Prompt rendering requires variables: ${unresolvedVariables.join(", ")}.`);
        }
