...
import { buildDiagnosticWarningSummary, buildIncidentRootCauses, buildPrimaryTraceContext, buildTraceSummary, compactionToIncidentTimelineEntry, countIncidentEntries, extractRemoteAuthorityViolations, extractRemoteWorkerIds, logToIncidentTimelineEntry, messageToIncidentTimelineEntry, previewText, resolveDurationMs, resolveHighestIncidentSeverity, sanitizeArtifact, selectRemoteTimelineEntries, toIncidentTimelineEntry, } from "./diagnostics-support.js";
...
export class DiagnosticsService {
    ...
    retentionService;
    timelineService;
    configGovernance = new ConfigGovernanceService();
    constructor(inspectService, healthService, logger, retentionService = null) {
    ...
    buildDebugDump(taskId) {
        ...
        return {
            ...
            dispatchSummary: {
                ...
                latestRejectedWorkers: latestDispatchDecision?.evaluations
    ...
    buildMinimalReproBundle(taskId) {
        ...
        return {
            taskId,
            sensitivityWarning: "Bundle may contain session messages, logs, and configuration metadata. Review before sharing.",
    ...
    buildRemoteTimelineReport(taskId) {
    ...
    collectIncidentLogs(taskId, traceId, correlationId) {
