...
import { SINGLE_TASK_GOLDEN_TASKS, runGoldenTaskCase, writeGoldenTaskInventoryBaseline, } from "./golden-task-runner.js";
 ...
 */
export function summarizeStableValidationRuns(runs) {
 ...
 */
export function buildStableValidationBaseline(report) {
    return {
...
function calculateDeltaPct(current, baseline) {
    if (baseline <= 0) {
...
function resolveDriftStatus(deltaMs, deltaPct) {
 ...
 */
export function compareStableValidationToBaseline(report, baseline, baselinePath) {
 ...
 */
export function mergeStableValidationReports(reports) {
 ...
 */
export async function runStableValidation(options) {
    ...
    const existingBaseline = safeReadJson(baselinePath);
...
//# sourceMappingURL=stable-runtime-validator.js.map