...
function buildBackupRestoreRuntimeVersionSnapshot(outputDir) {
...
async function runSqliteBackupRestoreRoundtrip(outputDir) {
    return measureScenario(async () => {
        ...
        sourceDb.close();
        const restore = reliability.restoreBackup(backupPath, restorePath);
...
export async function runStableBackupRestoreRehearsal(options) {
...
export function writeStableBackupRestoreRehearsalReport(outputFile, report) {
    writeJson(outputFile, report);
}
//# sourceMappingURL=stable-backup-restore-rehearsal.js.map