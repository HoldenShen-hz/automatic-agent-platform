 ...
 */
export function canPreempt(preemptor, target) {
 ...
 */
export function findTaskToPreempt(preemptor, runningTasks) {
...
export class PriorityScheduler {
    ...
    constructor(starvationThresholdMs = 30 * 60 * 1000) {
    ...
    tick() {
        ...
        for (const task of this.queue) {
            if (task.waitedMs > this.starvationThresholdMs
 ...
 */
export function hasExceededTimeout(task) {
