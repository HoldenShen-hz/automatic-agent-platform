...
import { SQLITE_MIGRATIONS, SQLITE_MIGRATION_LEDGER_SQL, } from "./sqlite-migration-plan.js";
 ...
 */
export function isSqliteWriteContentionError(error) {
...
export class SqliteDatabase {
    ...
    migrate() {
        ...
        for (const migration of this.migrationPlan) {
            ...
            if (!this.isMigrationChecksumCompatible(existing.checksum, migration)) {
                throw new StorageError(`sqlite.migration_checksum_mismatch:${migration.version}`, `sqlite.migration_checksum_mismatch:${migration.version}`, {
                    retryable: false,
    ...
    assertSchemaCurrent() {
        ...
        if (status.checksumMismatches.length > 0) {
            throw new StorageError(`sqlite.migration_checksum_mismatch:${status.checksumMismatches.map((item) => item.version).join(",")}`, `sqlite.migration_checksum_mismatch:${status.checksumMismatches.map((item) => item.version).join(",")}`, {
                retryable: false,
     ...
     */
    checkpointWal() {
        const row = this.connection.prepare("PRAGMA wal_checkpoint(TRUNCATE);").get();
     ...
     */
    rollbackTransaction(isRootTransaction, savepointName) {
        try {
            if (isRootTransaction) {
     ...
     */
    normalizeTransactionError(mode, error) {
     ...
     */
    applyCompatibleColumnMigrationIfKnown(migration) {
        switch (migration.version) {
            case 5:
                this.ensureColumn("worker_snapshots", "placement", "ALTER TABLE worker_snapshots ADD COLUMN placement TEXT NOT NULL DEFAULT 'local';");
                this.ensureColumn("execution_tickets", "dispatch_target", "ALTER TABLE execution_tickets ADD COLUMN dispatch_target TEXT NOT NULL DEFAULT 'any';");
                return true;
            case 6:
                this.ensureColumn("worker_snapshots", "isolation_level", "ALTER TABLE worker_snapshots ADD COLUMN isolation_level TEXT NOT NULL DEFAULT 'standard';");
                this.ensureColumn("execution_tickets", "required_isolation_level", "ALTER TABLE execution_tickets ADD COLUMN required_isolation_level TEXT NOT NULL DEFAULT 'standard';");
                return true;
            case 7:
                this.ensureColumn("messages", "parts_json", "ALTER TABLE messages ADD COLUMN parts_json TEXT NULL;");
                return true;
            case 8:
                this.ensureColumn("worker_snapshots", "repo_version", "ALTER TABLE worker_snapshots ADD COLUMN repo_version TEXT NULL;");
                this.ensureColumn("execution_tickets", "required_repo_version", "ALTER TABLE execution_tickets ADD COLUMN required_repo_version TEXT NULL;");
                return true;
            case 9:
                this.ensureColumn("worker_snapshots", "remote_session_status", "ALTER TABLE worker_snapshots ADD COLUMN remote_session_status TEXT NULL;");
                this.ensureColumn("worker_snapshots", "last_acknowledged_stream_offset", "ALTER TABLE worker_snapshots ADD COLUMN last_acknowledged_stream_offset TEXT NULL;");
                this.ensureColumn("worker_snapshots", "stream_resume_success_rate", "ALTER TABLE worker_snapshots ADD COLUMN stream_resume_success_rate REAL NULL;");
                this.ensureColumn("worker_snapshots", "credential_refresh_success_rate", "ALTER TABLE worker_snapshots ADD COLUMN credential_refresh_success_rate REAL NULL;");
                this.ensureColumn("worker_snapshots", "session_consistency_check_status", "ALTER TABLE worker_snapshots ADD COLUMN session_consistency_check_status TEXT NULL;");
                this.ensureColumn("worker_snapshots", "session_consistency_checked_at", "ALTER TABLE worker_snapshots ADD COLUMN session_consistency_checked_at TEXT NULL;");
                this.ensureColumn("worker_snapshots", "saturation", "ALTER TABLE worker_snapshots ADD COLUMN saturation REAL NULL;");
                this.ensureColumn("worker_snapshots", "active_lease_count", "ALTER TABLE worker_snapshots ADD COLUMN active_lease_count INTEGER NOT NULL DEFAULT 0;");
                this.ensureColumn("worker_snapshots", "mean_startup_latency_ms", "ALTER TABLE worker_snapshots ADD COLUMN mean_startup_latency_ms INTEGER NULL;");
                this.ensureColumn("worker_snapshots", "sandbox_success_rate", "ALTER TABLE worker_snapshots ADD COLUMN sandbox_success_rate REAL NULL;");
                this.ensureColumn("worker_snapshots", "repo_cache_hit_rate", "ALTER TABLE worker_snapshots ADD COLUMN repo_cache_hit_rate REAL NULL;");
                return true;
            case 11:
                this.ensureColumn("worker_snapshots", "registration_verified_at", "ALTER TABLE worker_snapshots ADD COLUMN registration_verified_at TEXT NULL;");
                this.ensureColumn("worker_snapshots", "registration_challenge_id", "ALTER TABLE worker_snapshots ADD COLUMN registration_challenge_id TEXT NULL;");
...
`);
                return true;
            case 12:
                this.ensureColumn("events", "session_id", "ALTER TABLE events ADD COLUMN session_id TEXT NULL;");
                this.connection.exec("CREATE INDEX IF NOT EXISTS idx_events_session_created_at ON events(session_id, created_at);");
                return true;
            case 13:
                this.ensureColumn("worker_snapshots", "workspace_sync_status", "ALTER TABLE worker_snapshots ADD COLUMN workspace_sync_status TEXT NULL;");
                this.ensureColumn("worker_snapshots", "workspace_sync_checked_at", "ALTER TABLE worker_snapshots ADD COLUMN workspace_sync_checked_at TEXT NULL;");
                return true;
            case 15:
                this.ensureColumn("memories", "session_id", "ALTER TABLE memories ADD COLUMN session_id TEXT NULL;");
                this.ensureColumn("memories", "agent_id", "ALTER TABLE memories ADD COLUMN agent_id TEXT NULL;");
                this.ensureColumn("memories", "execution_id", "ALTER TABLE memories ADD COLUMN execution_id TEXT NULL;");
                this.ensureColumn("memories", "memory_layer", "ALTER TABLE memories ADD COLUMN memory_layer TEXT NOT NULL DEFAULT 'layer_3';");
                this.ensureColumn("memories", "source_trust_level", "ALTER TABLE memories ADD COLUMN source_trust_level TEXT NOT NULL DEFAULT 'trusted';");
                this.ensureColumn("memories", "quality_score", "ALTER TABLE memories ADD COLUMN quality_score REAL NULL;");
                this.ensureColumn("memories", "hit_count", "ALTER TABLE memories ADD COLUMN hit_count INTEGER NOT NULL DEFAULT 0;");
                this.ensureColumn("memories", "last_accessed_at", "ALTER TABLE memories ADD COLUMN last_accessed_at TEXT NULL;");
                this.ensureColumn("memories", "expires_at", "ALTER TABLE memories ADD COLUMN expires_at TEXT NULL;");
                this.ensureColumn("memories", "revoked_at", "ALTER TABLE memories ADD COLUMN revoked_at TEXT NULL;");
                this.ensureColumn("memories", "revocation_reason", "ALTER TABLE memories ADD COLUMN revocation_reason TEXT NULL;");
                this.connection.exec(`
...
`);
                this.ensureColumn("tenants", "organization_id", "ALTER TABLE tenants ADD COLUMN organization_id TEXT NULL;");
                this.ensureColumn("tenants", "storage_scope", "ALTER TABLE tenants ADD COLUMN storage_scope TEXT NOT NULL DEFAULT 'tenant';");
                this.ensureColumn("tenants", "identity_scope", "ALTER TABLE tenants ADD COLUMN identity_scope TEXT NOT NULL DEFAULT 'tenant';");
                this.ensureColumn("tenants", "policy_scope", "ALTER TABLE tenants ADD COLUMN policy_scope TEXT NOT NULL DEFAULT 'tenant';");
                this.ensureColumn("tenants", "artifact_scope", "ALTER TABLE tenants ADD COLUMN artifact_scope TEXT NOT NULL DEFAULT 'tenant';");
                this.ensureColumn("tenants", "isolation_mode", "ALTER TABLE tenants ADD COLUMN isolation_mode TEXT NOT NULL DEFAULT 'shared';");
                this.ensureColumn("tenants", "deployment_mode", "ALTER TABLE tenants ADD COLUMN deployment_mode TEXT NOT NULL DEFAULT 'single_region';");
                this.connection.exec(`
...
`);
     ...
     */
    ensureColumn(tableName, columnName, addColumnSql) {
     ...
     */
    isMigrationChecksumCompatible(existingChecksum, migration) {
