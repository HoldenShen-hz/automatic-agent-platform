...
import { BILLING_COLLECTION_FOUNDATION_SQL, CONTROL_PLANE_LOAD_BALANCING_FOUNDATION_SQL, DATA_PLANE_FLOW_FOUNDATION_SQL, DLQ_RECORDS_SQL, ENTERPRISE_GOVERNANCE_FOUNDATION_SQL, EVENT_DEAD_LETTERS_SQL, LLM_EVAL_AND_GOVERNANCE_FOUNDATION_SQL, PRODUCT_GOVERNANCE_TENANT_SCOPE_SQL, RELEASE_DEPLOYMENT_LEDGER_SQL, RELEASE_EXECUTION_REPORTS_SQL, SECRET_LEASES_SQL, SESSION_EVENTS_SQL, SKILL_GOVERNANCE_FOUNDATION_SQL, TASK_TENANT_SCOPE_SQL, TENANT_DATA_NAMESPACE_FOUNDATION_SQL, WORKFLOW_DISPATCH_RECEIPT_AUDIT_SQL, } from "./sqlite/sqlite-migration-runtime-part3.js";
...
export class SchemaInventoryService {
    ...
    buildSummary() {
        ...
        return {
            ...
            byCategory: tables.reduce((summary, table) => {
...
//# sourceMappingURL=schema-inventory-service.js.map