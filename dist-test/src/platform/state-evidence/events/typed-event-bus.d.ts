...
import { type KnownEventType } from "./event-registry.js";
...
import type { CostLimitReachedPayload, DecisionRequestedPayload, DecisionRespondedPayload, DispatchTicketPayload, DivisionOutcomePayload, RecoveryPayload, StreamChunkEmittedPayload, SubtaskOutcomePayload, TakeoverPayload, TaskStatusChangedPayload, DomainLifecyclePayload, PluginLifecycleEventPayload, PluginInvocationEventPayload, KnowledgeChunkIndexedPayload, LearningKnowledgePromotedPayload, WorkerLifecyclePayload, WorkflowStepCompletedPayload } from "./typed-event-payloads.js";
/**
...
export declare class TypedEventBus {
     ...
     */
    subscribe<TType extends TypedEventType>(consumerId: string, eventTypes: readonly TType[], handler: (event: TypedEventEnvelope<TType>) => void | Promise<void>): void;
    /**
     ...
     */
    pendingForConsumer(consumerId: string): import("../truth/authoritative-task-store.js").PendingAckEvent[];
}
