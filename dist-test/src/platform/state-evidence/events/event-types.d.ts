 ...
 */
export declare const TIER_1_EVENT_TYPES: readonly ["task:status_changed", "workflow:step_completed", "decision:requested", "decision:responded", "division:completed", "division:failed", "subtask:completed", "subtask:failed", "cost:limit_reached", "delegation:created", "delegation:completed", "delegation:failed", "prompt:injected", "prompt:rendered", "prompt:validation_failed", "cost:budget_created", "cost:budget_exceeded", "cost:actualized", "tenant:provisioned", "tenant:suspended", "tenant:deleted", "pack:installed", "pack:uninstalled", "marketplace:listing_published", "marketplace:listing_purchased", "anomaly:classified", "slo:breached", "slo:recovered", "compliance:audit_recorded", "compliance:violation_detected", "knowledge:document_indexed", "knowledge:query_processed"];
/**
