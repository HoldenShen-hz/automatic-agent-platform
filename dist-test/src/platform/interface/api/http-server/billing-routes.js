...
export function createBillingRoutes(deps) {
    return [
        {
            method: "POST",
            ...
            handler: (ctx) => {
                ...
                const hasAuthCredential = (typeof ctx.request.headers.authorization === "string" && ctx.request.headers.authorization.trim().length > 0)
