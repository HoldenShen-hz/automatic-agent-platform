export const MODEL_GATEWAY_CAPABILITY_BASELINES = Object.freeze([
    {
...
export function listModelGatewayCapabilityBaselines() {
    return MODEL_GATEWAY_CAPABILITY_BASELINES;
}
export function resolveModelGatewayCapabilityBaseline(capabilityId) {
...
//# sourceMappingURL=model-gateway-baseline.js.map