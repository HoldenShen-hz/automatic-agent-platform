...
import { CONTROL_PLANE_BOOTSTRAP_SERVICE_ID, buildControlPlaneBootstrap, } from "./control-plane/control-plane-bootstrap.js";
import { EXECUTION_PLANE_BOOTSTRAP_SERVICE_ID, buildExecutionPlaneBootstrap, } from "./execution/execution-plane-bootstrap.js";
import { INTERFACE_PLANE_BOOTSTRAP_SERVICE_ID, buildInterfacePlaneBootstrap, } from "./interface/interface-plane-bootstrap.js";
import { ORCHESTRATION_PLANE_BOOTSTRAP_SERVICE_ID, buildOrchestrationPlaneBootstrap, } from "./orchestration/orchestration-plane-bootstrap.js";
import { resolvePlatformSurfaceManifest, } from "./platform-module-catalog.js";
import { STATE_EVIDENCE_PLANE_BOOTSTRAP_SERVICE_ID, buildStateEvidencePlaneBootstrap, } from "./state-evidence/state-evidence-plane-bootstrap.js";
export const FIVE_PLANE_STARTUP_PLAN_SERVICE_ID = "plane.runtime.startup-plan";
export function buildFivePlaneStartupPlan() {
...
export function registerFivePlaneStartupPlan(registry = ServiceRegistry.getInstance()) {
    registry.register(FIVE_PLANE_STARTUP_PLAN_SERVICE_ID, {
    ...
    return registry.get(FIVE_PLANE_STARTUP_PLAN_SERVICE_ID);
}
//# sourceMappingURL=five-plane-startup-plan.js.map