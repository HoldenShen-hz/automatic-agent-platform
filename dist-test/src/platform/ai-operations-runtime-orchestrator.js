...
import { AI_OPERATIONS_RUNTIME_CATALOG_SERVICE_ID, registerAiOperationsRuntimeCatalog, } from "./ai-operations-runtime-catalog.js";
import { AI_OPERATIONS_STARTUP_PLAN_SERVICE_ID, buildAiOperationsStartupPlan, registerAiOperationsStartupPlan, } from "./ai-operations-startup-plan.js";
import { COMPLIANCE_BOOTSTRAP_SERVICE_ID, registerComplianceBootstrap, } from "./compliance/compliance-bootstrap.js";
import { HARNESS_BOOTSTRAP_SERVICE_ID, registerHarnessBootstrap, } from "./orchestration/harness/harness-bootstrap.js";
import { MODEL_GATEWAY_BOOTSTRAP_SERVICE_ID, registerModelGatewayBootstrap, } from "./model-gateway/model-gateway-bootstrap.js";
import { PROMPT_ENGINE_BOOTSTRAP_SERVICE_ID, registerPromptEngineBootstrap, } from "./prompt-engine/prompt-engine-bootstrap.js";
...
export function registerAiOperationsRuntimeOrchestrator(registry = ServiceRegistry.getInstance()) {
    ...
    registry.register(AI_OPERATIONS_RUNTIME_ORCHESTRATOR_SERVICE_ID, {
    ...
    return registry.get(AI_OPERATIONS_RUNTIME_ORCHESTRATOR_SERVICE_ID);
}
//# sourceMappingURL=ai-operations-runtime-orchestrator.js.map