...
export declare const OapeflirStageRecordSchema: z.ZodObject<{
    ...
    stage: "plan" | "execute" | "release" | "observe" | "assess" | "feedback" | "learn" | "improve" | "knowledge_promotion";
...
export declare class OapeflirStageTimelineBuilder {
    ...
    private tick;
    record(stage: OapeflirStage, status: OapeflirStageStatus, refId?: string | null, reasonCode?: string | null, rationale?: string | null): OapeflirStageRecord;
