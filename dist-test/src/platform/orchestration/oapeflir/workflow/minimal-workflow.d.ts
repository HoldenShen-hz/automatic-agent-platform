 ...
 */
export type CompensationModel = "idempotent_replay" | "compare_and_swap_write" | "compensating_action" | "manual_reconciliation_required";
/**
 ...
 */
export declare const SINGLE_AGENT_MINIMAL_WORKFLOW: MinimalWorkflowDefinition;
/**
 ...
 */
export declare const PHASE_1B_SINGLE_DIVISION_WORKFLOW: MinimalWorkflowDefinition;
/**
 * Registry of built-in workflow definitions.
 * Maps workflow ID to definition for quick lookup.
 */
export declare const WORKFLOW_DEFINITIONS: ReadonlyMap<string, MinimalWorkflowDefinition>;
/**
 ...
 */
export declare function getWorkflowDefinition(workflowId: string): MinimalWorkflowDefinition | null;
