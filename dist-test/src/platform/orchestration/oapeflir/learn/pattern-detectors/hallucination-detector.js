 ...
 */
export function detectModelHallucination(signal) {
    ...
    if (evalScore > 0 && evalScore < 0.3) {
        ...
        return {
            ...
            recommendation: "Switch to a more reliable model for this task type, or provide additional grounding context to reduce hallucination risk.",
