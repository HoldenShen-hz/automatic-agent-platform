...
export class OapeflirLoopService {
    ...
    executeBridge;
    boundaryLogger = new StructuredLogger({ retentionLimit: 500 });
    constructor(options = {}) {
    ...
    async run(input) {
        return await startActiveSpan("oapeflir.loop", {
            ...
            timeline.record("learn", learningObjects.length > 0 ? "completed" : "skipped", learningObjects[0]?.learningObjectId ?? null, learningObjects.length > 0 ? null : "learning.no_objects", learningObjects.length > 0
            ...
            if (learningObjects.length > 0) {
                ...
                if (validatedLearningObjects.length === 0) {
                    ...
                    if (boundary.allowed) {
                        ...
                        timeline.record("release", rolloutRecord ? "completed" : "skipped", rolloutRecord?.recordId ?? null, rolloutRecord ? null : "release.validation_failed", rolloutRecord
