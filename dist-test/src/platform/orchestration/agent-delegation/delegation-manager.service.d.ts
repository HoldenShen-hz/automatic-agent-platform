 ...
 */
import { type ACPMessage, type InvariantContext } from "./collaboration-protocol/index.js";
...
export declare class DelegationManagerService {
    ...
    private readonly collaborationProtocol;
    ...
    completeWithEvidence(delegationId: string, evidence: readonly string[], outputRef?: string): Promise<void>;
    /**
    ...
    validateCollaborationMessage(message: ACPMessage, context: InvariantContext): {
        accepted: boolean;
        violations: string[];
    };
    recordTakeoverNotice(message: ACPMessage, context: InvariantContext): {
        accepted: boolean;
        violations: string[];
    };
