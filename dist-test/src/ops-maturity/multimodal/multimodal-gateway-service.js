...
export class MultimodalGatewayService {
    handle(request, createdAt = nowIso()) {
    ...
    estimatePartCost(part, modality, unitCostUsd) {
        switch (modality) {
            case "document":
...
//# sourceMappingURL=multimodal-gateway-service.js.map