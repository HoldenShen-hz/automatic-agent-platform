...
export declare class TimeTravelDebugService {
    ...
    private readonly maxEventsPerExecution;
    private readonly maxSnapshotsPerSession;
    private readonly sessions;
    private readonly eventStore;
    private readonly snapshots;
    constructor(options?: TimeTravelDebugServiceOptions);
    ...
    loadEventStore(executionId: string, events: readonly TimeTravelDebugEvent[]): void;
    ...
    private evictOldestSessionIfNeeded;
}
