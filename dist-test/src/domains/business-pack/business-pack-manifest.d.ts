 ...
 */
export type BusinessPackLifecycleStage = "draft" | "certifying" | "published" | "deprecated" | "archived";
/**
...
export declare const BusinessPackManifestSchema: z.ZodObject<{
    ...
    lifecycleStage: z.ZodDefault<z.ZodEnum<["draft", "certifying", "published", "deprecated", "archived"]>>;
    ...
    tags: string[];
    packId: string;
    lifecycleStage: "draft" | "deprecated" | "published" | "archived" | "certifying";
    ...
    failureStrategy: "fallback" | "continue" | "fail_fast" | "skip";
    ...
    sandboxTier: "none" | "scoped_external_access" | "process" | "container";
    permissions: {
        level: "admin" | "read" | "write";
        permission: string;
        justification: string;
    ...
    lifecycleStage?: "draft" | "deprecated" | "published" | "archived" | "certifying" | undefined;
    ...
    failureStrategy?: "fallback" | "continue" | "fail_fast" | "skip" | undefined;
    ...
    sandboxTier?: "none" | "scoped_external_access" | "process" | "container" | undefined;
    permissions?: {
        permission: string;
        level?: "admin" | "read" | "write" | undefined;
        justification?: string | undefined;
