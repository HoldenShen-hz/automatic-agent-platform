...
export declare class PackMigrationService {
    ...
    private readonly exportedSnapshots;
    private readonly executionTrace;
    /**
    ...
    seedPackState(packId: string, state: Record<string, unknown>): void;
    getPackState(packId: string): Record<string, unknown> | null;
    listExecutionTrace(planId: string): MigrationStepExecutionRecord[];
