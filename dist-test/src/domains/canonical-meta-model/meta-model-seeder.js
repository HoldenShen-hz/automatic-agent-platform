...
function buildAnswer(input, questionId) {
...
export function seedDomainMetaModel(input) {
    return {
...
export function seedDomainMetaModels(inputs) {
    return inputs.map((input) => seedDomainMetaModel(input));
}
//# sourceMappingURL=meta-model-seeder.js.map