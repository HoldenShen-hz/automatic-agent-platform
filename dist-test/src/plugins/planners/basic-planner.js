export function createBasicPlannerPlugin() {
    return {
        ...
        async suggestWorkflow(task) {
            ...
            const overrides = task.assessment.complexity === "trivial" || task.assessment.complexity === "simple"
                ? [
                    {
...
//# sourceMappingURL=basic-planner.js.map