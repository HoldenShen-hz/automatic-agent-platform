...
export function createGrowthRetrieverPlugin() {
    return {
        ...
        async retrieve(query) {
            ...
            const results = [
                {
                    knowledgeRef: `knowledge:growth/playbooks?query=${encodeURIComponent(searchQuery)}`,
                ...
                {
                    knowledgeRef: `knowledge:growth/campaigns?query=${encodeURIComponent(searchQuery)}`,
                ...
                {
                    knowledgeRef: `knowledge:growth/ab_tests?query=${encodeURIComponent(searchQuery)}`,
...
//# sourceMappingURL=growth-retriever.js.map