...
export declare const ReplicationPolicySchema: z.ZodObject<{
    ...
    residencyMode: z.ZodDefault<z.ZodEnum<["same_jurisdiction", "allowed_cross_border", "blocked"]>>;
}, "strip", z.ZodTypeAny, {
    ...
    residencyMode?: "blocked" | "same_jurisdiction" | "allowed_cross_border" | undefined;
}>;
