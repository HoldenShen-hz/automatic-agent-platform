...
export class HumanTakeoverServiceAsync extends EventEmitter {
    ...
    async openSession(input, options) {
        const result = await this.executeWithRetryAndTimeout("openSession", () => this.sync.openSession(input), options?.timeoutMs ?? this.options.defaultTimeoutMs, options?.signal);
     ...
     */
    async modifyInput(input, options) {
        return this.executeWithRetryAndTimeout("modifyInput", () => this.sync.modifyInput(input), options?.timeoutMs ?? this.options.defaultTimeoutMs, options?.signal);
    }
    /**
     ...
     * @returns Promise resolving to the action result
     */
    async switchWorker(input, options) {
        return this.executeWithRetryAndTimeout("switchWorker", () => this.sync.switchWorker(input), options?.timeoutMs ?? this.options.defaultTimeoutMs, options?.signal);
    }
    /**
     ...
     * @returns Promise resolving to the action result
     */
    async retryExecution(input, options) {
        return this.executeWithRetryAndTimeout("retryExecution", () => this.sync.retryExecution(input), options?.timeoutMs ?? this.options.defaultTimeoutMs, options?.signal);
    }
    /**
     ...
     * @returns Promise resolving to the action result
     */
    async setCurrentStep(input, options) {
        return this.executeWithRetryAndTimeout("setCurrentStep", () => this.sync.setCurrentStep(input), options?.timeoutMs ?? this.options.defaultTimeoutMs, options?.signal);
    }
    /**
     ...
     * @returns Promise resolving to the action result
     */
    async writeStepOutput(input, options) {
        return this.executeWithRetryAndTimeout("writeStepOutput", () => this.sync.writeStepOutput(input), options?.timeoutMs ?? this.options.defaultTimeoutMs, options?.signal);
    }
    /**
     ...
     * @returns Promise resolving to the action result
     */
    async skipCurrentStep(input, options) {
        return this.executeWithRetryAndTimeout("skipCurrentStep", () => this.sync.skipCurrentStep(input), options?.timeoutMs ?? this.options.defaultTimeoutMs, options?.signal);
    }
    /**
     ...
     * @returns Promise resolving to the action result
     */
    async completeTask(input, options) {
        const result = await this.executeWithRetryAndTimeout("completeTask", () => this.sync.completeTask(input), options?.timeoutMs ?? this.options.defaultTimeoutMs, options?.signal);
     ...
     * @returns Promise resolving to the action result
     */
    enqueueOperation(operationType, input, options) {
        if (this.disposed) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const operationFn = () => {
                switch (operationType) {
                    case "openSession":
                        return this.sync.openSession(input);
                    case "modifyInput":
                        return this.sync.modifyInput(input);
                    case "switchWorker":
                        return this.sync.switchWorker(input);
                    case "retryExecution":
                        return this.sync.retryExecution(input);
                    case "setCurrentStep":
                        return this.sync.setCurrentStep(input);
                    case "writeStepOutput":
                        return this.sync.writeStepOutput(input);
                    case "skipCurrentStep":
                        return this.sync.skipCurrentStep(input);
                    case "completeTask":
                        return this.sync.completeTask(input);
                    default:
     ...
     */
    async executeWithRetryAndTimeout(operationName, operation, timeoutMs, signal) {
     ...
     */
    async executeOperation(operation, operationId, operationName) {
