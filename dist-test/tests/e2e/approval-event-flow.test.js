...
test("E2E: blocked-for-approval flow emits tier1 events and drains consumer acks", async () => {
    ...
    try {
        ...
        assert.deepEqual([...(seenByConsumer.get("inspect_projection") ?? [])].sort(), ["decision:requested", "task:status_changed"]);
        ...
        assert.deepEqual([...(seenByConsumer.get("inspect_projection") ?? [])].sort(), ["decision:requested", "decision:responded", "task:status_changed"]);
...
//# sourceMappingURL=approval-event-flow.test.js.map