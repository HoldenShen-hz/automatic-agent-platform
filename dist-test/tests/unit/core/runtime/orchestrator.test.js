...
test("MultiStepToolExecutionInput optional fields", () => {
    ...
    const input = {
        ...
        admissionBackpressureSnapshot: () => ({
            ...
            queueGovernance: { delayedCount: 0, rateLimitedCount: 0, backlogSize: 0, dispatchableBacklogSize: 0, claimedBacklogSize: 0, oldestWaitSeconds: 0, nonPriorityBacklogSize: 0, priorityBacklogSize: 0 },
            findings: [],
        }),
    };
