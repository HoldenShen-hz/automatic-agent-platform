...
import { detectDependencyCycle, topologicallySortTaskIds, } from "../../../../../src/interaction/goal-decomposer/dependency-graph/index.js";
...
test("detectDependencyCycle handles self-loop", () => {
    const taskIds = ["a"];
    const edges = [{ fromTask: "a", toTask: "a" }];
    assert.equal(detectDependencyCycle(taskIds, edges), true);
});
