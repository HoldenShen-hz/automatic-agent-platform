...
import { getPlatformAppManifestByKind, listPlatformApps, resolvePlatformAppManifest, } from "../../../src/apps/index.js";
...
test("getPlatformAppManifestByKind throws for unknown kind", () => {
    assert.throws(() => getPlatformAppManifestByKind("unknown"), /^Error: Unknown platform app kind: unknown$/);
});
...
//# sourceMappingURL=index-extended.test.js.map