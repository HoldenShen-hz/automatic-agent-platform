...
function createScope(overrides = {}) {
    ...
    if (overrides.domainId !== undefined) {
        scope.domainId = overrides.domainId;
    }
    if (overrides.permission !== undefined) {
        scope.permission = overrides.permission;
    }
    return scope;
}
...
test("isOperationAllowedByRole allows platform_team all operations", () => {
    const operations = ["domain_onboarding", "modify_approval_rules", "publish_pack",
...
//# sourceMappingURL=scope-manager.test.js.map