...
import { parseFinishReason, canContinueResponse, buildContinuationPrompt, extractContinuationPoint, OutputContinuationService, getGlobalContinuationService, } from "../../../src/platform/execution/execution-engine/output-continuation-service.js";
...
test("extractContinuationPoint returns null for empty input", () => {
    ...
    assert.ok(!extractContinuationPoint("   "));
    assert.ok(!extractContinuationPoint(null));
});
...
//# sourceMappingURL=output-continuation-service.test.js.map