...
import { computeEffectiveActiveLeaseCount, computeWorkerLoadScore, summarizeWorkerLoadSkew, MAX_RECOMMENDED_STICKY_SHARE, } from "../../../src/platform/execution/worker-pool/worker-load-balancing.js";
test("worker load balancing computes effective active leases from the stronger of active leases and running work", () => {
    assert.equal(computeEffectiveActiveLeaseCount({
        workerId: "worker-a",
...
//# sourceMappingURL=worker-load-balancing.test.js.map