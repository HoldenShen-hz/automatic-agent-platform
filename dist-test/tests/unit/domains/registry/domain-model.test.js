...
import { StepTemplateConfigSchema, WorkflowConfigSchema, ToolBundleConfigSchema, OutputContractConfigSchema, DomainCapabilityProfileSchema, PluginBindingSchema, DomainDefinitionSchema, } from "../../../../src/domains/registry/domain-model.js";
...
test("PluginBindingSchema applies defaults", () => {
    const input = { bindingId: "b1", domainId: "d1", pluginType: "retriever", pluginId: "p1" };
    const result = PluginBindingSchema.parse(input);
