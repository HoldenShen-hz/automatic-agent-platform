...
import { PackRegistryService, } from "../../../../src/domains/business-pack/pack-registry-service.js";
function createTestManifest(packId, overrides = {}) {
    return {
        packId,
...
describe("PackRegistryService", () => {
    ...
    describe("registerPack", () => {
        ...
        it("should throw if pack already registered", () => {
            ...
            assert.throws(() => service.registerPack("pack-001", manifest), /already registered/);
        });
    });
    describe("getPack", () => {
    ...
    describe("updatePack", () => {
        ...
        it("should throw if pack not found", () => {
            ...
            assert.throws(() => service.updatePack("nonexistent", manifest), /not found/);
        });
    });
...
//# sourceMappingURL=pack-registry-service.test.js.map