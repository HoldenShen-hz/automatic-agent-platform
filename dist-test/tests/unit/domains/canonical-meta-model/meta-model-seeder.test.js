...
test("seedDomainMetaModels creates multiple models", () => {
    const inputs = [
        { domainId: "domain_a", displayName: "Domain A", ownerOrgNodeId: "org.a", taskTypes: ["task_a"], tags: ["a"], riskLevel: "medium" },
        { domainId: "domain_b", displayName: "Domain B", ownerOrgNodeId: "org.b", taskTypes: ["task_b"], tags: ["b"], riskLevel: "high" },
        { domainId: "domain_c", displayName: "Domain C", ownerOrgNodeId: "org.c", taskTypes: ["task_c"], tags: ["c"], riskLevel: "critical" },
    ];
...
//# sourceMappingURL=meta-model-seeder.test.js.map