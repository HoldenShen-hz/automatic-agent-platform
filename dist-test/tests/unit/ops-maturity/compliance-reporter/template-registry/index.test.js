...
import { ComplianceTemplateRegistryService, findComplianceTemplate, } from "../../../../../src/ops-maturity/compliance-reporter/template-registry/index.js";
const makeTemplate = (id, framework, reportType) => ({
    templateId: id,
    framework,
    reportType,
