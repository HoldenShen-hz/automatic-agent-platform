...
import { ComplianceReportRendererService, ComplianceReportPipelineService, ComplianceTemplateRegistryService, EvidenceMapperService, } from "../../../../src/ops-maturity/compliance-reporter/index.js";
...
test("ComplianceReportPipelineService.generate throws for unknown template", () => {
    ...
    assert.throws(() => service.generate(request), (err) => err.message.includes("compliance_report.template_not_found"));
});
...
test("EvidenceMapperService summarizes coverage ratio", () => {
    ...
    const coverage = service.summarizeCoverage(createEvidence(["access_log", "incident_log"]), ["access_log", "change_record", "incident_log"]);
...
//# sourceMappingURL=compliance-report-pipeline-service.test.js.map