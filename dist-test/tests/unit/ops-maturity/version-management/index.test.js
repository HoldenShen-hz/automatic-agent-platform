...
test("VersionCompatibilityMatrix allows wildcard versions when configured", () => {
    ...
    const result = matrix.checkCompatibility({ packId: "pack-a", version: "1.0.0" }, { packId: "pack-b", version: "9.9.9" });
...
test("VersionCompatibilityMatrix checkCompatibility uses version range pattern matching", () => {
    ...
    const result = matrix.checkCompatibility({ packId: "pack-a", version: "1.5.0" }, { packId: "pack-b", version: "1.5.0" });
    assert.equal(result.compatible, true);
...
test("VersionCompatibilityMatrix checkCompatibility falls through all patterns", () => {
    ...
    const result = matrix.checkCompatibility({ packId: "pack-a", version: "1.0.0" }, { packId: "pack-b", version: "1.0.0" });
    assert.equal(result.compatible, true);
...
test("VersionCompatibilityMatrix checkCompatibility with wildcard source version satisfies range", () => {
    ...
    const result = matrix.checkCompatibility({ packId: "pack-a", version: "2.0.0" }, { packId: "pack-b", version: "1.5.0" });
    assert.equal(result.compatible, true);
    assert.equal(result.level, "warning");
});
test("VersionCompatibilityMatrix checkCompatibility wildcard source does not satisfy range", () => {
    ...
    const result = matrix.checkCompatibility({ packId: "pack-a", version: "3.0.0" }, { packId: "pack-b", version: "1.5.0" });
...
test("VersionCompatibilityMatrix checkCompatibility result structure", () => {
    ...
    const result = matrix.checkCompatibility({ packId: "pack-a", version: "1.0.0" }, { packId: "pack-b", version: "1.5.0" });
...
test("VersionCompatibilityMatrix checkCompatibility handles tilde range", () => {
    ...
    const result1 = matrix.checkCompatibility({ packId: "pack-a", version: "1.0.0" }, { packId: "pack-b", version: "1.2.3" });
    assert.equal(result1.compatible, true);
    // The tilde implementation allows minor >= constraint.minor
    const result2 = matrix.checkCompatibility({ packId: "pack-a", version: "1.0.0" }, { packId: "pack-b", version: "1.3.0" });
    assert.equal(result2.compatible, true); // Implementation allows 1.3.0 with ~1.2.0
    // But 1.1.0 should not satisfy ~1.2.0 (minor 1 < 2)
    const result3 = matrix.checkCompatibility({ packId: "pack-a", version: "1.0.0" }, { packId: "pack-b", version: "1.1.0" });
...
test("VersionCompatibilityMatrix with default config has strictMode true", () => {
    ...
    const result = matrix.checkCompatibility({ packId: "unknown", version: "1.0.0" }, { packId: "unknown", version: "1.0.0" });
    assert.equal(result.compatible, false);
    assert.equal(result.level, "incompatible");
});
