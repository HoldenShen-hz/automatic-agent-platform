...
import { OpsHealthMonitorService, summarizeOpsHealth, findUnhealthyComponents, calculateHealthMetrics, groupProbesByStatus, analyzeLatencyTrends, hasLatencyAnomalies, generateHealthSummary, } from "../../../../../src/ops-maturity/platform-ops-agent/health-monitor/index.js";
// ============================================================================
...
test("OpsHealthProbe accepts all status values", () => {
    const healthy = { component: "c", status: "healthy" };
    const degraded = { component: "c", status: "degraded" };
    const failed = { component: "c", status: "failed" };
...
test("groupProbesByStatus preserves probe objects", () => {
    const probe1 = { component: "comp1", status: "healthy" };
    const probes = [probe1];
    const grouped = groupProbesByStatus(probes);
