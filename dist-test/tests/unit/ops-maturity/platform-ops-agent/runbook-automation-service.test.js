...
import { RunbookAutomationService, } from "../../../../src/ops-maturity/platform-ops-agent/runbook-automation-service.js";
function createRunbook(overrides = {}) {
    return {
        runbookId: "runbook_1",
        name: "Test Runbook",
...
test.describe("RunbookAutomationService", () => {
    test.describe("execute", () => {
        ...
        test("calculates totalDurationMs from step results", () => {
            ...
            const runbook = createRunbook();
            const execution = service.execute(runbook);
            const expectedDuration = execution.stepResults.reduce((sum, r) => sum + r.durationMs, 0);
...
//# sourceMappingURL=runbook-automation-service.test.js.map