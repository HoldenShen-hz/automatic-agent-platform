...
describe("PlatformOpsAgentService - Edge Cases", () => {
    ...
    describe("getProposal", () => {
        test("throws Error with proposal_not_found code for unknown id", () => {
            const service = createService();
            assert.throws(() => service.getProposal("nonexistent_id"), /ops_agent\.proposal_not_found/);
        });
    ...
    describe("recordApproval", () => {
        test("throws when approver is not in requiredApprovals list", () => {
            ...
            assert.throws(() => service.recordApproval(proposal.proposalId, "unauthorized_user"), /ops_agent\.approver_not_allowed/);
        });
...
//# sourceMappingURL=platform-ops-agent-service-edge-cases.test.js.map