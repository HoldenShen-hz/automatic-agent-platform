...
test("simplifyExplanation confidence increases with both factors and links", () => {
    const links = [{ source: "a", target: "b", rationale: "r" }];
...
test("simplifyExplanation whyItMatters shows at most 2 relevant impacts", () => {
    const result = simplifyExplanation("execute", "Task done", ["cost_issue", "time_issue", "quality_issue", "security_issue"], [], "medium");
...
//# sourceMappingURL=simplified-explainer.test.js.map