...
import { simplifyExplanation, formatAsMarkdown, formatAsNotification, } from "../../../../src/ops-maturity/explainability/index.js";
...
describe("SimplifiedExplainer - Edge Cases", () => {
    describe("simplifyExplanation", () => {
        ...
        test("confidence caps at 100 even with many factors and links", () => {
            ...
            const manyLinks = Array(20).fill({ source: "a", target: "b", rationale: "r" });
        ...
        test("whyItMatters maps cost-related factors to business impact", () => {
            const result = simplifyExplanation("execute", "Analysis done", ["cost_over_budget", "resource_usage_high"], [], "medium");
        ...
        test("whyItMatters maps security/compliance factors correctly", () => {
            const result = simplifyExplanation("execute", "Deployment reviewed", ["security_policy_violated", "compliance_check_failed"], [], "high");
        ...
        test("whatHappened includes factor count when > 3 factors", () => {
            const result = simplifyExplanation("execute", "Task done", ["factor1", "factor2", "factor3", "factor4", "factor5"], [], "low");
        ...
        test("jargon replacement replaces multiple technical terms", () => {
            const result = simplifyExplanation("execute", "The workflow timeout caused a deadlock requiring retry with circuit_breaker fallback", [], [], "medium");
        ...
        test("jargon replacement is case-insensitive", () => {
            const result = simplifyExplanation("execute", "WORKFLOW deployment with TIMEOUT latency issues", [], [], "medium");
...
//# sourceMappingURL=simplified-explainer-edge-cases.test.js.map