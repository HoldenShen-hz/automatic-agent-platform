...
import { listOpsMaturityCapabilityBaselines, resolveOpsMaturityCapabilityBaseline, } from "../../../src/ops-maturity/ops-maturity-baseline-catalog.js";
...
test("ops-maturity baseline services resolve from canonical submodule and root exports", () => {
    const rootExports = opsMaturityRoot;
    const submodulesByEntryModule = {
        "src/ops-maturity/agent-lifecycle/index.ts": agentLifecycle,
        "src/ops-maturity/capacity-planner/index.ts": capacityPlanner,
        "src/ops-maturity/compliance-reporter/index.ts": complianceReporter,
        "src/ops-maturity/cost-optimizer/index.ts": costOptimizer,
        "src/ops-maturity/drift-detection/index.ts": driftDetection,
        "src/ops-maturity/edge-runtime/index.ts": edgeRuntime,
        "src/ops-maturity/emergency/index.ts": emergency,
        "src/ops-maturity/explainability/index.ts": explainability,
        "src/ops-maturity/monitoring/index.ts": monitoring,
        "src/ops-maturity/multimodal/index.ts": multimodal,
        "src/ops-maturity/platform-ops-agent/index.ts": platformOpsAgent,
        "src/ops-maturity/workflow-debugger/index.ts": workflowDebugger,
    };
...
//# sourceMappingURL=ops-maturity-baseline-catalog.test.js.map