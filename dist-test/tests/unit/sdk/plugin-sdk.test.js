...
test("definePlugin validates required fields", () => {
    assert.throws(() => definePlugin({ pluginId: "", name: "Test", version: "1.0.0", type: "tool", capabilities: [{ name: "exec", description: "", inputSchema: {}, outputSchema: {} }] }), /Plugin ID is required/);
    assert.throws(() => definePlugin({ pluginId: "  ", name: "Test", version: "1.0.0", type: "tool", capabilities: [{ name: "exec", description: "", inputSchema: {}, outputSchema: {} }] }), /Plugin ID is required/);
    assert.throws(() => definePlugin({ pluginId: "p", name: "", version: "1.0.0", type: "tool", capabilities: [{ name: "exec", description: "", inputSchema: {}, outputSchema: {} }] }), /Plugin name is required/);
    assert.throws(() => definePlugin({ pluginId: "p", name: "Test", version: "", type: "tool", capabilities: [{ name: "exec", description: "", inputSchema: {}, outputSchema: {} }] }), /Plugin version is required/);
    assert.throws(() => definePlugin({ pluginId: "p", name: "Test", version: "1.0.0", type: "tool", capabilities: [] }), /at least one capability/);
});
test("definePlugin validates capability fields", () => {
    ...
    assert.throws(() => definePlugin({
        ...
        version: "1.0.0",
        type: "tool",
        capabilities: [{ name: "exec", description: "desc", inputSchema: undefined, outputSchema: {} }],
    }), /inputSchema/);
    assert.throws(() => definePlugin({
        pluginId: "p",
        name: "Test",
        version: "1.0.0",
        type: "tool",
        capabilities: [{ name: "exec", description: "desc", inputSchema: {}, outputSchema: undefined }],
    }), /outputSchema/);
});
...
test("validatePluginDefinition throws on invalid definition", () => {
    ...
    assert.throws(() => validatePluginDefinition(invalid), /plugin_sdk\.missing_plugin_id/);
});
...
//# sourceMappingURL=plugin-sdk.test.js.map