...
describe("loadDataPlaneCliEnv", () => {
    it("parses analytics, archive, replay, and movement job actions", () => {
    ...
    it("parses summary and export filters", () => {
    ...
    it("rejects unknown actions", () => {
        assert.throws(() => loadDataPlaneCliEnv({
            ...
            AA_DB_PATH: "/tmp/test.db",
        }), (error) => error instanceof ValidationError && error.code === "invalid_env:AA_DATA_PLANE_ACTION");
    });
});
