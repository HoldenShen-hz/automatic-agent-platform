...
import { loadControlPlaneBalancerCliEnv } from "../../../../src/platform/control-plane/config-center/remaining-cli-env-loaders.js";
describe("loadControlPlaneBalancerCliEnv", () => {
    it("parses heartbeat action", () => {
    ...
    it("parses heartbeat with optional parameters", () => {
        const config = loadControlPlaneBalancerCliEnv({
            AA_CONTROL_PLANE_ACTION: "heartbeat",
            AA_DB_PATH: "/tmp/test.db",
    ...
    it("parses select with request_key", () => {
        const config = loadControlPlaneBalancerCliEnv({
            AA_CONTROL_PLANE_ACTION: "select",
            AA_DB_PATH: "/tmp/test.db",
    ...
    it("parses summary action (default)", () => {
        const config = loadControlPlaneBalancerCliEnv({
    ...
    it("parses queue_affinity parameter", () => {
        const config = loadControlPlaneBalancerCliEnv({
            AA_CONTROL_PLANE_ACTION: "heartbeat",
            AA_DB_PATH: "/tmp/test.db",
...
//# sourceMappingURL=control-plane-balancer.test.js.map