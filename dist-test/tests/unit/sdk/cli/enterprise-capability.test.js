...
describe("loadEnterpriseCapabilityCliEnv", () => {
    it("parses readiness registration and list actions", () => {
    ...
    it("defaults to summary and rejects unknown actions", () => {
        ...
        assert.throws(() => loadEnterpriseCapabilityCliEnv({
            AA_ENTERPRISE_ACTION: "unknown_action",
            AA_DB_PATH: "/tmp/test.db",
        }), (error) => error instanceof ValidationError && error.code === "invalid_env:AA_ENTERPRISE_ACTION");
    });
});
//# sourceMappingURL=enterprise-capability.test.js.map