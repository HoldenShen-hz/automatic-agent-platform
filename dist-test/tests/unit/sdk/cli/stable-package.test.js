...
test("loadStablePackageCliEnv throws on invalid targetStatus", () => {
    assert.throws(() => loadStablePackageCliEnv({ AA_STABLE_PACKAGE_TARGET_STATUS: "invalid" }), /stable\.invalid_gate_target_status/);
});
// ---------------------------------------------------------------------------
