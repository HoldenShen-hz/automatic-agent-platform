...
describe("loadEnvironmentDeploymentCliEnv", () => {
    it("parses current deployment env names", () => {
    ...
    it("uses current defaults and still requires db path for build", () => {
        ...
        assert.throws(() => loadEnvironmentDeploymentCliEnv({
            AA_DEPLOYMENT_ACTION: "build",
        }), (error) => error instanceof ValidationError && error.code === "missing_env:AA_DB_PATH");
    });
});
//# sourceMappingURL=environment-deployment.test.js.map