...
test("registration policy uses default challengeTtlMs when not configured", () => {
    const registration = { challengeTtlMs: undefined };
    const challengeTtlMs = typeof registration.challengeTtlMs === "number" && Number.isFinite(registration.challengeTtlMs)
...
test("registration policy uses default allowedCapabilities when not configured", () => {
    const registration = { allowedCapabilities: undefined };
...
//# sourceMappingURL=worker-register.test.js.map