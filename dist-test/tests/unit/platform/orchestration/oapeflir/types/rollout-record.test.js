...
import { RolloutLevelSchema, RolloutStatusSchema, RolloutRecordSchema, parseRolloutRecord, } from "../../../../../../src/platform/orchestration/oapeflir/types/rollout-record.js";
...
test("RolloutStatusSchema accepts valid statuses", () => {
    const statuses = ["draft", "pending_approval", "shadow", "canary_5", "partial_25", "partial_50", "partial_75", "stable", "rejected", "rolled_back", "paused"];
...
//# sourceMappingURL=rollout-record.test.js.map