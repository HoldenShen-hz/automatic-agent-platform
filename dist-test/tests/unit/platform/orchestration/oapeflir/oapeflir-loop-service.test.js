...
class DeterministicExecuteBridge {
    executionCount = 0;
...
test("OapeflirLoopService records execute errors when execute bridge fails", async () => {
    ...
    class FailingExecuteBridge extends DeterministicExecuteBridge {
        async executePlan(_plan, _context) {
    ...
    assert.ok(runtimeMetricsRegistry
...
//# sourceMappingURL=oapeflir-loop-service.test.js.map