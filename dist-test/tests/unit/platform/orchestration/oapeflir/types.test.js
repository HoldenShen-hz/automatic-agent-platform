...
import { DualChannelStepOutputSchema, FeedbackSignalSchema, ImprovementCandidateSchema, PlanSchema, RolloutRecordSchema, TaskSituationSchema, UnifiedAssessmentSchema, } from "../../../../../src/platform/orchestration/oapeflir/types/index.js";
...
test("UnifiedAssessmentSchema accepts all execution modes", () => {
    for (const mode of ["auto", "supervised", "manual"]) {
        assert.doesNotThrow(() => UnifiedAssessmentSchema.parse({
            taskId: "task_mode",
            timestamp: 1,
