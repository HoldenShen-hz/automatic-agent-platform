...
import { CitationBuilder, FreshnessTracker, KnowledgeAccessControl, SourceTrustPolicyRegistry, } from "../../../../../src/platform/state-evidence/knowledge/index.js";
...
test("CitationBuilder.buildMany deduplicates citations", () => {
    const citations = new CitationBuilder();
    const hits = [
        { chunkId: "chunk_1", documentId: "doc_1", score: 1, matchType: "keyword", snippet: "test", namespace: "ns", knowledgeRef: "knowledge:chunk_1" },
        { chunkId: "chunk_1", documentId: "doc_1", score: 1, matchType: "semantic", snippet: "test", namespace: "ns", knowledgeRef: "knowledge:chunk_1" },
        { chunkId: "chunk_2", documentId: "doc_1", score: 0.9, matchType: "keyword", snippet: "test2", namespace: "ns", knowledgeRef: "knowledge:chunk_2" },
    ];
...
//# sourceMappingURL=knowledge-governance.test.js.map