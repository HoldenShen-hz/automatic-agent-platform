...
function createTestSource(freshnessTimestamp, trustLevel = "verified") {
    return {
...
function createTestNamespace(maxAgeDays, staleAction) {
    return {
        namespaceId: "ns_test",
        path: "/test",
...
//# sourceMappingURL=freshness-tracker.test.js.map