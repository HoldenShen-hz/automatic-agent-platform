...
import { AuthoritativeTaskStoreRuntimeLifecycleRepository, ObservedRuntimeLifecycleRepository, RetryingRuntimeLifecycleRepository, } from "../../../../../src/platform/state-evidence/truth/repositories/runtime-lifecycle-repository.js";
...
test("authoritative runtime lifecycle repository delegates task status updates to the store", () => {
    ...
    repository.updateTaskStatus("task-1", "failed", "2026-04-11T00:00:00.000Z", "task.failed", "2026-04-11T00:01:00.000Z");
...
test("retrying runtime lifecycle repository retries SQLITE_BUSY operations", () => {
    let attempts = 0;
    const repository = new RetryingRuntimeLifecycleRepository(createRepositoryStub({
        updateTaskStatus() {
            attempts += 1;
            if (attempts === 1) {
...
test("observed runtime lifecycle repository records successful operations", () => {
    ...
    const repository = new ObservedRuntimeLifecycleRepository(createRepositoryStub({
...
//# sourceMappingURL=runtime-lifecycle-repository.test.js.map