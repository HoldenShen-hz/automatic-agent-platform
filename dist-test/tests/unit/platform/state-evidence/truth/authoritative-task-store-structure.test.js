...
const LEGACY_COMPAT_PATH = join(process.cwd(), "src", "platform", "state-evidence", "truth", "sqlite", "authoritative-task-store-legacy-compat.ts");
const DELEGATING_CORE_PATH = join(process.cwd(), "src", "platform", "state-evidence", "truth", "sqlite", "authoritative-task-store-delegating-core.ts");
const DELEGATING_BASE_PATH = join(process.cwd(), "src", "platform", "state-evidence", "truth", "sqlite", "authoritative-task-store-delegating-base.ts");
...
const LEGACY_ADAPTER_PATH = join(process.cwd(), "src", "platform", "state-evidence", "truth", "sqlite", "repositories", "legacy-authoritative-task-store-adapter.ts");
