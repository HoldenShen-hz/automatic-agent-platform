...
import { STABLE_PROMPT_INJECTION_RED_TEAM_CASES, runStablePromptInjectionRedTeam, } from "../../../../../src/platform/shared/stability/stable-prompt-injection-red-team.js";
...
test("stable prompt injection red-team suite covers the expected adversarial and control cases", async () => {
    ...
    try {
        ...
        assert.ok(report.scenarios.some((scenario) => scenario.scenarioId === "credential_harvest_bearer_token" &&
