...
import { runStableMigrationCompatibilityRehearsal, writeStableMigrationCompatibilityRehearsalReport, } from "../../../../../src/platform/shared/stability/stable-migration-compatibility-rehearsal.js";
...
test("migration_plan_passes_pg_portability_rules scenario exists and has valid structure", async () => {
    ...
    try {
        const report = await runStableMigrationCompatibilityRehearsal({ outputDir });
        const scenario = report.scenarios.find((s) => s.scenarioId === "migration_plan_passes_pg_portability_rules");
        if (!scenario) {
...
test("sqlite_migration_bootstrap_reaches_latest_schema scenario exists and has valid structure", async () => {
    ...
    try {
        const report = await runStableMigrationCompatibilityRehearsal({ outputDir });
        const scenario = report.scenarios.find((s) => s.scenarioId === "sqlite_migration_bootstrap_reaches_latest_schema");
        if (!scenario) {
...
//# sourceMappingURL=stable-migration-compatibility-rehearsal.test.js.map