...
test("metrics service calculates approval metrics with only pending approvals", () => {
    ...
    try {
        ...
        db.connection.prepare(`UPDATE tasks SET status = ?, updated_at = ? WHERE id = ?`).run("awaiting_decision", "2026-04-06T08:00:00.000Z", "task-pending");
...
//# sourceMappingURL=metrics-service-branches.test.js.map