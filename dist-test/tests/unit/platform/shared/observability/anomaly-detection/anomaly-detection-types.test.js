...
test("TimeSeriesPoint with zero value", () => {
    const point = { timestamp: "2026-04-23T00:00:00.000Z", value: 0 };
    assert.equal(point.value, 0);
});
test("TimeSeriesPoint with negative value", () => {
    const point = { timestamp: "2026-04-23T00:00:00.000Z", value: -100 };
    assert.equal(point.value, -100);
});
test("TimeSeriesPoint with large positive value", () => {
    const point = { timestamp: "2026-04-23T00:00:00.000Z", value: 1e15 };
    assert.equal(point.value, 1e15);
});
test("TimeSeriesPoint with floating point value", () => {
    const point = { timestamp: "2026-04-23T00:00:00.000Z", value: 0.000001 };
...
//# sourceMappingURL=anomaly-detection-types.test.js.map