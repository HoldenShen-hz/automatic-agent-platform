...
test("TaskSituationBuilder defaults derived fields from file refs and runtime context", () => {
    ...
    assert.deepEqual(situation.codebaseSnapshot.relevantFiles.map((file) => file.path), ["src/index.ts", "README.md"]);
...
//# sourceMappingURL=task-situation-services.test.js.map