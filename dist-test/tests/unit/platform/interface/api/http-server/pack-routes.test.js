...
function createMockContext(pathname = "/v1/packs", segments = [], body = null) {
    return {
...
test("POST /v1/packs creates a pack and GET /v1/packs returns it", async () => {
    ...
    const createResponse = await callRoute(routes, createMockContext("/v1/packs", ["v1", "packs"], JSON.stringify({
        packId: "pack.finance",
        name: "Finance Pack",
        version: "1.0.0",
        domainId: "finance",
...
//# sourceMappingURL=pack-routes.test.js.map