...
import { validateApprovalDecision, } from "../../../../src/platform/control-plane/approval-center/index.js";
import { VoteType, createInitialQuorumStatus, calculateQuorumStatus, isQuorumMet, isDenied, } from "../../../../src/platform/control-plane/approval-center/index.js";
import { EscalationManager, NotificationChannelType, NotificationPriority, DelegationStatus, EscalationReason, } from "../../../../src/platform/control-plane/approval-center/index.js";
import { ApprovalFlowEngine, FlowType, FlowStatus, } from "../../../../src/platform/control-plane/approval-center/index.js";
// ============================================================================
...
test("validateApprovalDecision throws for option_selected without selectedOptionId", () => {
    ...
    assert.throws(() => validateApprovalDecision(decision), (err) => err.code === "approval.invalid_option_selected");
});
test("validateApprovalDecision throws for confirmed without confirmed=true", () => {
    ...
    assert.throws(() => validateApprovalDecision(decision), (err) => err.code === "approval.invalid_confirmed");
});
test("validateApprovalDecision throws for text_input without inputText", () => {
    ...
    assert.throws(() => validateApprovalDecision(decision), (err) => err.code === "approval.invalid_text_input");
});
test("validateApprovalDecision throws for terminal decision with extra fields", () => {
    ...
    assert.throws(() => validateApprovalDecision(decision), (err) => err.code === "approval.invalid_terminal_payload");
});
// ============================================================================
...
test("EscalationManager via barrel export - createDelegation throws on self-delegation", () => {
    const manager = new EscalationManager();
    assert.throws(() => manager.createDelegation("user1", "user1", "approval_123"), /Cannot delegate to yourself/);
});
...
test("ApprovalFlowEngine via barrel export - createMultiPartyFlow", () => {
    const engine = new ApprovalFlowEngine();
    const request = createMockApprovalRequest();
    const flow = engine.createMultiPartyFlow(request, 2, [
...
//# sourceMappingURL=approval-center.test.js.map