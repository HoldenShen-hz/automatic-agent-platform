...
import { ApprovalPolicyEngine, PolicyVersionManager, DEFAULT_APPROVAL_POLICY_BUNDLE, } from "../../../../../../src/platform/control-plane/approval-center/approval-policy-engine/index.js";
...
test("PolicyVersionManager prevents non-draft updates", () => {
    const manager = new PolicyVersionManager(DEFAULT_APPROVAL_POLICY_BUNDLE);
    const active = manager.getActiveBundle("default-approval-policies");
    assert.throws(() => manager.updateDraft(active, "user-1"), /Cannot update non-draft/);
});
