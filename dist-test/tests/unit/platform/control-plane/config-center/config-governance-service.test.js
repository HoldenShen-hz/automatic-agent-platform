...
test("config governance service diffs bundles and enforces prod restrictions", () => {
    ...
    try {
        ...
        createFile(join(configRoot, "security/default.json"), JSON.stringify({ approvalMode: "supervised", sandboxMode: "restricted_exec", allowDestructiveActions: true }, null, 2));
