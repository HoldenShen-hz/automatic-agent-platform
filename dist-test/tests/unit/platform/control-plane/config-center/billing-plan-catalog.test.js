...
import { DEFAULT_BILLING_PLAN_CATALOG, loadBillingPlanCatalog, } from "../../../../../src/platform/control-plane/config-center/billing-plan-catalog.js";
...
test("billing plan catalog rejects malformed quota definitions", () => {
    ...
    try {
        ...
        assert.throws(() => loadBillingPlanCatalog({
            configRoot,
            sandboxPolicy: createWorkspaceWritePolicy(configRoot),
        }), /limit_value_invalid/);
    }
...
//# sourceMappingURL=billing-plan-catalog.test.js.map