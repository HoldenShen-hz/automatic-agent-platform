...
import { ConfigRolloutService, RolloutPhase, DEFAULT_ROLLOUT_STAGES, } from "../../../../src/platform/control-plane/config-center/config-rollout-service.js";
test("DEFAULT_ROLLOUT_STAGES CANARY_5 has minDurationMs of 1800000 (30 minutes)", () => {
    ...
    assert.strictEqual(canary5Stage.minDurationMs, 1800000, "CANARY_5 minDurationMs should be 1800000 (30 minutes per §24 spec)");
});
...
//# sourceMappingURL=config-rollout-service.test.js.map