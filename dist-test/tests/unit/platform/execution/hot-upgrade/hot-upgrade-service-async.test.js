        ...
        async updateUpgradePlanStatus(planId, status, updatedFields) {
            ...
            if (plan) {
                ...
                if (updatedFields?.startedAt !== undefined)
                    plan.startedAt = updatedFields.startedAt;
                if (updatedFields?.completedAt !== undefined)
                    plan.completedAt = updatedFields.completedAt;
                if (updatedFields?.rollbackTriggeredAt !== undefined)
                    plan.rollbackTriggeredAt = updatedFields.rollbackTriggeredAt;
                if (updatedFields?.rollbackReason !== undefined)
                    plan.rollbackReason = updatedFields.rollbackReason;
            }
        },
...
//# sourceMappingURL=hot-upgrade-service-async.test.js.map