...
import { sanitizeMcpToolCallResult, validateMcpToolDefinition, validateMcpToolRuntime, } from "../../../../../src/platform/execution/tool-executor/mcp-tool-guard.js";
const MCP_METADATA = {
...
test("mcp tool guard requires explicit metadata and approval for mutable tools", () => {
    ...
    assert.equal(validateMcpToolRuntime("mcp_github_create_issue", mutableMetadata)?.code, "approval_mode_invalid");
});
...
//# sourceMappingURL=mcp-tool-guard.test.js.map