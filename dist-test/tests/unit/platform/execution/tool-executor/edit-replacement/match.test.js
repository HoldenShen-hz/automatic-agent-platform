...
import { matchExact, matchNormalizedWindows, matchFuzzyWindows, matchAnchoredFuzzy, toExactOutcome, findAllOccurrences, buildCandidateWindows, dedupeWindows, computeLineOffsets, offsetToLineColumn, } from "../../../../../../src/platform/execution/tool-executor/edit-replacement/match.js";
...
test("toExactOutcome returns matched for single candidate", () => {
    const candidate = { startOffset: 0, endOffset: 5, text: "hello" };
