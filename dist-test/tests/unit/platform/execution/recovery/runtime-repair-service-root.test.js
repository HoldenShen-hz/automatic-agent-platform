...
function createMockStore(overrides = {}) {
    return {
        dispatch: {
            getExecution: (id) => overrides.executions?.find((e) => e.id === id) ?? null,
            getSession: (id) => overrides.sessions?.find((s) => s.id === id) ?? null,
        },
        task: {
...
//# sourceMappingURL=runtime-repair-service-root.test.js.map