...
import { DEFAULT_LEASE_TTL_MS, MIN_LEASE_TTL_MS, MAX_LEASE_TTL_MS, DEFAULT_RENEWAL_INTERVAL_MS, } from "../../../../../src/platform/execution/lease/types.js";
// ---------------------------------------------------------------------------
// Constants
// ---------------------------------------------------------------------------
test("DEFAULT_LEASE_TTL_MS is 10 seconds", () => {
    assert.equal(DEFAULT_LEASE_TTL_MS, 10_000);
});
test("MIN_LEASE_TTL_MS is 5 seconds", () => {
    assert.equal(MIN_LEASE_TTL_MS, 5_000);
});
test("MAX_LEASE_TTL_MS is 30 seconds", () => {
    assert.equal(MAX_LEASE_TTL_MS, 30_000);
});
test("DEFAULT_RENEWAL_INTERVAL_MS is 3 seconds", () => {
