...
import { EffectBuffer, EffectScope, EffectBuilder, globalEffectBuffer, } from "../../../../../src/platform/execution/execution-engine/effect-buffer.js";
...
test("EffectScope constructor sets options correctly", () => {
    ...
    scope.addEffect(EffectBuilder.create("event_publish", "Test")
        .withExecute(async () => { })
        .build());
...
test("EffectScope addEffect adds effect to scope", () => {
    ...
    scope.addEffect(EffectBuilder.create("metric_record", "Test metric")
        .withExecute(async () => { })
        .build());
    assert.equal(scope.getEffectCount(), 1);
});
...
test("EffectScope executeEffects executes in priority order", async () => {
    ...
    scope.addEffect(EffectBuilder.create("event_publish", "low priority")
        .withPriority("low")
        .withExecute(async () => {
        executionOrder.push("low");
    })
        .build());
    scope.addEffect(EffectBuilder.create("event_publish", "critical priority")
        .withPriority("critical")
        .withExecute(async () => {
        executionOrder.push("critical");
    })
        .build());
    scope.addEffect(EffectBuilder.create("event_publish", "normal priority")
        .withPriority("normal")
        .withExecute(async () => {
...
test("EffectScope executeEffects returns proper result", async () => {
    const scope = new EffectScope({ scopeId: "test_scope" });
    scope.addEffect(EffectBuilder.create("event_publish", "Test effect")
        .withExecute(async () => { })
        .build());
    scope.commit();
...
test("EffectScope executeEffects handles failures", async () => {
    const scope = new EffectScope({ scopeId: "test_scope" });
    scope.addEffect(EffectBuilder.create("event_publish", "Failing effect")
        .withExecute(async () => {
...
test("EffectBuffer flush executes all committed scopes", async () => {
    const buffer = new EffectBuffer();
    const scope1 = buffer.createScope({ scopeId: "scope1" });
    scope1.addEffect(EffectBuilder.create("event_publish", "Test1")
        .withExecute(async () => { })
        .build());
    scope1.commit();
    const scope2 = buffer.createScope({ scopeId: "scope2" });
    scope2.addEffect(EffectBuilder.create("event_publish", "Test2")
        .withExecute(async () => { })
        .build());
    scope2.commit();
...
//# sourceMappingURL=effect-buffer.test.js.map