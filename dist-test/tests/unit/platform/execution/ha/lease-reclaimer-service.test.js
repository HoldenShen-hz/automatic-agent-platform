...
import { LeaseReclaimerService, createLeaseReclaimerService, } from "../../../../../src/platform/execution/ha/lease-reclaimer-service.js";
...
function createMockCoordinator() {
    ...
    return {
        ...
        updateNodeHeartbeat(nodeId, _status) {
...
// ─────────────────────────────────────────────────────────────────────────────
function createReclaimer(coordinator, options = {}) {
...
test("LeaseReclaimerService - reclaimOnce() triggers failover for leader lease", async () => {
    ...
    coordinator.triggerFailover = (cause) => {
...
test("LeaseReclaimerService - reclaimOnce() calls onLeaseReclaimed callback", async () => {
    ...
    let reclaimedLease = null;
    let reclaimedNode = null;
    const service = createReclaimer(coordinator, {
        config: { reclaimIntervalMs: 10_000, gracePeriodMs: 2_000, autoFailover: true },
...
//# sourceMappingURL=lease-reclaimer-service.test.js.map