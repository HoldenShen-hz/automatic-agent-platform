...
function createMockWorkerStore() {
    const snapshots = new Map();
    return {
        snapshots,
        upsertCoordinatorInstanceSnapshot(record) {
...
function createCoordinatorRecord(overrides = {}) {
    return {
...
test("CoordinatorLoadBalancingService - registerHeartbeat normalizes shards", () => {
    ...
    const shards = JSON.parse(record.shardJson);
