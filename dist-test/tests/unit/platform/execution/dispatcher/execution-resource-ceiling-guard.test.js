...
test("ExecutionResourceCeilingGuard constructor applies defaults for invalid values", () => {
    const guard = new ExecutionResourceCeilingGuard({ maxToolCalls: -1, maxMemoryMb: 0, maxElapsedMs: NaN });
    const sampleAtLimit = {
        executionId: "exec-1",
        taskId: "task-1",
        agentId: "agent-1",
...
//# sourceMappingURL=execution-resource-ceiling-guard.test.js.map