...
import { ANOMALY_EVENT_CLASSES, UNIFIED_SEVERITIES, alertSeverityToUnifiedSeverity, classifyAnomalyEvent, createControlDirective, createExecutionPlan, createExecutionReceipt, createPlatformPrincipal, createRequestEnvelope, createStateCommand, newId, nowIso, TASK_STATUSES, WORKFLOW_STATUSES, } from "../../../../../src/platform/contracts/types/index.js";
...
test("types barrel exports anomaly classification and unified severity helpers", () => {
    ...
    assert.equal(classifyAnomalyEvent({
