...
import { buildPlatformArchitectureBootstrapSummary, getPlatformArchitectureServices, listPlatformAppsByKind, listPlatformLayerManifests, } from "../../src/platform-architecture-bootstrap.js";
...
test("platform architecture bootstrap exposes the canonical seven-layer system plus cross-layer surfaces", () => {
    ...
    assert.deepEqual(layers.map((layer) => layer.layerId), ["platform", "domains", "interaction", "org-governance", "scale-ecosystem", "ops-maturity", "plugins", "sdk", "apps"]);
...
//# sourceMappingURL=platform-architecture-bootstrap.test.js.map