...
import { SlaOperationsService, } from "../../../../src/scale-ecosystem/sla-engine/index.js";
...
function createTestTier(overrides = {}) {
    return {
...
test("detectSlaBreach returns empty array when within commitment", () => {
    const observation = { latencyMs: 400, successRate: 1.0, queueWaitMs: 1500 };
    const commitment = { maxLatencyMs: 500, minSuccessRate: 0.99, maxQueueWaitMs: 2000 };
...
test("detectSlaBreach detects all three breach types", () => {
    const observation = { latencyMs: 600, successRate: 0.95, queueWaitMs: 2500 };
    const commitment = { maxLatencyMs: 500, minSuccessRate: 0.99, maxQueueWaitMs: 2000 };
    const breaches = detectSlaBreach(observation, commitment);
...
//# sourceMappingURL=sla-operations-service.test.js.map