...
test("integration: scale-ops mainline composes routing, connectors, feedback, ops, panic, explainability, debugging, compliance, and multimodal flow", async () => {
    ...
    try {
        ...
        const approvedCandidate = feedback.review(feedbackIngest.candidates[0].candidateId, "ops_reviewer", "approved", {
        ...
        const comparison = debuggerService.buildComparisonReport("workflow_scale_ops_mainline", workflowFrames, [
            workflowFrames[0],
            {
                workflowId: "workflow_scale_ops_mainline",
                stepId: "explain",
        ...
        const accessReceipt = compliancePipeline.recordReadAccess(complianceReport, "ops_auditor", "2026-04-22T08:15:30.000Z");
...
//# sourceMappingURL=scale-ops-mainline-integration.test.js.map