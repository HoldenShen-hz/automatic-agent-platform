...
test("integration: debugger registers and lists breakpoints", () => {
    ...
    service.registerBreakpoint({ actorId: "dev_1", canDebugProduction: false }, "dev", {
        breakpointId: "bp_001",
...
test("integration: debugger rejects production breakpoint without permission", () => {
    const service = new WorkflowDebuggerService();
    assert.throws(() => service.registerBreakpoint({ actorId: "dev_1", canDebugProduction: false }, "prod", {
...
test("integration: debugger evaluates trace and identifies breakpoint hits", () => {
    const service = new WorkflowDebuggerService();
    service.registerBreakpoint({ actorId: "sre_1", canDebugProduction: true }, "prod", {
...
test("integration: empty trace returns empty results", () => {
    const service = new WorkflowDebuggerService();
    service.registerBreakpoint({ actorId: "tester", canDebugProduction: false }, "dev", {
