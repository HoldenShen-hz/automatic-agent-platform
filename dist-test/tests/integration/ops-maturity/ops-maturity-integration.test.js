...
test("EdgeRuntimeSyncService executes offline tasks and builds sync envelopes", () => {
    ...
    const models = [
        { modelId: "model_local_001", modalities: ["text", "code"], priority: 1 },
        { modelId: "model_local_002", modalities: ["text"], priority: 2 },
    ];
...
test("EdgeRuntimeSyncService rejects restricted data when policy denies", () => {
    ...
    const envelopes = [
        { envelopeId: "env_001", recordId: "edge_node_002:task_001:2026-04-23T00:00:00.000Z", edgeNodeId: "edge_node_002", priority: 1, dataClassification: "restricted", payloadDigest: "digest_r_001", createdAt: "2026-04-23T00:00:00.000Z" },
        { envelopeId: "env_002", recordId: "edge_node_002:task_002:2026-04-23T01:00:00.000Z", edgeNodeId: "edge_node_002", priority: 2, dataClassification: "internal", payloadDigest: "digest_i_001", createdAt: "2026-04-23T01:00:00.000Z" },
    ];
    const cloudDigests = {};
...
test("EdgeRuntimeSyncService merges when cloud digest differs from edge digest", () => {
    ...
    const envelopes = [
        { envelopeId: "env_101", recordId: "edge_node_003:task_101:2026-04-23T00:00:00.000Z", edgeNodeId: "edge_node_003", priority: 1, dataClassification: "internal", payloadDigest: "edge_digest_v2", createdAt: "2026-04-23T00:00:00.000Z" },
    ];
...
test("selectEdgeLocalModel selects highest priority model for modality", () => {
    const models = [
        { modelId: "model_text_v1", modalities: ["text", "code"], priority: 1 },
        { modelId: "model_text_v2", modalities: ["text"], priority: 3 },
        { modelId: "model_image_v1", modalities: ["image"], priority: 2 },
    ];
...
test("orderEdgeSyncQueue orders envelopes by priority ascending", () => {
    ...
    assert.deepEqual(ordered.map((item) => item.envelopeId), ["env_high", "env_med", "env_low"]);
});
...
//# sourceMappingURL=ops-maturity-integration.test.js.map