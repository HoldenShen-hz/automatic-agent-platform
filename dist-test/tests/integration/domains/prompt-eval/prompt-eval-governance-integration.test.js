...
function createEvalContext(prefix) {
...
test.skip("Prompt governance: proposes and activates release", () => {
    ...
    try {
        ...
        const release = governance.proposeRelease({ libraryId: "lib_001", domainId: "coding", prompts: [] }, {
...
test.skip("Prompt governance: activates and deactivates release", () => {
    ...
    try {
        ...
        const release = governance.proposeRelease(library, {
...
test.skip("Prompt governance with registry: builds capability for domain with prompt library", () => {
    ...
    try {
        ...
        const governance = new DomainPromptGovernanceService();
        const release = governance.proposeRelease({ libraryId: "lib_prompt_cap", domainId: "prompt_cap", prompts: [] }, {
...
//# sourceMappingURL=prompt-eval-governance-integration.test.js.map