    ...
    try {
        ...
        db.connection
          ...
          error_code, created_at, updated_at, completed_at
            ...
            .run(taskId, null, taskId, "general_ops", null, "Idempotent test", "queued", "user", "normal", "{}", null, null, null, 0, null, now, now, null);
        // Second migration - should be no-op
        db.migrate();
        const secondMigrations = db.listAppliedMigrations();
        // Migration count should be identical
        assert.equal(secondMigrations.length, firstMigrations.length, "Running migrate twice should not apply additional migrations");
    ...
    try {
        ...
        db.connection
          ...
          error_code, created_at, updated_at, completed_at
            ...
            .run(taskId, null, taskId, "general_ops", null, "Survivor test", "in_progress", "user", "high", '{"priority": "high"}', '{"priority": "high"}', null, 0.05, 0.02, null, now, now, null);
        // Update the task
        db.connection
    ...
    try {
        ...
        db.connection
          ...
          error_code, created_at, updated_at, completed_at
            ...
            .run(taskId, null, taskId, "general_ops", null, "Sequential test", "queued", "user", "normal", "{}", null, null, null, 0, null, now, now, null);
...
test("migration: schema version tracking is consistent", () => {
    ...
    try {
        ...
        assert.deepEqual(versionsAfterSecond, versionsAfterFirst, "Migration versions should be identical after re-run");
...
//# sourceMappingURL=rollback-migration.test.js.map