    ...
    try {
        ...
        db.connection
          ...
          error_code, created_at, updated_at, completed_at
            ...
            .run(taskId, null, taskId, "general_ops", null, "Migration upgrade test", "in_progress", "user", "normal", "{}", null, null, null, 0, null, now, now, null);
    ...
    try {
        ...
        db.connection
          ...
          error_code, created_at, updated_at, completed_at
            ...
            .run(taskId, null, taskId, "general_ops", null, "New columns test", "queued", "user", "normal", "{}", null, null, null, 0, null, now, now, null);
    ...
    try {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            error_code, created_at, updated_at, completed_at
                ...
                .run(taskId, null, taskId, "general_ops", null, `Index test ${i}`, "queued", "user", "normal", "{}", null, null, null, 0, null, now, now, null);
        }
    ...
    try {
        ...
        db.connection
          ...
          error_code, created_at, updated_at, completed_at
            ...
            .run(taskId, null, taskId, "general_ops", null, "Event upgrade test", "in_progress", "user", "normal", "{}", null, null, null, 0, null, now, now, null);
        // Insert an event referencing the task
        const eventId = newId("evt");
        db.connection
            .prepare(`INSERT INTO events (id, task_id, execution_id, event_type, event_tier, payload_json, trace_id, created_at)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?)`)
            .run(eventId, taskId, null, "task.started", "tier_1", "{}", "trace-upgrade", now);
        // Re-run migrations
        db.migrate();
...
//# sourceMappingURL=upgrade-migration.test.js.map