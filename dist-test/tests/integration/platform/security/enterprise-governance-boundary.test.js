...
function createService(workspace) {
    ...
    return {
        ...
        manifestPath,
        lockfilePath,
        serviceFactory: (outsideRoot) => new EnterpriseGovernanceService(governance, store, {
...
test("enterprise governance export fail-closes when artifact root is outside the allowed workspace", () => {
    ...
    try {
        ...
        assert.throws(() => service.exportReport({
            environment: "prod",
            taskId,
...
//# sourceMappingURL=enterprise-governance-boundary.test.js.map