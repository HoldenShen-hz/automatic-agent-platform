...
function createService(workspace) {
    ...
    return { db, taskId, serviceFactory: (outsideRoot) => new OperationsGovernanceService(db, metricsService, doctor, diagnostics, {
...
//# sourceMappingURL=ops-governance-boundary.test.js.map