...
import { checkSandboxPath, } from "../../../../src/platform/control-plane/iam/sandbox-policy.js";
test("security: basic ../ path traversal is blocked", () => {
    ...
    assert.ok(result.reasonCode?.includes("traversal") || result.reasonCode?.includes("denied"), `Reason code should indicate traversal: ${result.reasonCode}`);
});
// TODO: fix - checkSandboxPath with realpathEnforced:true may not properly decode
...
//# sourceMappingURL=path-traversal-advanced.test.js.map