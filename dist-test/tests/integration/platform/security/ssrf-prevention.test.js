...
test("security: AWS metadata endpoint (169.254.169.254) is blocked", () => {
    ...
    assert.ok(result.reasonCode?.toLowerCase().includes("internal") || result.reasonCode?.toLowerCase().includes("blocked"), `Reason code should indicate internal network block: ${result.reasonCode}`);
});
...
//# sourceMappingURL=ssrf-prevention.test.js.map