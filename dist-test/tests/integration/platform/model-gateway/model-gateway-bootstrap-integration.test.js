...
import { listModelGatewayCapabilityBaselines, resolveModelGatewayCapabilityBaseline, MODEL_GATEWAY_CAPABILITY_BASELINES, } from "../../../../src/platform/model-gateway/model-gateway-baseline.js";
import { buildModelGatewayBootstrap, registerModelGatewayBootstrap, MODEL_GATEWAY_CATALOG_SERVICE_ID, MODEL_GATEWAY_BOOTSTRAP_SERVICE_ID, } from "../../../../src/platform/model-gateway/model-gateway-bootstrap.js";
...
test("ModelGatewayBaseline: resolveModelGatewayCapabilityBaseline throws for unknown capability", () => {
    assert.throws(() => resolveModelGatewayCapabilityBaseline("unknown-capability"), /model_gateway_capability.not_found/);
});
...
//# sourceMappingURL=model-gateway-bootstrap-integration.test.js.map