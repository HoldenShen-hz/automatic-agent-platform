...
test("DegradationController: setLevel rejects invalid levels", () => {
    ...
    assert.throws(() => controller.setLevel(5), /Invalid degradation level/);
    assert.throws(() => controller.setLevel(-1), /Invalid degradation level/);
});
...
//# sourceMappingURL=degradation-integration.test.js.map