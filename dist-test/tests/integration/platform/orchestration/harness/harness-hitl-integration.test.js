...
test.skip("Harness opens HITL review and stores request in SQLite", () => {
    ...
    try {
        ...
        run = service.openHitlReview(run, "High-risk delete operation requires human review", ["security_scan_001", "code_review_001"]);
...
//# sourceMappingURL=harness-hitl-integration.test.js.map