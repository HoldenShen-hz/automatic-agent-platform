...
import { HarnessLoopController } from "../../../../../../src/platform/orchestration/harness/index.js";
function createMockConstraintPack(overrides = {}) {
    return {
        policyIds: [],
        approvalMode: "none",
        autonomyMode: "manual",
...
describe("HarnessLoopController", () => {
    ...
    describe("getGuards", () => {
        ...
        it("should respect guard overrides", () => {
            const controller = new HarnessLoopController(createMockConstraintPack(), { maxIterations: 5, maxReplans: 2, maxDurationMs: 1000, maxCost: 100 });
    ...
    describe("getState", () => {
        ...
        it("should respect initialState overrides", () => {
            ...
            const controller = new HarnessLoopController(createMockConstraintPack(), {}, { iteration: 5, replanCount: 2, totalCost: 25, startedAt: fixedStartTime });
            const state = controller.getState();
