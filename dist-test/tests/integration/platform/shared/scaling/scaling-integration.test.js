...
import { createResourceQuota, canAllocate, calculateBurstCapacity, inheritQuota, } from "../../../../../src/platform/shared/scaling/resource-quota.js";
import { PriorityScheduler, PRIORITY_CLASSES, canPreempt, parseTimeoutToMs, hasExceededTimeout, } from "../../../../../src/platform/shared/scaling/priority-scheduler.js";
import { FairScheduler, } from "../../../../../src/platform/shared/scaling/fair-scheduler.js";
import { HorizontalScalingController, evaluateScalingAction, } from "../../../../../src/platform/shared/scaling/horizontal-scaling-controller.js";
...
test("FairScheduler: getTenantStats returns correct utilization", () => {
    ...
    // Use 5 of 10 workflows (50% utilization)
    scheduler.admitTask("tenant-x", "task-1", { maxConcurrentWorkflows: 3 });
    scheduler.admitTask("tenant-x", "task-2", { maxConcurrentWorkflows: 2 });
    const stats = scheduler.getTenantStats("tenant-x");
    assert.ok(stats !== null);
    assert.equal(stats.used.maxConcurrentWorkflows, 5);
    assert.equal(stats.utilizationPercent, 50);
});
...
//# sourceMappingURL=scaling-integration.test.js.map