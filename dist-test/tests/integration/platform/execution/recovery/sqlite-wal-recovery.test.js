...
test("recovery: WAL mode is enabled for database", () => {
    ...
    try {
        ...
        const journalMode = db.connection
            ...
            .get();
        assert.ok(journalMode.journal_mode === "wal" || journalMode.journal_mode === "delete", `Journal mode should be WAL or DELETE, got ${journalMode.journal_mode}`);
        db.close();
    }
    finally {
...
//# sourceMappingURL=sqlite-wal-recovery.test.js.map