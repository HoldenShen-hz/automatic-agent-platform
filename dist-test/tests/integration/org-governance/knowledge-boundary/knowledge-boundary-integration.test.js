...
test("Knowledge Boundary: evaluateAccess grants access to public boundary", () => {
    ...
    try {
        ...
        const decision = kbService.evaluateAccess(boundary, "user-123", "org-engineering", "research", [], undefined, "2026-04-20T10:00:00.000Z");
...
test("Knowledge Boundary: evaluateAccess denies access to private boundary without grants", () => {
    ...
    try {
        ...
        const decision = kbService.evaluateAccess(boundary, "user-456", "org-engineering", "research", [], undefined, "2026-04-20T10:00:00.000Z");
...
test("Knowledge Boundary: evaluateAccess allows owner access to private boundary", () => {
    ...
    try {
        ...
        const decision = kbService.evaluateAccess(boundary, "user-owner", "org-finance", "finance work", [], undefined, "2026-04-20T10:00:00.000Z");
        assert.equal(decision.allowed, true);
...
test("Knowledge Boundary: evaluateAccess allows access via valid share grant", () => {
    ...
    try {
        ...
        const decision = kbService.evaluateAccess(boundary, "user-engineer", "org-engineering", "collaboration", grants, undefined, "2026-04-20T10:00:00.000Z");
        assert.equal(decision.allowed, true);
...
test("Knowledge Boundary: evaluateAccess blocks access via Chinese Wall policy", () => {
    ...
    try {
        ...
        const decision = kbService.evaluateAccess(boundary, "user-compliance", "org-compliance", "legal review", [], chineseWallPolicy, "2026-04-20T10:00:00.000Z");
        assert.equal(decision.allowed, false);
...
test("Knowledge Boundary: evaluateAccess records correct access log entries", () => {
    ...
    try {
        ...
        const decision = kbService.evaluateAccess(boundary, "requester-xyz", "org-requester", "test-purpose", [], undefined, "2026-04-20T15:30:00.000Z");
...
//# sourceMappingURL=knowledge-boundary-integration.test.js.map