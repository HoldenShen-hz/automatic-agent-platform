# E2E Workflow State Migration (Legacy Alias)

Canonical document moved to [../migration/e2e-workflow-state-migration.md](../migration/e2e-workflow-state-migration.md).
