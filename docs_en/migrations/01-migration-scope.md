# Migration Boundaries: Old System to New Platform
...
- Migration guideline defines migration order and tiers
- Current code architecture documents serve as reference for legacy assets and refactoring costs
...
## Document Families That Require Refactoring Before Migration
...
- Formal documentation resides under `docs_zh/` and `docs_en/`

## Material That Should Be Kept Only for Reference

The following may remain in the old repository for reference but will not enter the new platform formal document set:
...
The following will not enter the new platform formal document set:
...
- `docs_zh/reviews/` — Architecture and implementation gap reviews