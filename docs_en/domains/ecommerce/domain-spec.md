...
- Price changes exceeding thresholds must require human approval.
...
- GA must provide price guardrail, order side effect reconciliation, inventory consistency, and customer service escalation evidence before release.