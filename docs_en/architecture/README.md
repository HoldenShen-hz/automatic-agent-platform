...
The `architecture/` directory contains the formal documentation that defines "what the platform is," organized by reading order.

## File Order

1. [00-platform-architecture.md](./00-platform-architecture.md)
   System skeleton and master design - the only authoritative design source.
...
3. [02-code-architecture-reference.md](./02-code-architecture-reference.md)
   Code architecture reference migrated from the legacy system, retained as the structural baseline for the new platform.
...
5. [04-runtime-sequence.md](./04-runtime-sequence.md)
   Key runtime sequences and main path diagrams.
