...
- Long-term architectural boundary issues defer to `docs_en/architecture/00-*.md` ~ `04-*.md`.
- Approach trade-off issues defer to `adr/`.
- New platform design and migration boundaries defer to the platform architecture documents under this project's `docs_en/architecture/`.
