...
- A-31: This ADR originally used `phase 8c` as delivery gate terminology, root cause being async mode ADR followed historical phase scheduling, did not switch to main architecture unified ring口径. Fix: Main text now changed to `Ring 2 async-readiness`.
