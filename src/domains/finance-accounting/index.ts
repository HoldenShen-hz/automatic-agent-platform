...
export const FINANCE_ACCOUNTING_DOMAIN_PRESET = createDomainModulePreset("finance-accounting", ["reconcile", "report", "forecast"] as const, ["reconcile", "report", "forecast"] as const);
