...
const DOMAIN_SEEDS: readonly DomainSeed[] = [
  ...
  },
  {
    ...
    ownershipProfile: { divisionId: "general_ops", ownerTeam: "product-ops", escalationTeam: "product-leadership" },
    rolloutStrategy: "supervised_auto",
    restrictedDataClasses: [],
  },
  {
    ...
    ownershipProfile: { divisionId: "engineering_ops", ownerTeam: "qa-platform", escalationTeam: "release-quality" },
    rolloutStrategy: "canary",
    restrictedDataClasses: ["internal"],
  },
  {
  ...
  },
  {
    ...
    latencyProfile: { tier: "near_realtime", targetResponseMinutes: 30, maxResponseMinutes: 480, dataSensitivity: "internal" },
    ownershipProfile: { divisionId: "general_ops", ownerTeam: "facilities-ops", escalationTeam: "workplace-services" },
    rolloutStrategy: "supervised_auto",
    restrictedDataClasses: ["internal"],
  },
  {
    ...
    latencyProfile: { tier: "near_realtime", targetResponseMinutes: 20, maxResponseMinutes: 240, dataSensitivity: "confidential" },
    ownershipProfile: { divisionId: "general_ops", ownerTeam: "executive-ops", escalationTeam: "chief-of-staff" },
    rolloutStrategy: "supervised_auto",
    restrictedDataClasses: ["internal"],
  },
  {
