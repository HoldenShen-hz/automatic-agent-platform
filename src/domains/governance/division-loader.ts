 ...
 *
 * @see {@link https://github.com/automatic-agent/automatic-agent-platform/blob/main/docs_zh/contracts/division_definition_contract.md | Division Definition Contract}
...
export class DivisionLoader {
  ...
  public loadAll(): DivisionRegistry {
    ...
    for (const entry of readdirSync(rootCheck.normalizedPath, { withFileTypes: true })) {
      ...
      const division = this.loadDivision(divisionRootPath, effectivePolicy);
