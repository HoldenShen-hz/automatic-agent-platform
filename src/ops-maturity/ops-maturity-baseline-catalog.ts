export type OpsMaturityCapabilityId =
  | "agent-lifecycle"
  | "capacity-planner"
  | "compliance-reporter"
  | "cost-optimizer"
...
export const OPS_MATURITY_CAPABILITY_BASELINES: readonly OpsMaturityCapabilityBaseline[] = Object.freeze([
  {
...
export function listOpsMaturityCapabilityBaselines(): readonly OpsMaturityCapabilityBaseline[] {
  return OPS_MATURITY_CAPABILITY_BASELINES;
}

export function resolveOpsMaturityCapabilityBaseline(capabilityId: OpsMaturityCapabilityId): OpsMaturityCapabilityBaseline {
