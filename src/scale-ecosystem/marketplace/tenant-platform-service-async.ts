...
export class TenantPlatformServiceAsync {
  private readonly sync: import("./tenant-platform-service.js").TenantPlatformService;
   ...
   * @internal
   */
  public getSyncService(): import("./tenant-platform-service.js").TenantPlatformService {
    return this.sync;
  }
}
