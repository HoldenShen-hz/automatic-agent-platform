...
const ROUTES: ApiRouteSpec[] = [
  ...
  { method: "GET", path: "/v1/dashboard/metrics", summary: "Mission control metric cards", tags: ["dashboard"] },
  { method: "GET", path: "/v1/workers", summary: "List public worker summaries", tags: ["dashboard"] },
  { method: "GET", path: "/v1/queues", summary: "List public queue summaries", tags: ["dashboard"] },
  { method: "GET", path: "/v1/agents", summary: "List public agent summaries", tags: ["dashboard"] },
  { method: "GET", path: "/v1/explanations", summary: "List explanation summaries", tags: ["explainability"] },
  { method: "GET", path: "/v1/meta/contract-version", summary: "Read current public contract version", tags: ["meta"] },
  ...
  { method: "GET", path: "/v1/knowledge", summary: "List public knowledge summaries", tags: ["knowledge"] },
  ...
  { method: "GET", path: "/v1/marketplace", summary: "List marketplace packs", tags: ["packs"] },
  { method: "GET", path: "/v1/packs/{packId}/versions", summary: "List pack versions", tags: ["packs"] },
  ...
  { method: "GET", path: "/v1/workflows/builder", summary: "List workflow builder models", tags: ["tasks"] },
  ...
  { method: "GET", path: "/v1/admin/compliance/policies", summary: "List compliance policy summaries", tags: ["admin"] },
  { method: "PATCH", path: "/v1/admin/compliance/policies/{policyId}", summary: "Update compliance policy review metadata", tags: ["admin"] },
  { method: "GET", path: "/v1/admin/audit-logs", summary: "List governance audit log summaries", tags: ["admin"] },
  { method: "GET", path: "/v1/admin/compliance/exceptions", summary: "List compliance exception queue", tags: ["admin"] },
  { method: "POST", path: "/v1/admin/compliance/exceptions", summary: "Create compliance exception request", tags: ["admin"] },
  { method: "POST", path: "/v1/admin/compliance/exceptions/{exceptionId}/approve", summary: "Approve compliance exception", tags: ["admin"] },
  { method: "POST", path: "/v1/admin/compliance/exceptions/{exceptionId}/reject", summary: "Reject compliance exception", tags: ["admin"] },
