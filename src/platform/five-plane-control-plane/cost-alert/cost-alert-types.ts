 ...
 */
export type CostAlertAction =
  | "sev1_alert"    // Platform-wide critical alert
  | "sev2_alert"    // Tenant/pack level alert
  | "sev3_alert"    // Step level informational alert
  | "queue_slowdown"  // Slow down workflow queue
  | "workflow_pause"   // Pause new workflow starts
  | "workflow_degrade"  // Degrade to supervised mode
  | "step_abort";      // Abort current step and replan
...
export interface CostEvaluationResult {
  ...
  thresholdRatio: number; // How close to limit (0-1)
