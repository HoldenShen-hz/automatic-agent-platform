...
const DEFAULT_ENTRIES: ThreatEntry[] = [
  {
    ...
    implementationRefs: [
      ...
      "src/platform/five-plane-control-plane/iam/secret-management-service.ts",
      "src/platform/five-plane-state-evidence/truth/sqlite/repositories/worker-repository.ts",
    ],
    residualRisk: "medium",
  },
  {
    ...
    implementationRefs: [
      ...
      "src/platform/five-plane-control-plane/iam/audit-integrity-repository.ts",
      "src/platform/five-plane-state-evidence/events/transactional-event-appender.ts",
    ],
    residualRisk: "low",
  },
  {
    ...
    implementationRefs: [
      "src/platform/five-plane-control-plane/config-center/config-validation-service.ts",
      "src/platform/five-plane-control-plane/iam/audit-event-integrity.ts",
  ...
  },
  {
    ...
    implementationRefs: [
      "src/platform/five-plane-control-plane/incident-control/enterprise-governance-service.ts",
      "src/platform/five-plane-control-plane/iam/audit-event-integrity.ts",
      "src/platform/shared/observability/diagnostics-service.js",
    ],
    residualRisk: "medium",
  },
  {
    ...
    implementationRefs: [
      "src/platform/five-plane-control-plane/iam/field-encryption.ts",
      "src/platform/five-plane-control-plane/iam/network-egress-policy.ts",
      "src/platform/five-plane-control-plane/iam/outbound-url-policy.ts",
      "src/platform/five-plane-control-plane/iam/secret-management-service.ts",
    ],
    residualRisk: "medium",
  },
  ...
  },
  {
    ...
    implementationRefs: [
      ...
      "src/platform/five-plane-control-plane/incident-control/operations-governance-service.ts",
  ...
  },
  {
    ...
    implementationRefs: [
      "src/platform/five-plane-control-plane/iam/sandbox-policy.ts",
      "src/platform/five-plane-control-plane/iam/policy-engine.ts",
      "src/platform/five-plane-execution/plugin-executor/plugin-executor.service.ts",
    ],
    residualRisk: "high",
  },
];
