...
export const CONTROL_PLANE_CAPABILITY_BASELINES: readonly ControlPlaneCapabilityBaseline[] = Object.freeze([
  freezeBaseline({ capabilityId: "approval-center", entryModule: "src/platform/five-plane-control-plane/approval-center/index.ts", description: "Approval orchestration and multi-party approval baselines.", baselineServices: ["ApprovalService", "ApprovalFlowEngine"] }),
  freezeBaseline({ capabilityId: "audit-export", entryModule: "src/platform/five-plane-control-plane/audit-export/index.ts", description: "Audit export and evidence packaging baselines.", baselineServices: ["AuditExportService"] }),
  freezeBaseline({ capabilityId: "compliance", entryModule: "src/platform/five-plane-control-plane/compliance/index.ts", description: "Operational compliance and erasure control baselines.", baselineServices: ["ErasureRequestService"] }),
  freezeBaseline({ capabilityId: "config-center", entryModule: "src/platform/five-plane-control-plane/config-center/index.ts", description: "Configuration governance, rollout, versioning, and startup validation baselines.", baselineServices: ["ConfigGovernanceService", "ConfigVersioningService"] }),
