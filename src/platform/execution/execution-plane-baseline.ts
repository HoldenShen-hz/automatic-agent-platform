...
export const EXECUTION_CAPABILITY_BASELINES: readonly ExecutionCapabilityBaseline[] = Object.freeze([
  ...
  { capabilityId: "plugin-executor", entryModule: "src/platform/execution/plugin-executor/index.ts", description: "Plugin execution runtime baselines.", baselineServices: ["PluginExecutorService", "AdapterExecutor", "BrowserExecutor", "HumanWaitExecutor", "SubWorkflowExecutor"] },
  ...
  { capabilityId: "tool-executor", entryModule: "src/platform/execution/tool-executor/index.ts", description: "Tool execution and command mediation baselines.", baselineServices: ["CommandExecutor", "ToolExecutor"] },
