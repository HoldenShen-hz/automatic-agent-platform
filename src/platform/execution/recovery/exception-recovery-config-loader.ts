...
let cachedConfig: ExceptionRecoveryConfig | null = null;
 ...
 */
export function loadExceptionRecoveryConfig(configPath: string = DEFAULT_CONFIG_PATH): ExceptionRecoveryConfig {
  if (cachedConfig) {
    return cachedConfig;
  }
