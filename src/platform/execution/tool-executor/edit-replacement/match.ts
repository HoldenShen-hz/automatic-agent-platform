 ...
 */
export function matchExact(content: string, needle: string): MatchOutcome {
 ...
 */
export function matchNormalizedWindows(
  windows: MatchCandidate[],
  oldString: string,
 ...
 */
export function matchFuzzyWindows(windows: MatchCandidate[], oldString: string, threshold: number): MatchOutcome {
 ...
 */
export function matchAnchoredFuzzy(content: string, request: EditInstruction, threshold: number): MatchOutcome {
 ...
 */
export function toExactOutcome(candidates: MatchCandidate[]): MatchOutcome {
 ...
 */
export function findAllOccurrences(content: string, needle: string): MatchCandidate[] {
  if (needle.length === 0) {
    return [];
  }
 ...
 */
export function dedupeWindows(windows: MatchCandidate[]): MatchCandidate[] {
