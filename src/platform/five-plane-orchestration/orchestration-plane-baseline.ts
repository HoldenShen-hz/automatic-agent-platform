...
export const ORCHESTRATION_CAPABILITY_BASELINES: readonly OrchestrationCapabilityBaseline[] = Object.freeze([
  ...
  { capabilityId: "escalation", entryModule: "src/platform/five-plane-orchestration/escalation/index.ts", description: "Escalation policies and override routing baselines.", baselineServices: ["EscalationPolicyService"] },
  ...
  { capabilityId: "replan", entryModule: "src/platform/five-plane-orchestration/replan/index.ts", description: "Replanning and plan migration baselines.", baselineServices: ["ReplanningCoordinatorService"] },
