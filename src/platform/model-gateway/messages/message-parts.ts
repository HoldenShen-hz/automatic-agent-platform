 ...
 */
function defaultPartType(messageType: string): MessagePartType {
  switch (messageType) {
    case "tool_result":
      return "tool_result";
 ...
 */
function defaultContentPayload(partType: MessagePartType, content: string): Record<string, unknown> {
  switch (partType) {
    case "summary":
 ...
 */
function safeParseContentJson(contentJson: string): Record<string, unknown> | null {
  try {
 ...
 */
function renderArtifactRefPayload(payload: Record<string, unknown>): string {
 ...
 */
export function buildMessageParts(input: Pick<MessageRecord, "id" | "messageType" | "content" | "createdAt">): MessagePart[] {
 ...
 */
export function buildStructuredToolResultParts(input: StructuredToolResultPartsInput): MessagePart[] {
 ...
 */
export function buildRetryRecordParts(input: RetryRecordPartsInput): MessagePart[] {
  return [
    {
 ...
 */
export function parseMessagePartsJson(partsJson: string | null | undefined): MessagePart[] {
  ...
  try {
    ...
    return parsed
      .filter((part): part is MessagePart => {
 ...
 */
export function renderMessagePartContent(part: MessagePart): string {
 ...
 */
export function renderMessagePartsForContext(
  input: Pick<MessageRecord, "id" | "content" | "partsJson">,
  options: RenderMessagePartsOptions = {},
 ...
 */
export function ensureMessagePartsJson(input: Pick<MessageRecord, "id" | "messageType" | "content" | "createdAt" | "partsJson">): string {
