...
export const ARCHITECTURE_INVARIANTS: readonly ArchitectureInvariant[] = Object.freeze([
  {
    ...
    testRef: "tests/unit/platform/five-plane-state-evidence/truth/runtime-truth-repository.test.ts",
  ...
  },
  {
    ...
    testRef: "tests/unit/platform/five-plane-orchestration/harness/runtime/runtime-entry-guard.test.ts",
  ...
  },
  {
    ...
    testRef: "tests/unit/platform/five-plane-orchestration/harness/runtime/plan-graph-harness-runtime.test.ts",
  ...
  },
  {
    ...
    testRef: "tests/unit/platform/five-plane-execution/budget-allocator.test.ts",
  ...
  },
  {
    ...
    testRef: "tests/unit/platform/five-plane-state-evidence/events/event-registry.test.ts",
  ...
  },
  {
    ...
    testRef: "tests/unit/platform/five-plane-execution/side-effect-manager.test.ts",
  ...
  },
  {
    ...
    testRef: "tests/unit/platform/five-plane-execution/runtime-state-machine.test.ts",
