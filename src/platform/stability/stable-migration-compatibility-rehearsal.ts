...
export interface StableMigrationCompatibilityScenarioResult {
  scenarioId:
    | "migration_plan_passes_pg_portability_rules"
    | "sqlite_migration_bootstrap_reaches_latest_schema";
  passed: boolean;
  durationMs: number;
  summary: string;
...
async function measureScenario(
  scenarioId: StableMigrationCompatibilityScenarioResult["scenarioId"],
  run: () => Promise<Omit<StableMigrationCompatibilityScenarioResult, "scenarioId" | "durationMs">>,
): Promise<StableMigrationCompatibilityScenarioResult> {
 ...
 */
async function runPortabilityRuleScenario(): Promise<StableMigrationCompatibilityScenarioResult> {
 ...
 */
async function runSqliteBootstrapScenario(outputDir: string): Promise<StableMigrationCompatibilityScenarioResult> {
 ...
 */
export async function runStableMigrationCompatibilityRehearsal(
  options: StableMigrationCompatibilityRehearsalOptions,
): Promise<StableMigrationCompatibilityRehearsalReport> {
 ...
 */
export function writeStableMigrationCompatibilityRehearsalReport(
  path: string,
  report: StableMigrationCompatibilityRehearsalReport,
): void {
