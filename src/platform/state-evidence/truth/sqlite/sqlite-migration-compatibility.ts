 ...
 */
export type SqliteMigrationCompatibilityRuleId =
...
interface CompatibilityRule {
  id: SqliteMigrationCompatibilityRuleId;
  evaluate(statement: string): string | null;
}
 ...
 */
export function evaluateSqliteMigrationCompatibility(
