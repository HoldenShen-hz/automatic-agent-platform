...
// Note: CostEstimationService is implemented in scale-ecosystem/billing/ and
// exposed via CostEstimationServicePort. Control Plane should use the port
// interface to avoid direct scale-ecosystem coupling.
