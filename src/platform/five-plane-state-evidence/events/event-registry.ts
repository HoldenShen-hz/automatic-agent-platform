...
const RAW_EVENT_SCHEMA_REGISTRY = {
  ...
  "takeover:completed": {
    type: "takeover:completed",
    tier: "tier_2",
    producer: "human_takeover_service",
    consumers: ["inspect_projection"],
  },
  "takeover:timeout": {
    type: "takeover:timeout",
    tier: "tier_2",
    producer: "human_takeover_service",
    consumers: ["inspect_projection"],
  },
  "takeover:escalated": {
    type: "takeover:escalated",
    tier: "tier_2",
    producer: "human_takeover_service",
    consumers: ["inspect_projection"],
  },
  "takeover:cancelled": {
    type: "takeover:cancelled",
    tier: "tier_2",
    producer: "human_takeover_service",
    consumers: ["inspect_projection"],
  },
  "takeover:request_enqueued": {
    type: "takeover:request_enqueued",
    tier: "tier_2",
    producer: "human_takeover_service",
    consumers: ["inspect_projection"],
  },
  "takeover:request_processed": {
    type: "takeover:request_processed",
    tier: "tier_2",
    producer: "human_takeover_service",
    consumers: ["inspect_projection"],
  },
  "takeover:ack_expired": {
    type: "takeover:ack_expired",
    tier: "tier_2",
    producer: "human_takeover_service",
    consumers: ["inspect_projection"],
  },
