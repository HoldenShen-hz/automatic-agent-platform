...
export class SecretRepository {
  ...
  public upsertSecretRegistryRecord(record: SecretRegistryRecord): void {
    execute(
      this.db.connection,
  ...
  public insertSecretUsageAudit(record: SecretUsageAuditRecord): void {
    execute(
      this.db.connection,
  ...
  public insertSecretRotationEvent(record: SecretRotationEventRecord): void {
    execute(
      this.db.connection,
  ...
  public upsertSecretLeaseRecord(record: SecretLeaseRecord): void {
    execute(
      this.db.connection,
  ...
  public getSecretRegistryRecord(secretRef: string): SecretRegistryRecord | null {
    return queryOne<SecretRegistryRecord>(
      this.db.connection,
      `SELECT
  ...
  public listSecretRegistryRecords(): SecretRegistryRecord[] {
    return queryAll<SecretRegistryRecord>(
      this.db.connection,
      `SELECT
         secret_ref AS secretRef,
         display_name AS displayName,
  ...
  public listSecretUsageAuditsBySecretRef(secretRef: string): SecretUsageAuditRecord[] {
    return queryAll<SecretUsageAuditRecord>(
      this.db.connection,
      `SELECT
         audit_id AS auditId,
         secret_ref AS secretRef,
  ...
  public listSecretRotationEventsBySecretRef(secretRef: string): SecretRotationEventRecord[] {
    return queryAll<SecretRotationEventRecord>(
      this.db.connection,
      `SELECT
         event_id AS eventId,
         secret_ref AS secretRef,
  ...
  public getSecretLeaseRecord(leaseId: string): SecretLeaseRecord | null {
    return queryOne<SecretLeaseRecord>(
      this.db.connection,
      `SELECT
         lease_id AS leaseId,
         secret_ref AS secretRef,
  ...
  public listSecretLeasesBySecretRef(secretRef: string): SecretLeaseRecord[] {
    return queryAll<SecretLeaseRecord>(
      this.db.connection,
      `SELECT
         lease_id AS leaseId,
         secret_ref AS secretRef,
