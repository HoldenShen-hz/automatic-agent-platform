...
const DEFAULT_JUDGE_PROVIDER_CATALOG: readonly JudgeProviderCatalogEntry[] = [
  {
    providerId: "judge.minimax.minimax-m2.7.primary",
    provider: "minimax",
  ...
  {
    providerId: "judge.minimax.minimax-m2.7.safety",
    provider: "minimax",
    providerFamily: "minimax",
    modelId: "minimax-m2.7",
  ...
  {
    providerId: "judge.minimax.minimax-m2.7.regional",
    provider: "minimax",
    providerFamily: "minimax",
    modelId: DEFAULT_MODEL_METADATA_REGISTRY.profiles.balanced?.modelId ?? "minimax-m2.7",
