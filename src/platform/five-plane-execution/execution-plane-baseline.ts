...
export const EXECUTION_CAPABILITY_BASELINES: readonly ExecutionCapabilityBaseline[] = Object.freeze([
  ...
  freezeExecutionBaseline({ capabilityId: "distributed-lock", entryModule: "src/platform/five-plane-execution/distributed-lock/index.ts", description: "Distributed lock and fencing baselines.", baselineServices: ["DistributedLockService"] }),
  ...
  freezeExecutionBaseline({ capabilityId: "recovery", entryModule: "src/platform/five-plane-execution/recovery/index.ts", description: "Recovery, replay, and stuck-run resolution baselines.", baselineServices: ["RecoveryService"] }),
  freezeExecutionBaseline({ capabilityId: "resource", entryModule: "src/platform/five-plane-execution/resource/index.ts", description: "Runtime resource and process tracking baselines.", baselineServices: ["ProcessTrackerService"] }),
  freezeExecutionBaseline({ capabilityId: "startup", entryModule: "src/platform/five-plane-execution/startup/index.ts", description: "Startup preflight, shutdown, and process error handling baselines.", baselineServices: ["StartupPreflightService"] }),
