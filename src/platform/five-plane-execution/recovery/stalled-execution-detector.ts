 ...
 * @see {@link https://github.com/automatic-agent/automatic-agent-platform/blob/main/docs_zh/contracts/task_lease_and_fencing_contract.md | Task Lease and Fencing Contract}
