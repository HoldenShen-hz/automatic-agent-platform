 ...
 * @see {@link https://github.com/automatic-agent/automatic-agent-platform/blob/main/docs_zh/contracts/context_compaction_and_overflow_contract.md | Context Compaction and Overflow Contract}
