...
export const EventEnvelopeSchema = z.object({
  ...
  payload: JsonValueSchema,
  replayBehavior: z.enum(["replay_as_fact", "skip_side_effect", "simulate_projection", "forbidden"]).optional(),
...
const REQUIRED_FIELDS = {
  TaskDraft: ["taskDraftId", "tenantId", "principal", "source", "normalizedIntent", "missingFields", "riskPreview", "ambiguityPolicy", "createdAt"],
  ConfirmedTaskSpec: ["confirmedTaskSpecId", "taskDraftId", "tenantId", "principal", "goal", "inputs", "constraintPackRef", "riskClass", "idempotencyKey", "traceId", "createdAt"],
  RequestEnvelope: ["requestId", "confirmedTaskSpecId", "tenantId", "principal", "traceId", "idempotencyKey", "requestHash", "constraintPackRef", "budgetIntent", "policyContext", "artifactRefs", "submittedAt"],
  HarnessRun: ["harnessRunId", "tenantId", "confirmedTaskSpecId", "requestEnvelopeId", "requestHash", "status", "constraintPackRef", "versionLockId", "budgetLedgerId", "currentSeq", "createdAt", "updatedAt"],
  ...
  NodeAttemptReceipt: ["nodeAttemptReceiptId", "nodeAttemptId", "nodeRunId", "receiptKind", "status", "sideEffectRefs", "budgetSettlementRefs", "evidenceRefs", "producedAt"],
  ...
  EventEnvelope: ["eventId", "eventType", "eventVersion", "aggregateType", "aggregateId", "aggregateSeq", "tenantId", "traceId", "payloadHash", "payload", "occurredAt"],
