export type PlatformMainlineCapabilityId =
  | "interface"
  | "control-plane"
  | "orchestration"
  | "execution"
...
export function listPlatformMainlineCapabilities(): readonly PlatformMainlineCapability[] {
  return PLATFORM_MAINLINE_CAPABILITIES;
}

export function resolvePlatformMainlineCapability(capabilityId: PlatformMainlineCapabilityId): PlatformMainlineCapability {
