...
export function createAssetProductionRetrieverPlugin(): DomainRetrieverPlugin {
  return {
    ...
    async retrieve(query) {
      ...
      const results: RetrieverKnowledgeResult[] = [
        {
          knowledgeRef: `knowledge:assetprod/figma?query=${encodeURIComponent(searchQuery)}` as string,
        ...
        {
          knowledgeRef: `knowledge:assetprod/cdn?query=${encodeURIComponent(searchQuery)}` as string,
        ...
        {
          knowledgeRef: `knowledge:assetprod/design_tokens?query=${encodeURIComponent(searchQuery)}` as string,
        ...
        {
          knowledgeRef: `knowledge:assetprod/metadata?query=${encodeURIComponent(searchQuery)}` as string,
