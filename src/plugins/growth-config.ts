...
export const growthDomainDefinition: DomainDefinition = {
  ...
  workflows: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          modelHints: { preferredModel: "minimax-m2.7", temperature: 0.2 },
        ...
        },
        {
          ...
          toolHints: ["summarize"],
          modelHints: { preferredModel: "minimax-m2.7", temperature: 0.4 },
  ...
  capabilities: {
    ...
    modelPreferences: {
      "campaign_optimization": "minimax-m2.7",
      "customer_analytics": "minimax-m2.7",
      "growth_experiment": "minimax-m2.7",
    },
    budgetLimits: {
