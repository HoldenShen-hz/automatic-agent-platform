 ...
 *
 * ## References
 * - Contract: {@link https://github.com/automatic-agent/automatic-agent-platform/tree/main/docs_zh/contracts/runtime_execution_contract.md Runtime Execution Contract}
 * - Related: {@link https://github.com/automatic-agent/automatic-agent-platform/tree/main/docs_zh/contracts/task_and_workflow_contract.md task_and_workflow_contract.md}
 * - Related: {@link https://github.com/automatic-agent/automatic-agent-platform/tree/main/docs_zh/contracts/workflow_static_analysis_and_compensation_contract.md workflow_static_analysis_and_compensation_contract.md}
 * - Glossary: {@link https://github.com/automatic-agent/automatic-agent-platform/tree/main/docs_zh/governance/glossary_and_terminology.md Glossary - task, workflow, step, execution, division, routing}
