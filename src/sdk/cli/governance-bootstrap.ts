 ...
 */
function defaultGovernanceQuotaCategories(workspaceRoot: string): StorageQuotaCategoryConfig[] {
  return [
    {
      categoryId: "artifact",
 ...
 * ```
 */
export function bootstrapGovernanceServices(options: GovernanceBootstrapOptions): GovernanceServices {
  ...
  const doctor = new DoctorService(
    ...
    stalledDetector,
    new SqliteReliabilityService(sqlite),
    `${options.dbPath}.backup`,
 ...
 */
export function bootstrapGovernanceServicesWithMetrics(options: GovernanceBootstrapWithMetricsOptions): GovernanceServices & {
  metrics: MetricsService;
  workspaceRoot: string;
} {
