...
const INCLUDED_FILES = new Set([
  ...
  "tests/unit/interaction/goal-decomposer/dependency-graph/index.test.ts",
  "tests/unit/interaction/goal-decomposer/goal-decomposer-enhancements.test.ts",
  "tests/unit/interaction/goal-decomposer/planner/index.test.ts",
  "tests/unit/interaction/goal-decomposer/validator/validator.test.ts",
  "tests/unit/interaction/proactive-agent/schedule-manager/index.test.ts",
  "tests/unit/interaction/nl-gateway/intent-parser/index.test.ts",
  "tests/unit/interaction/nl-gateway/nl-gateway-support.test.ts",
  "tests/unit/ops-maturity/improvement/barrel-exports.test.ts",
  "tests/unit/ops-maturity/learning/barrel-exports.test.ts",
  "tests/unit/ops-maturity/drift-detection/evolution-integration-service.test.ts",
  "tests/unit/ops-maturity/drift-detection/evolution-registry.test.ts",
  "tests/unit/ops-maturity/drift-detection/rollout-manager.test.ts",
  "tests/unit/platform/interaction/nl-gateway/ambiguity-handler.test.ts",
  "tests/unit/org-governance/approval-routing/approval-routing-service-coverage.test.ts",
  "tests/unit/org-governance/approval-routing/delegation/index.test.ts",
  "tests/unit/org-governance/approval-routing/escalation/index.test.ts",
  "tests/unit/org-governance/approval-routing/escalation.test.ts",
  "tests/unit/org-governance/approval-routing/route-engine/index.test.ts",
  "tests/unit/org-governance/sso-scim/group-role-mapping-service-comprehensive.test.ts",
  "tests/unit/org-governance/sso-scim/identity-sync-service-comprehensive.test.ts",
  "tests/unit/org-governance/sso-scim/oidc/index-comprehensive.test.ts",
  "tests/unit/org-governance/sso-scim/saml/index-comprehensive.test.ts",
  "tests/unit/org-governance/sso-scim/scim-dlq-reconciliation-comprehensive.test.ts",
  "tests/unit/org-governance/sso-scim/scim-sync/index.test.ts",
  "tests/unit/platform/control-plane/approval-center/index.test.ts",
  "tests/unit/platform/control-plane/approval-center/approval-flow-engine.test.ts",
  "tests/unit/platform/control-plane/approval-center/approval-policy-engine/index.test.ts",
  "tests/unit/platform/control-plane/approval-center/quorum-calculator.test.ts",
  "tests/unit/platform/shared/observability/structured-logger-branches.test.ts",
  "tests/unit/platform/shared/observability/metrics-service-branches.test.ts",
  "tests/unit/platform/shared/observability/slo-alerting-branches.test.ts",
  "tests/unit/platform/shared/observability/diagnostics-service-edge-cases.test.ts",
  "tests/unit/scale-ecosystem/marketplace/marketplace-governance-service.test.ts",
  "tests/unit/scale-ecosystem/marketplace/billing-service.test.ts",
  "tests/unit/scale-ecosystem/marketplace/data-plane-flow-service.test.ts",
  "tests/unit/sdk/plugin-sdk/plugin-context.test.ts",
  "tests/unit/sdk/plugin-sdk/plugin-definition.test.ts",
  "tests/unit/sdk/plugin-sdk/plugin-test-harness.test.ts",
]);
